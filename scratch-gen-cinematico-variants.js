...
genVariants(
  ...
  [
    ...
    { name: "Nocturna", acc: "#D9BFA0", acc2: "#8C4A52", bg: "#241417", surface: "#331B20", muted: "#C9A8A0", ink: "#F3E4DC" },
    ...
    { name: "Esmeralda", acc: "#D9BFA0", acc2: "#3D6E58", bg: "#122019", surface: "#1B3026", muted: "#A8C2B4", ink: "#EFE7D8" },
...
genVariants(
  ...
  [
    ...
    { name: "VinoVibrante", acc: "#E23B4E", acc2: "#8C1B2A", bg: "#2B0E14", surface: "#3B131B", muted: "#C99AA1", ink: "#F6E4E6" },
...
genVariants(
  ...
  [
    ...
    { name: "PerlaSuave", acc: "#B9A6D9", acc2: "#7C93B0", bg: "#F4F1F9", surface: "#E9E2F3", muted: "#847ba0", ink: "#3A3450" },
