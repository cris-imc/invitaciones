                ...
                <DialogContent className="bg-[var(--card)] border-[var(--line)] text-[var(--foreground)]">
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            <p className="text-[10px] text-[var(--shell-fg-faint)]">Si ingresas una contraseña (mínimo 8 caracteres, con una mayúscula y un número), se sobreescribirá la actual y se le pedirá cambiarla al iniciar sesión.</p>
                        </div>
                    </div>
