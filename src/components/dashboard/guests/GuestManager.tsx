          ...
          <CardContent>
            {!addGuestOpen ? (
              <button
                ...
                className={`w-full flex flex-col items-center justify-center gap-2 py-10 rounded-xl border-2 border-dashed text-muted-foreground hover:border-primary hover:text-primary hover:bg-primary/5 transition-colors ${
                  !isLoading && guests.length === 0
                    ? "border-amber-500/30 animate-heartbeat-ring"
