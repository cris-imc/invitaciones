...
function getAvailableTabs(eventType: string | undefined, collection: Coleccion): { tipo: TemplateTipo; label: string }[] {
  const soloQuince = new Set(["EDITORIAL", "ONIX", "JARDINSEDA", "HOLOGRAMA", "CIRCUITO", "CRISTAL3D", "PRINCESA", "CORONAESCARLATA", "JEWELRYBOX", "PASEVIP", "CINEABSTRACTOXV", "ACRYLICPOP", "BOLADEDISCOTECA", "CRYSTAL3D", "FASHIONTAG", "FASHIONLOOKBOOK", "CIELODEPAPEL", "CUENTODEPAPEL"]);
  ...
  const quinceYCasamiento = new Set(["SEDA", "PETALOS", "LUZLUNA", "BONVOYAGE", "CINE", "BLACKANDWHITE", "PRENSA", "LUMBRE", "NOCHE", "TRAZO", "HERBARIO", "SOBRESELLO"]);
