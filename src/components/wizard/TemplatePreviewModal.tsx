...
import {
  ...
  TINTAVINILO_COLORS,
  MANUSCRITA_COLORS,
  ACUARELACORONA_COLORS,
  SOBRESELLO_COLORS,
  TRAZODEPAPEL_COLORS,
  CIUDADDEPAPEL_COLORS,
  CUENTODEPAPEL_COLORS,
  CIELODEPAPEL_COLORS,
  HERBARIO_COLORS,
  TRAZO_COLORS,
  NOCHE_COLORS,
...
export const TEMPLATE_TIPO_ACCENT: Record<TemplateTipo, string> = {
  ...
  JEWELRYBOX: "#D9B063",
  PASEVIP: "#C8A45C",
  CINEABSTRACTOXV: "#E8123A",
  ACRYLICPOP: "#FF3D8B",
  BOLADEDISCOTECA: "#FF2E9A",
  CRYSTAL3D: "#7FD1E0",
  FASHIONTAG: "#B0562E",
  CERAMICAEDITORIAL: "#B98B5E",
  CINEABSTRACTO: "#C6743A",
  PAPELERIADEHOTELDELUJO: "#1C4A3F",
  ...
  BABYSHOWER: "#C9A8D4",
  BAUTISMO: "#B7A97E",
  CORPORATIVOANIVERSARIO: "#C9A25C",
  CORPORATIVOENCUENTRO: "#B8895A",
  CUMPLEANOSCOCKTAIL: "#C8A45C",
  CUMPLEANOSJARDIN: "#9FB98A",
  CUMPLEANOSTERRAZA: "#D99A5B",
  DESPEDIDASOLTERA: "#E08FA8",
  DESPEDIDASOLTERO: "#4A9BC9",
  GRADUACION: "#C6A860",
  INAUGURACION: "#C8A45C",
  INFANTILESPACIO: "#5FC9E8",
  INFANTILJURASICO: "#7EA84A",
  INFANTILSAFARI: "#D98A3C",
  ANIVERSARIO: "#C48A6E",
  // Papel Prensado: el "acento" es la tinta, que no cambia entre variantes.
  PRENSA: "#514842",
  EDITORIALBLANCNOIR: "#E63B2E",
  ARCADE: "#FF3CAC",
  Y2K: "#FF5FB2",
  TROPICAL: "#FF5E7A",
  REINO: "#E24BA0",
  ...
  TINTAVINILO: "#B4231F",
  MANUSCRITA: "#7A2F3A",
  ACUARELACORONA: "#C27C86",
  SOBRESELLO: "#7A2F3A",
  TRAZODEPAPEL: "#5C6B2F",
  CIUDADDEPAPEL: "#C2564B",
  CUENTODEPAPEL: "#9B6BD6",
  CIELODEPAPEL: "#D9738F",
  HERBARIO: "#6E7A5E",
  TRAZO: "#3C3A35",
  NOCHE: "#F6EBE4",
...
// nombres visibles salen de TEMPLATE_LABELS, que se comparte con la landing
// de modelos: tener dos listas separadas hacía que una quedara vieja (la de
// /modelos no tenía ninguna familia de Storytelling y mostraba la constante
// cruda, tipo "GUESTPASSVIP").
const TEMPLATE_TIPOS_ORDENADOS: TemplateTipo[] = [
  "ELEGANT",
  "MODERNO",
  "NEON",
  "CHIC",
...
const TEMPLATE_TABS: { tipo: TemplateTipo; label: string }[] =
  TEMPLATE_TIPOS_ORDENADOS.map((tipo) => ({ tipo, label: labelDeFamilia(tipo) }));
...
function getAvailableTabs(eventType: string | undefined, collection: Coleccion): { tipo: TemplateTipo; label: string }[] {
  const soloQuince = new Set(["EDITORIAL", "ONIX", "JARDINSEDA", "HOLOGRAMA", "CIRCUITO", "CRISTAL3D", "PRINCESA", "CORONAESCARLATA", "JEWELRYBOX", "PASEVIP", "CINEABSTRACTOXV", "ACRYLICPOP", "BOLADEDISCOTECA", "CRYSTAL3D", "FASHIONTAG", "FASHIONLOOKBOOK", "CIELODEPAPEL", "CUENTODEPAPEL", "ACUARELACORONA", "POP", "SHOJO", "REINO", "TROPICAL", "Y2K", "ARCADE"]);
  const soloCasamiento = new Set(["JARDINDEPAPEL", "NORDICO", "RIVIERA", "GOLDENDUSK", "GUESTPASSVIP", "CERAMICAEDITORIAL", "CINEABSTRACTO", "PAPELERIADEHOTELDELUJO", "VINTAGEEDITORIAL", "MARMOLYORO", "ATELIERDEPAPEL", "BOTANICAEDITORIAL", "ENCAJECONTEMPORANEO", "LIQUIDGLASS", "CIUDADDEPAPEL", "TRAZODEPAPEL", "COUTURE", "CARTELERA", "BAUHAUS", "RETROWAVE", "POSTAL", "NOIR", "OBSERVATORIO", "EDITORIALBLANCNOIR"]);
  ...
  const quinceYCasamiento = new Set(["SEDA", "PETALOS", "LUZLUNA", "BONVOYAGE", "CINE", "BLACKANDWHITE", "PRENSA", "LUMBRE", "NOCHE", "TRAZO", "HERBARIO", "SOBRESELLO", "MANUSCRITA"]);
  const soloCumpleanos = new Set(["CORPORATE", "GARDENPARTY", "LOFTINDUSTRIAL", "INFANTIL", "BABYSHOWER", "BAUTISMO", "CORPORATIVOANIVERSARIO", "CORPORATIVOENCUENTRO", "CUMPLEANOSCOCKTAIL", "CUMPLEANOSJARDIN", "CUMPLEANOSTERRAZA", "DESPEDIDASOLTERA", "DESPEDIDASOLTERO", "GRADUACION", "INAUGURACION", "INFANTILESPACIO", "INFANTILJURASICO", "INFANTILSAFARI", "ANIVERSARIO", "TINTAVINILO", "MEMBRETE"]);
...
const COLORS_BY_TIPO: Record<TemplateTipo, typeof ELEGANT_COLORS> = {
  ...
  EDITORIALBLANCNOIR: EDITORIALBLANCNOIR_COLORS,
  ARCADE: ARCADE_COLORS,
  Y2K: Y2K_COLORS,
  TROPICAL: TROPICAL_COLORS,
  REINO: REINO_COLORS,
  SHOJO: SHOJO_COLORS,
  POP: POP_COLORS,
  OBSERVATORIO: OBSERVATORIO_COLORS,
  NOIR: NOIR_COLORS,
  POSTAL: POSTAL_COLORS,
  RETROWAVE: RETROWAVE_COLORS,
  BAUHAUS: BAUHAUS_COLORS,
  CARTELERA: CARTELERA_COLORS,
  COUTURE: COUTURE_COLORS,
  MEMBRETE: MEMBRETE_COLORS,
  TINTAVINILO: TINTAVINILO_COLORS,
  MANUSCRITA: MANUSCRITA_COLORS,
  ACUARELACORONA: ACUARELACORONA_COLORS,
  SOBRESELLO: SOBRESELLO_COLORS,
  TRAZODEPAPEL: TRAZODEPAPEL_COLORS,
  CIUDADDEPAPEL: CIUDADDEPAPEL_COLORS,
  CUENTODEPAPEL: CUENTODEPAPEL_COLORS,
  CIELODEPAPEL: CIELODEPAPEL_COLORS,
    ...
    <>
        <div className="relative px-6 pt-4 shrink-0">
          {canScrollTabsLeft && (
            ...
            >
              <span className="text-muted-foreground/60 hover:text-muted-foreground text-lg md:text-3xl leading-none transition-colors">‹</span>
            </button>
          )}
          {canScrollTabsRight && (
            <button
