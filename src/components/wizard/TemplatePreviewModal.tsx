...
const TEMPLATE_TABS: { tipo: TemplateTipo; label: string }[] = [
  ...
  { tipo: "JEWELRYBOX", label: "Jewelry Box" },
  { tipo: "PASEVIP", label: "Pase VIP" },
  { tipo: "CINEABSTRACTOXV", label: "Cine Abstracto XV" },
  { tipo: "ACRYLICPOP", label: "Acrylic Pop" },
  { tipo: "BOLADEDISCOTECA", label: "Bola de Discoteca" },
  { tipo: "CRYSTAL3D", label: "Crystal 3D" },
  { tipo: "FASHIONTAG", label: "Fashion Tag" },
  { tipo: "CERAMICAEDITORIAL", label: "Cerámica Editorial" },
  { tipo: "CINEABSTRACTO", label: "Cine Abstracto" },
  { tipo: "PAPELERIADEHOTELDELUJO", label: "Papelería de Hotel de Lujo" },
  ...
  { tipo: "BABYSHOWER", label: "Baby Shower" },
  { tipo: "BAUTISMO", label: "Bautismo" },
  { tipo: "CORPORATIVOANIVERSARIO", label: "Corporativo Aniversario" },
  { tipo: "CORPORATIVOENCUENTRO", label: "Corporativo Encuentro" },
  { tipo: "CUMPLEANOSCOCKTAIL", label: "Cumpleaños Cocktail" },
  { tipo: "CUMPLEANOSJARDIN", label: "Cumpleaños Jardín de Noche" },
  { tipo: "CUMPLEANOSTERRAZA", label: "Cumpleaños Terraza Dorada" },
  { tipo: "DESPEDIDASOLTERA", label: "Despedida de Soltera" },
  { tipo: "DESPEDIDASOLTERO", label: "Despedida de Soltero" },
  { tipo: "GRADUACION", label: "Graduación" },
  { tipo: "INAUGURACION", label: "Inauguración" },
  { tipo: "INFANTILESPACIO", label: "Infantil Rumbo al Espacio" },
  { tipo: "INFANTILJURASICO", label: "Infantil Mundo Jurásico" },
  { tipo: "INFANTILSAFARI", label: "Infantil Safari" },
  { tipo: "ANIVERSARIO", label: "Aniversario" },
];
