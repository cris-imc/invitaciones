  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#080808", tinta: "#F4F1EA", acento: "#B9B9BC", clase: `${bcwBodoni.variable} ${bcwMono.variable}`, fuente: "var(--bcw-mono), monospace" }}
      />
    );
  }
...
const GP_CSS = `
  ...
  .bcw-cover-names { margin: 0; font-family: var(--bcw-bodoni), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #FFFFFF; }
