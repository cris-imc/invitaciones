          ...
          <div className="bcw-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="8,8,8" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="8,8,8" />
              </div>
            )}
...
function CoverHalf({
  ...
  return (
    <div className="bcw-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint={false} effect="enfoque" scrimColorRgb="8,8,8" />
        </div>
      )}
...
const GP_CSS = `
  ...
  .bcw-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #17141F 0%, #0A0A0A 60%, #080808 100%); }
