    ...
    >
      ...
      {!isCoverOpen && (
        <div
          ...
          className="text-[#411D14] transition-all duration-1000 animate-in fade-in"
        >
          <div style={{
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <h2 className="text-4xl sm:text-5xl font-light tracking-wide text-[#411D14] leading-relaxed" style={{ fontFamily: 'var(--font-title, var(--font-cormorant)), serif', fontStyle: 'italic' }}>
              {guestNameDisplay}
            </h2>

            {Boolean(activeDressCode) && (
              <p className=" text-sm font-medium text-[#9c5a45] tracking-wide uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter)), sans-serif", letterSpacing: "0.2em", opacity: 0.8 }}>
