 ...
 *   --t-bg #F5F7F8 · --t-surface #EAEFF1 · --seda-ink #263238
 *   --t-muted #6b7c85 · --t-acc #8FA3B0 (rosa polvo) · --t-acc2 #C9A876 (oro champagne)
 *
...
interface SedaTemplatePerlaProps {
    ...
    return (
      <div className="min-h-dvh w-full text-white relative overflow-x-hidden flex flex-col justify-between" style={{ background: "linear-gradient(180deg, var(--t-bg) 0%, var(--t-surface) 55%, #FFFFFF 100%)" }} data-theme={theme}>
        ...
        <footer className="relative z-10 pt-4 pb-2 text-center font-sans" style={{ borderTop: "1px solid color-mix(in srgb, var(--t-acc) 10%, transparent)" }}>
          <LogoFooterCredit bgColor="transparent" textColor="var(--chic-ink, #263238)" />
        </footer>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <style jsx>{`
            ...
            .seda-cover-text { color: #F5F7F8; }
            .seda-cover-text-muted { color: #F5F7F8; }
      ...
      <div className="d-right tpl">
        ...
        <LogoFooterCredit bgColor="var(--t-bg)" textColor="var(--chic-ink, #263238)" />
        </div>
      </div>
