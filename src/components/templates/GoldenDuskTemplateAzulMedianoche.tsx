/**
 * GoldenDuskTemplateAzulMedianoche.tsx
 ...
 * oscura (#3B2A2A) + terracota dorada (#3B5773, variable por color) +
...
interface GoldenDuskTemplateAzulMedianocheProps {
...
export function GoldenDuskTemplateAzulMedianoche({ invitation, guest, isPersonalized = false }: GoldenDuskTemplateAzulMedianocheProps) {
    ...
    >
      <style>{`
        ...
        #countdown[data-style="clasico"].dark > div > div > div {
          ...
          border-color: rgba(59, 87, 115, 0.2) !important;
        }

        /* RSVP Custom Aesthetics for GoldenDuskTemplateAzulMedianoche */
        #rsvp.section.dark {
          background-color: #FDF6F0 !important;
          color: #3B2A2A !important;
        ...
        #rsvp.section.dark input {
          ...
          border: 1px solid rgba(59, 87, 115, 0.2) !important;
      ...
      {!isCoverOpen && (
        ...
        >
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(59,87,115,0.15), transparent), radial-gradient(45% 40% at 85% 80%, rgba(232,196,160,0.25), transparent)',
            backgroundSize: '160% 160%',
            animation: 'golden-meshDrift 14s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', width: 220, height: 220, borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(59,87,115,0.15), transparent 70%)',
          ...
          <IconBouquet className="golden-doodle opacity-0 absolute" style={{ width: 46, height: 48, top: '8%', left: '9%', color: 'rgba(59,87,115,0.55)' }} />
          ...
          <IconRanunculus className="golden-doodle opacity-0 absolute" style={{ width: 16, height: 16, bottom: '24%', right: '19%', color: 'rgba(59,87,115,0.4)' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="golden-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #3B5773',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#3B5773',
            }}>
              {monogram}
            </div>
            ...
            <button
              ...
              style={{
                ...
                background: 'rgba(59,87,115,0.08)', backdropFilter: 'blur(6px)',
                marginTop: '1rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#3B5773'; e.currentTarget.style.color = '#FDF6F0'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(59,87,115,0.08)'; e.currentTarget.style.color = '#3B5773'; }}
            >
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#3B5773]/40 shadow-md ${isTicketMaximized ? 'bg-[#FDF6F0]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#3B2A2A]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#3B5773', margin: '6px 0 14px', animation: 'golden-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#FDF6F0]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#FDF6F0] z-10 relative">
            ...
            <div style={{ width: 40, height: 2, background: '#3B5773', margin: '0 0 20px', animation: 'golden-lineExpand 1.2s ease-out' }} />
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
              <div className="absolute inset-0" style={{ border: "1px solid rgba(59,87,115,0.65)" }} />
              <IconVine style={{ position: "absolute", top: 6, left: -3, width: 16, height: "70%", color: "rgba(143,160,122,0.55)" }} />
              <IconOpenRose style={{ position: "absolute", top: -14, left: -12, width: 34, height: 34, color: "#3B5773" }} />
            ...
            {/* Resplandor cálido "atardecer": halo ámbar que crece/decrece +
                ...
                de scroll. */}
            <div ref={heroFlareRef} className="pointer-events-none z-20" style={{ position: "absolute", width: 140, height: 140, borderRadius: "50%", background: "radial-gradient(circle, rgba(255,224,178,0.9) 0%, rgba(59,87,115,0.4) 45%, transparent 72%)", opacity: 0, transform: "translate(-50%,-50%)" }} />
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#FDF6F0]" aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #3B5773, transparent)' }} />
          <IconSunHorizon className="golden-scroll-doodle opacity-0" style={{ width: 34, height: 17, color: '#3B5773' }} />
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #3B5773, transparent)' }} />
        </div>
          ...
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              ...
              <div className="bg-black/20 border-l-[2px] border-l-[#3B5773] p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#3B5773] hover:text-[#3B2A2A] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#3B5773] p-6 sm:p-8 mb-10 shadow-sm">
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#3B5773] hover:text-[#3B2A2A] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#FDF6F0' }} aria-hidden="true">
            <IconMusic className="golden-scroll-doodle opacity-0" style={{ width: 26, height: 26, color: '#3B5773' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
