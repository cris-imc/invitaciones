...
const GP_CSS = `
  ...
  .ifj-cover-names { margin: 0; font-family: var(--ifj-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #F8E2DE; }
