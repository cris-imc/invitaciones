    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="neon-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #B6FF3C',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#B6FF3C',
            }}>
              {monogram}
            </div>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#B6FF3C] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#0D0D10]" aria-hidden="true">
          <IconDiscoBall className="neon-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(182,255,60,0.4)' }} />
          <div style={{ width: 48, height: 1, background: 'linear-gradient(90deg, transparent, #FF2E9B, transparent)' }} />
          <IconSpark className="neon-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#FF2E9B' }} />
          <div style={{ width: 48, height: 1, background: 'linear-gradient(90deg, transparent, #FF2E9B, transparent)' }} />
          <IconDiscoBall className="neon-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(182,255,60,0.4)' }} />
        </div>
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0D0D10' }} aria-hidden="true">
            <IconMusic className="neon-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#B6FF3C' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
