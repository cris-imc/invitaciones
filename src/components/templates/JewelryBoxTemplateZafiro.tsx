          ...
          <div className="jwb-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="14,27,51" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="14,27,51" />
              </div>
            )}
...
function JwbCoverHalf({
  ...
  return (
    <div className="jwb-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#7FA8DB" tintColor2="#0E1B33" effect="enfoque" scrimColorRgb="14,27,51" />
        </div>
      )}
