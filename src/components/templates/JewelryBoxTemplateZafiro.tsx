  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="jwb-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="jwb-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #0F1B2E 0%, #06090F 52%, #0E1B33 100%)" }}>
            ...
            <div data-strip="1" className="jwb-strip">
              ...
              <div data-tone="light" className="jwb-panel jwb-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                ...
                <div className="jwb-album-embed">
                  {livePhotos.length > 0 ? (
                    <LiveAlbumStrip photos={livePhotos} tone="light" accentColor="#C9D2E0" />
                  ) : (
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="jwb-section" style={{ background: "#122A4A" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="jwb-section" style={{ background: "#122A4A" }}>
...
const JWB_CSS = `
  ...
  .jwb-cover-names { margin: 0; font-family: var(--jwb-cormorant), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #EAF1FA; }
