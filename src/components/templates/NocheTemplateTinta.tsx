...
/**
 * NocheTemplateTinta.tsx — Colección Paper · Papel Prensado · Familia 02 "Noche"
 * Variante: Tinta (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Tinta, Vino, Bosque, Bronce)
...
interface NocheTemplateTintaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function NocheTemplateTinta({ invitation, guest, isPersonalized = false }: NocheTemplateTintaProps) {
  const tx = useTextos();
