  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="prc-scroller">
        ...
        <div id="album" data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label={tx("invitacion.album.titulo")} className="prc-pan">
          <div className="prc-pan-sticky">
            <div data-strip="1" className="prc-strip">
              {photoPages.map((page, pageIndex) => (
                <div key={pageIndex} data-tone="light" className="prc-panel prc-panel--gap" style={{ background: ALBUM_TONES[pageIndex % ALBUM_TONES.length], color: "#14141B" }}>
                  ...
                  <div className="prc-seguir prc-seguir--split">
                    ...
                    <span className="prc-accent-serif-2">{tx("invitacion.portada.segui").toUpperCase() + " →"}</span>
                  </div>
                </div>
              ))}

              <div data-tone="light" className="prc-panel prc-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                <span className="prc-panel-top" style={{ display: "block" }}>{tx("invitacion.album.hoja", { n: String(photoPages.length + 1).padStart(2, "0"), etiqueta: "— " + tx("invitacion.enVivo.titulo").toUpperCase() }).toUpperCase()}</span>
                <h2 className="prc-panel-title">{tx("invitacion.album.tituloLinea1")}<br /><span className="prc-accent-serif">{tx("invitacion.album.tituloLinea2")}</span></h2>
                <div className="prc-album-embed">
                  {livePhotos.length > 0 ? (
                    <LiveAlbumStrip photos={livePhotos} tone="light" accentColor="#8C4A6E" />
                  ) : (
