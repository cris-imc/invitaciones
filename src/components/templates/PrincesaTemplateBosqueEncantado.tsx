          ...
          <div className="prc-hero-photo-frame">
            <div className="acp-mobile-only">
              {photoMobile ? (
                ...
                <div className="prc-hero-photo-placeholder" />
              )}
            </div>
...
const PRC_CSS = `
  ...
  .prc-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #244A2E 0%, #0F2417 60%, #0E1F16 100%); }
