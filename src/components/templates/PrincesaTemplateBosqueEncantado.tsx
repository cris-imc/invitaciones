...
export function PrincesaTemplateBosqueEncantado({ invitation, guest, isPersonalized = false }: PrincesaTemplateProps) {
  ...
  const coverKickerText = showGuestNameInCover ? "UN CUENTO DE HADAS PARA" : "UN CUENTO DE HADAS PARA LOS 15 DE";
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="prc-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="prc-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #13251A 0%, #070E0A 52%, #0E1F16 100%)" }}>
          <div data-drift="-130" className="prc-glow-blob" />
          <span data-xin="1" data-dist="-60" className="prc-kicker" style={{ position: "relative" }}>{knPre(3)} — UN MENSAJE PARA VOS</span>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label="El lugar" className="prc-pan" style={!scrollVertical && ceremoniaHabilitada ? { height: "340vh" } : undefined}>
            ...
            <div data-strip="1" className="prc-strip">
              {ceremoniaHabilitada && (
                <div id="ceremonia" data-tone="light" className="prc-panel prc-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                  ...
                  <div className="prc-seguir">SEGUÍ BAJANDO <span className="prc-side-hint">{scrollVertical ? "↓" : "→"}</span></div>
                </div>
              )}
        ...
        <div id="album" data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label="Álbum" className="prc-pan">
          <div className="prc-pan-sticky">
            <div data-strip="1" className="prc-strip">
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="prc-section" style={{ background: "#16311F" }}>
            <span data-xin="1" data-dist="-60" className="prc-kicker">{kn(6)} — SUGERENCIA DE MÚSICA</span>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="prc-section" style={{ background: "#16311F" }}>
            <span data-xin="1" data-dist="-60" className="prc-kicker">{sugerenciaMusicaHabilitada ? kn(7) : kn(6)} — REGALOS Y PAGOS</span>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="prc-section" style={{ background: "#16311F" }}>
            <span data-xin="1" data-dist="-60" className="prc-kicker">{knAcc([sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6)} — EL JUEGO</span>
          ...
          <div className="prc-rsvp-row prc-rsvp-row--payment">
            ...
            <div className="prc-rsvp-payment-value">
              ...
              {paymentStatus === "PARTIAL" && (
                <div className="prc-rsvp-payment-detail"><span>Pago parcial registrado</span></div>
              )}
      ...
      <div className="prc-cover-content">
        ...
        <div className="prc-cover-bottom">
          ...
          <div className="prc-barcode-wrap">
            ...
            <span className="prc-mini-label prc-mini-label--cover" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
