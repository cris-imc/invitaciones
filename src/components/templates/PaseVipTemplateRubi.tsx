          ...
          <div className="pvp-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="12,7,8" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="12,7,8" />
              </div>
            )}
...
function PvpCoverHalf({
  ...
  return (
    <div className="pvp-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#C23B4E" tintColor2="#0C0708" effect="enfoque" scrimColorRgb="12,7,8" />
        </div>
      )}
