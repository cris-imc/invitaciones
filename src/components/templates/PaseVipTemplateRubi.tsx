      ...
      <div ref={scrollerRef} data-scroller="1" className="pvp-scroller">
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="pvp-section" style={{ background: "#100A0B" }}>
            <span data-xin="1" data-dist="-60" className="pvp-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6 + kOffset} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu pase VIP" className="pvp-section pvp-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #1F1013 0%, #100A0B 55%, #0C0708 100%)" }}>
          <span data-xin="1" data-dist="-60" className="pvp-kicker">{[sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 6 + kOffset} — GUARDÁ TU PASE</span>
