          ...
          <div className="pvp-hero-photo-frame">
            <div className="acp-mobile-only">
              {photoMobile ? (
                ...
                <div className="pvp-hero-photo-placeholder" />
              )}
            </div>
...
const PVP_CSS = `
  ...
  .pvp-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #301418 0%, #100A0B 60%, #0C0708 100%); }
