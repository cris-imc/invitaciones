...
/**
 * ManuscritaTemplateCiruela.tsx — Colección Paper · Papelería Viva · Familia 03 "Manuscrita"
 * Variante: Ciruela (generada, no editar a mano).
 *
...
interface ManuscritaTemplateCiruelaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function ManuscritaTemplateCiruela({ invitation, guest, isPersonalized = false }: ManuscritaTemplateCiruelaProps) {
  const tx = useTextos();
