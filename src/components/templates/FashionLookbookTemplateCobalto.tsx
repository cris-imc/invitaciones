    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="flb-scroller">
            ...
            <div data-strip="1" className="flb-strip">
              ...
              <div data-tone="dark" className="flb-panel flb-panel--center" style={{ background: "#0B0D16", color: "#F4F1EA" }}>
                <div className="flb-medallion flb-medallion--lg">
                  <FlbMedallion kicker="SECTOR" main="Pasarela" sub="LOOK 04" subColor="#2F55D9" arcId="flbArc2" arcText={`ACCESO VIP · LOOK Nº ${passNumber} · `} spin="reverse" />
                </div>
            ...
            <div data-strip="1" className="flb-strip">
              ...
              <div data-tone="light" className="flb-panel flb-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                ...
                <div className="flb-album-embed">
                  {livePhotos.length > 0 ? (
                    <LiveAlbumStrip photos={livePhotos} tone="light" accentColor="#2F55D9" />
                  ) : (
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="flb-section" style={{ background: "#0B0D16" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="flb-section" style={{ background: "#0B0D16" }}>
