...
/**
 * HerbarioTemplateTinta.tsx — Colección Paper · Papel Prensado · Familia 04 "Herbario"
 * Variante: Tinta (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Eucalipto, Oliva, Ceniza,
 ...
 */
const ACENTO = "#55605C";
const FILTRO = "grayscale(1) sepia(1) hue-rotate(150deg) saturate(.45) brightness(.92)";
...
interface HerbarioTemplateTintaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function HerbarioTemplateTinta({ invitation, guest, isPersonalized = false }: HerbarioTemplateTintaProps) {
  const tx = useTextos();
