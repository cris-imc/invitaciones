    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="infantil-seal opacity-0 infantil-seal-wiggle" style={{
              width: 46, height: 46, borderRadius: '50%', border: '2px solid #4FB8E8',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, color: '#4FB8E8',
            }}>
              {monogram}
            </div>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-bold uppercase tracking-[0.15em] text-[#4FB8E8] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#FFF7F2]" aria-hidden="true">
          <IconCloudBlob className="infantil-scroll-doodle opacity-0" style={{ width: 30, height: 20, color: '#FF5C8A', opacity: 0.35 }} />
          <IconConfetti className="infantil-scroll-doodle opacity-0" style={{ width: 26, height: 13, color: '#4FB8E8' }} />
          ...
          <SectionWrapper id="album" delay={200} className="w-full bg-[#FFF0E4] py-20 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-10 flex items-center gap-2">
                <IconStar className="infantil-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#4FB8E8' }} />
                ÁLBUM
              </p>
            </div>
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#FFF7F2' }} aria-hidden="true">
            <IconMusic className="infantil-scroll-doodle opacity-0" style={{ width: 24, height: 24, color: '#4FB8E8' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
