          ...
          <div className="cme-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="25,18,13" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="25,18,13" />
              </div>
            )}
    ...
    <div className="cme-cover-inner">
      ...
      <div className="cme-cover-content">
        ...
        <div className="cme-cover-bottom">
          <div ref={perfRef} className="cme-perf-strip cme-perf-strip--reveal" />
          ...
          <div className="cme-barcode-wrap">
            <div className="cme-barcode" style={{ width: "62%" }} />
            <span className="cme-mini-label" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
...
const CME_CSS = `
  ...
  .cme-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #3A2A1E 0%, #26190F 60%, #19120D 100%); }
