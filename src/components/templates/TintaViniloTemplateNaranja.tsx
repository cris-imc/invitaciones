...
/**
 * TintaViniloTemplateNaranja.tsx — Colección Paper · Papelería Viva · Familia 04 "Tinta & Vinilo"
 * Variante: Naranja quemado (generada, no editar a mano).
 *
...
interface TintaViniloTemplateNaranjaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function TintaViniloTemplateNaranja({ invitation, guest, isPersonalized = false }: TintaViniloTemplateNaranjaProps) {
  const tx = useTextos();
