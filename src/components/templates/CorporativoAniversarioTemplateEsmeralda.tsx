  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="cpa-scroller">
        ...
        <div data-pan="1" data-screen-label="El lugar" className="cpa-pan">
          <div className="cpa-pan-sticky">
            <div data-strip="1" className="cpa-strip">
              <div id="details" data-tone="light" className="cpa-panel cpa-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                ...
                <div className="cpa-seguir">SEGUÍ BAJANDO <span className="cpa-side-hint">→</span></div>
              </div>
        ...
        {hasPayment && paymentAmount != null && !isExempt && (
          ...
          <div className="cpa-rsvp-row cpa-rsvp-row--payment">
            ...
            <div className="cpa-rsvp-payment-value">
              <span className="cpa-rsvp-payment-total">
                {formatARS(isPartialPayment ? paymentBalance : totalPayment)}
              </span>
              {isPaidInFull && (
                <div className="cpa-rsvp-payment-detail"><span>Pago registrado ✓</span></div>
              )}
              {isPartialPayment && (
