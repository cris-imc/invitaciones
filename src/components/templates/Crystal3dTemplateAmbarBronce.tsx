  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="c3d-scroller">
        ...
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="c3d-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #271A0D 0%, #170E08 52%, #120D08 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="c3d-section" style={{ background: "#170F09" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="c3d-section" style={{ background: "#170F09" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="c3d-section c3d-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #241A10 0%, #170F09 55%, #120D08 100%)" }}>
    ...
    <div className="c3d-cover-inner">
      ...
      <div className="c3d-cover-content">
        ...
        <div className="c3d-cover-bottom">
          <div ref={perfRef} className="c3d-perf-strip c3d-perf-strip--reveal" />
          ...
          <div className="c3d-barcode-wrap">
            <div className="c3d-barcode" style={{ width: "62%" }} />
            <span className="c3d-mini-label" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
...
const C3D_CSS = `
  ...
  .c3d-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 0%, #241A10 0%, #170F09 55%, #120D08 100%); }
  ...
  .c3d-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(232,169,76,0.4), rgba(199,148,98,0.5), rgba(232,169,76,0.55), rgba(232,169,76,0.4)); filter: blur(64px); opacity: .62; animation: gpFoil 26s linear infinite; }
  ...
  .c3d-cover-names { margin: 0; font-family: var(--c3d-poppins), sans-serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #FBE6C4; }
