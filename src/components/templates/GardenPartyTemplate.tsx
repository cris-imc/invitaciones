 ...
 * (#3A2A22) + acento terracota (#D97757, variable por color) + acento salvia
...
interface GardenPartyTemplateProps {
    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.background = '#D97757'; e.currentTarget.style.color = '#FFFFFF'; }}
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#D97757]/40 shadow-md rounded-full ${isTicketMaximized ? 'bg-[#FBF4EC]/95 backdrop-blur-md w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#3A2A22]/95 backdrop-blur-md px-5 py-2'}`}
        >
          {isTicketMaximized ? (
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#D97757', margin: '6px 0 14px', animation: 'gardenparty-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#FBF4EC]">
          <div className="px-8 pt-16 pb-12 text-left bg-[#FBF4EC] z-10 relative">
            ...
            <div style={{ width: 40, height: 2, background: '#D97757', margin: '0 0 20px', animation: 'gardenparty-lineExpand 1.2s ease-out' }} />
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
              ...
              <IconFlower style={{ position: "absolute", top: -12, left: -10, width: 26, height: 26, color: "#D97757" }} />
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#FBF4EC] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            ...
            {Boolean(invitation.ceremoniaHabilitada) && (
              <div className="bg-white border-l-[3px] border-l-[#D97757] p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#D97757] hover:text-[#3A2A22] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-white border-l-[3px] border-l-[#D97757] p-6 sm:p-8 mb-10 shadow-sm">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#8a7462] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#D97757] hover:text-[#3A2A22] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
