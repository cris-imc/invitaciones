...
export function BautismoTemplateVerdeSalvia({ invitation, guest, isPersonalized = false }: BautismoTemplateVerdeSalviaProps) {
  ...
  return (
    ...
    >
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="bts-section bts-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #161712 55%, #11120E 100%)" }}>
          ...
          <div data-xin="1" data-delay="100" data-dist="130" className="bts-final-card">
            <div className="bts-medallion bts-medallion--final">
              <BtsMedallionCmp label="LL" sub={confirmed ? "CONFIRMADO" : "PENDIENTE"} arcId="btsArc3" arcText={`${namesTitle.toUpperCase()} · ${fechaCorta} · `} spin="reverse" />
            </div>
      ...
      <div ref={coverRef} className="bts-cover">
    ...
    <div className="bts-cover-inner">
      ...
      <div className="bts-cover-content">
        <div className="bts-cover-top-row">
          <span>PASE Nº {passNumber}</span><span className="bts-accent-serif-2">ADMIT ONE</span>
        </div>
...
const GP_CSS = `
  ...
  .bts-cover-names { margin: 0; font-family: var(--bts-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #F2F7EF; }
