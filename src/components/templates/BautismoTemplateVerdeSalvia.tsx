  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="bts-scroller">
        ...
        <div data-pan="1" data-screen-label="El lugar" className="bts-pan">
          <div className="bts-pan-sticky">
            <div data-strip="1" className="bts-strip">
              <div id="details" data-tone="light" className="bts-panel bts-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                ...
                <div className="bts-seguir">SEGUÍ BAJANDO <span className="bts-side-hint">→</span></div>
              </div>
        ...
        {hasPayment && paymentAmount != null && !isExempt && (
          ...
          <div className="bts-rsvp-row bts-rsvp-row--payment">
            ...
            <div className="bts-rsvp-payment-value">
              <span className="bts-rsvp-payment-total">
                {formatARS(isPartialPayment ? paymentBalance : totalPayment)}
              </span>
              {isPaidInFull && (
                <div className="bts-rsvp-payment-detail"><span>Pago registrado ✓</span></div>
              )}
              {isPartialPayment && (
