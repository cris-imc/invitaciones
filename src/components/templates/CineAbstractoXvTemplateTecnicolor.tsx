...
export function CineAbstractoXvTemplateTecnicolor({ invitation, guest, isPersonalized = false }: CineAbstractoXvTemplateProps) {
 ...
 data-tone="dark" data-screen-label="Countdown" className="cxv-section cxv-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #0A1830 0%, #060B14 55%, #05070F 100%)" }}>
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="cxv-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #131A2E 0%, #0A0D16 52%, #05070F 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="cxv-section" style={{ background: "#0A101C" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="cxv-section" style={{ background: "#0A101C" }}>
