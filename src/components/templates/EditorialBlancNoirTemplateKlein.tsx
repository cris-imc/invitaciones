 ...
 * Variante: Klein. Es la familia BASE de la sub-colección: las otras
...
export function EditorialBlancNoirTemplateKlein({ invitation, guest, isPersonalized = false }: EditorialBlancNoirTemplateProps) {
  const tx = useTextos();
