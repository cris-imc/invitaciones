 ...
 * grafito cálido (#A97D2A, variable por color), tipografía grotesca
...
interface NordicoTemplateOcreProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#A97D2A]/25 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#A97D2A] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#A97D2A] shrink-0" />
...
export function NordicoTemplateOcre({ invitation, guest, isPersonalized = false }: NordicoTemplateOcreProps) {
  ...
  return (
    ...
    >
      <style>{`
        ...
        /* RSVP Custom Aesthetics for NordicoTemplateOcre */
        #rsvp.section.dark {
          background-color: #FFFFFF !important;
          color: #111111 !important;
          border: none !important;
        ...
        #banco .copy-btn.copied {
          background-color: #A97D2A !important;
          color: #FFFFFF !important;
        }
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <IconRegisterMark className="nordico-doodle opacity-0 absolute" style={{ width: 26, height: 26, top: '10%', left: '11%', color: 'rgba(169,125,42,0.55)' }} />
          <IconSquareDoodle className="nordico-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: '14%', right: '13%', color: 'rgba(169,125,42,0.5)' }} />
          <IconLineDoodle className="nordico-doodle opacity-0 absolute" style={{ width: 40, height: 8, bottom: '22%', left: '10%', color: 'rgba(169,125,42,0.4)' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem', position: 'relative' }}>
            ...
            <div className="nordico-seal opacity-0" style={{
              width: 40, height: 40, border: '1px solid #A97D2A',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, color: '#A97D2A',
            }}>
              {monogram}
            </div>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#A97D2A]/40 shadow-md ${isTicketMaximized ? 'bg-[#FFFFFF]/95 backdrop-blur-md w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#111111]/95 backdrop-blur-md px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#A97D2A] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
                <span className="text-[#111111] font-bold text-sm leading-none" style={{ fontFamily: 'var(--font-cormorant), serif' }}>{guest.name}</span>
              </div>
              <div className="flex flex-col items-end border-l border-[#A97D2A]/20 pl-3">
      ...
      <aside className="d-left hide-mobile" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#A97D2A', margin: '6px 0 14px', animation: 'nordico-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#FFFFFF]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#FFFFFF] z-10 relative">
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#A97D2A] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            <h1 className="text-[4rem] font-light text-[#111111] leading-[1.0] mb-3" style={{ fontFamily: 'var(--font-title, var(--font-cormorant)), serif' }}>
              {em ? (
                <>
                  <span className="block">{title.slice(0, title.indexOf(em)).trim()}</span>
                  <span className="block"><em style={{ fontFamily: 'var(--font-cormorant), serif', fontStyle: 'italic', color: '#A97D2A' }}>&amp;</em> {em.replace('& ', '').trim()}</span>
                </>
              ) : (
                <span className="block">{title}</span>
              )}
            </h1>
            <div style={{ width: 40, height: 2, background: '#A97D2A', margin: '0 0 20px', animation: 'nordico-lineExpand 1.2s ease-out' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#A97D2A] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#FFFFFF]" aria-hidden="true">
          ...
          <IconLineDoodle className="nordico-scroll-doodle opacity-0" style={{ width: 28, height: 6, color: '#A97D2A' }} />
          <div style={{ width: 40, height: 1, background: 'rgba(17,17,17,0.18)' }} />
        </div>
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#FFFFFF] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#A97D2A]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="border border-[#111111]/12 border-l-2 border-l-[#A97D2A] p-6 sm:p-8 mb-6">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#A97D2A] hover:text-[#111111] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="border border-[#111111]/12 border-l-2 border-l-[#A97D2A] p-6 sm:p-8 mb-10">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#6E6E6E] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  FIESTA / SALÓN
                </span>
                {lugarNombre && (
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#A97D2A] hover:text-[#111111] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16">
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#A97D2A]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
          ...
          <SectionWrapper id="album" delay={200} className="w-full bg-[#F5F4F1] py-20 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-10 flex items-center gap-2">
                <IconSquareDoodle className="nordico-scroll-doodle opacity-0" style={{ width: 11, height: 11, color: '#A97D2A' }} />
                ÁLBUM
              </p>
            </div>
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#F0EFEB] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#A97D2A]">
          ...
          <SectionWrapper id="quiz" delay={300} className="w-full py-20 px-6 md:px-12" style={{ background: "linear-gradient(160deg, #8A857818, transparent 70%), #F0EFEB" }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-8 flex items-center gap-2">
                <IconRegisterMark className="nordico-scroll-doodle opacity-0" style={{ width: 13, height: 13, color: '#A97D2A' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#F0EFEB' }} aria-hidden="true">
            <IconMusic className="nordico-scroll-doodle opacity-0" style={{ width: 24, height: 24, color: '#A97D2A' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
        ...
        <div className="w-full flex items-center justify-center gap-2 py-6" style={{ background: '#FFFFFF' }} aria-hidden="true">
          ...
          <IconRegisterMark className="nordico-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#A97D2A' }} />
          <div style={{ width: 28, height: 1, background: 'rgba(17,17,17,0.15)' }} />
        </div>
