...
export function ModernoTemplateBordo({ invitation, guest, isPersonalized = false }: ModernoTemplateBordoProps) {
  ...
  const portadaTintColor2 = "#1A070A";
  ...
  return (
    ...
    >
      ...
      {!isCoverOpen && (
        <div
          style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100dvh', zIndex: 99999, backgroundColor: '#120406', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', paddingTop: '25vh', overflow: 'hidden', ...getTypographyCssVars(invitation.fontTitle as string, invitation.fontBody as string) }}
        ...
        >
          {isTicketMaximized ? (
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#1A070A]  text-[10px] font-semibold tracking-wider uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{tx("invitacion.pase.pase")}</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="d-right tpl">
        ...
        {mapUrl && (
          <section id="location" style={{ height: "220px", overflow: "hidden", background: "#120406" }}>
