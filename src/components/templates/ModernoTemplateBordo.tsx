...
export function ModernoTemplateBordo({ invitation, guest, isPersonalized = false }: ModernoTemplateBordoProps) {
  ...
  return (
    ...
    >
      ...
      {!isCoverOpen && (
        <div 
          style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100dvh', zIndex: 99999, backgroundColor: '#120406', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', paddingTop: '25vh', overflow: 'hidden' }}
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#120406]">
          {/* Text Container */}
          <div className="px-8 pt-16 pb-12 text-left bg-[#120406] z-10 relative">
          ...
          <div className="flex-1 w-full relative">
            <div className="absolute inset-x-0 bottom-0 h-1/2 pointer-events-none z-10" style={{ background: 'linear-gradient(to bottom, transparent 0%, #120406 100%)' }} />
            <div
