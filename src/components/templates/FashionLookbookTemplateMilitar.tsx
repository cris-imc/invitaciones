  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#080906", tinta: "#F4F1EA", acento: "#6B8F3B", clase: `${flbArchivo.variable} ${flbMono.variable}`, fuente: "var(--flb-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#6B8F3B" guest={guest} />
      )}
...
const FLB_CSS = `
  ...
  @media (min-width: 768px) {
    .flb-hero-photo-frame { inset: 64px max(24px, calc((100% - 900px) / 2)); border: 1px solid rgba(107,143,59,.3); }
  ...
  .flb-cal-link:hover { color: #6B8F3B; }
