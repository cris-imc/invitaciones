...
// CiudadDePapelTemplate.tsx — no editar a mano: los cambios se pierden al regenerar.

/**
 * CIUDAD DE PAPEL · Colección Iconic — sub-colección "Capas de papel"
 * Variante: Terracota urbana
 *
...
export function CiudadDePapelTemplateTerracota({ invitation, guest, isPersonalized = false }: CiudadDePapelTemplateProps) {
  const tx = useTextos();
