  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#070B09", tinta: "#F4F1EA", acento: "#3F9C74", clase: `${myoItaliana.variable} ${myoCormorant.variable} ${myoMono.variable}`, fuente: "var(--myo-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="myo-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label={tx("invitacion.frase.etiqueta")} className="myo-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #122A22 0%, #070F0A 52%, #070B09 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="myo-section" style={{ background: "#0F1512" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="myo-section" style={{ background: "#0F1512" }}>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#3F9C74" guest={guest} />
      )}
...
const MYO_CSS = `
  ...
  .myo-cal-link:hover { color: #3F9C74; }
