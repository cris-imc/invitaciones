  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="myo-scroller">
        ...
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="myo-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #122A22 0%, #0C0B11 52%, #070B09 100%)" }}>
