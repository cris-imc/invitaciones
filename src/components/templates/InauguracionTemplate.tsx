...
interface InauguracionTemplateProps {
...
export function InauguracionTemplate({ invitation, guest, isPersonalized = false }: InauguracionTemplateProps) {
  const tx = useTextos();
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#0B0B0B" : "#C8A45C";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#080808", tinta: "#F4F1EA", acento: "#C8A45C", clase: `${ingDisplay.variable} ${ingMono.variable}`, fuente: "var(--ing-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="ing-scroller">
        ...
        <section data-tone="dark" data-screen-label="Save the Date" className="ing-section" style={{ background: "radial-gradient(120% 80% at 50% 0%, #17141F 0%, #0B0B0B 55%, #080808 100%)" }}>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label={tx("invitacion.ubicacion.elLugar")} className="ing-pan">
          <div className="ing-pan-sticky">
            <div data-strip="1" className="ing-strip">
              ...
              <div data-tone="dark" className="ing-panel ing-panel--center" style={{ background: "#0B0B0B", color: "#F4F1EA" }}>
        ...
        <section data-tone="dark" data-screen-label="Check-in" className="ing-section" style={{ background: "radial-gradient(110% 70% at 50% 100%, #17141F 0%, #0B0B0B 60%, #080808 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="ing-section" style={{ background: "#0B0B0B" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="ing-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="ing-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F5F2ED" : "#C8A45C" }} />
              ))}
            </div>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="ing-section" style={{ background: "#0B0B0B" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="ing-section" style={{ background: "#0B0B0B" }}>
        ...
        <section data-tone="dark" data-screen-label={tx("invitacion.pase.tuPase")} className="ing-section ing-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #0B0B0B 55%, #080808 100%)" }}>
...
const GP_CSS = `
  ...
  .ing-date-month { font-family: var(--ing-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #C8A45C; padding-left: 12%; }

  .ing-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .ing-divider-line { width: 52px; height: 1px; background: #C8A45C; display: inline-block; }
  ...
  .ing-cal-link:hover { color: #C8A45C; }
  ...
  .ing-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #C8A45C, #F5F2ED, #6E5AA8); filter: saturate(.75); }
  ...
  .ing-medallion-label { font-family: var(--ing-display), serif; font-size: 26px; line-height: 1; color: #F5F2ED; }
  .ing-medallion-label-sm { font-family: var(--ing-display), serif; font-size: 16px; color: #F5F2ED; }
  .ing-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .ing-medallion-sub--accent { color: #C8A45C; }
  ...
  .ing-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #C8A45C; opacity: 0.4; font-family: var(--ing-mono), monospace; }
  ...
  .ing-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #F5F2ED, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .ing-cd-num { font-family: var(--ing-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F5F2ED; display: inline-block; }
  .ing-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #C8A45C; }
  ...
  .ing-accent-italic { font-style: italic; color: #C8A45C; }
  .ing-accent-serif { font-style: italic; color: #0B0B0B; font-family: var(--ing-display), serif; }
  .ing-accent-serif-2 { color: #0B0B0B; }
  ...
  .ing-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #0B0B0B; margin-top: auto; }
  ...
  .ing-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #0B0B0B; }
  ...
  .ing-crono-time { font-family: var(--ing-mono), monospace; color: #0B0B0B; min-width: 42px; }
  ...
  .ing-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #F5F2ED, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .ing-rsvp-payment-total { color: #F5F2ED; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .ing-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #C8A45C; background: transparent; color: #C8A45C; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .ing-rsvp-input:focus { outline: none; border-bottom-color: #C8A45C; }
  .ing-rsvp-btn { width: 100%; padding: 16px; font-family: var(--ing-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #C8A45C, #0B0B0B); border: 1px solid #C8A45C; color: #0B0B0B; cursor: pointer; }
  .ing-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .ing-rsvp-btn--ghost { background: transparent; color: #C8A45C; }
  .ing-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #C8A45C; margin: 0; }
  ...
  .ing-bank-copy { flex-shrink: 0; font-family: var(--ing-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #C8A45C; background: transparent; color: #C8A45C; cursor: pointer; }
  ...
  .ing-song-input:focus { outline: none; border-bottom-color: #C8A45C; }
  .ing-song-sep { color: #8A8577; flex-shrink: 0; }
  .ing-song-submit { flex-shrink: 0; background: none; border: none; color: #C8A45C; font-family: var(--ing-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .ing-song-submit:hover { color: #F5F2ED; }
  .ing-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .ing-song-error { font-size: 10px; color: #C8A45C; margin-top: 6px; }
  ...
  .ing-quiz-opt { font-family: var(--ing-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #C8A45C; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .ing-quiz-opt:disabled { cursor: default; }
  .ing-quiz-opt--picked { background: #C8A45C; border-color: #C8A45C; color: #0B0B0B; }
  .ing-quiz-opt--correct { background: #C8A45C; border-color: #C8A45C; color: #0B0B0B; }
  ...
  .ing-quiz-result-score { margin: 0 0 6px; font-family: var(--ing-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #F5F2ED; }
  .ing-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .ing-final-card { border: 1px solid #C8A45C; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .ing-final-names { font-family: var(--ing-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #F5F2ED; }
  ...
  .ing-replay { cursor: pointer; color: #C8A45C; }
  ...
  .ing-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F5F2ED, #C8A45C); transition: height 260ms linear; display: block; }
  .ing-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #C8A45C; transition: color 500ms ease; }
  ...
  .ing-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #141414 0%, #0B0B0B 46%, #080808 100%); }
  .ing-cover-half--bottom .ing-cover-inner { top: auto; bottom: 0; }
  .ing-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(200,164,92,0.35), rgba(11,11,11,0.5), rgba(200,164,92,0.5), rgba(200,164,92,0.35)); filter: blur(64px); opacity: .62; animation: bbsFoil 26s linear infinite; }
  .ing-cover-texture { position: absolute; inset: 0; background-image: linear-gradient(90deg, rgba(245,242,237,.08) 1px, transparent 1px); background-size: 44px 100%; }
  ...
  .ing-cover-names { margin: 0; font-family: var(--ing-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #F5F2ED; }
  .ing-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#C8A45C, transparent); display: block; }
  ...
  .ing-cover-cta { border: 1px solid #C8A45C; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--ing-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  .ing-cover-cta--btn { cursor: pointer; border-radius: 0; }
  @media (hover: hover) {
    .ing-cover-cta--btn:hover { background: linear-gradient(100deg, rgba(232,214,168,0.34), rgba(246,239,221,0.5), rgba(232,214,168,0.34)); color: #0B0B0B; }
  }
  ...
  .ing-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #C8A45C; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
