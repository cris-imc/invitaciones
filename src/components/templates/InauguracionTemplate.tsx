    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="ing-scroller">
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="ing-section" style={{ background: "#0B0B0B" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="ing-section" style={{ background: "#0B0B0B" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="ing-section ing-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #0B0B0B 55%, #080808 100%)" }}>
...
const GP_CSS = `
  ...
  .ing-cover-names { margin: 0; font-family: var(--ing-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #F5F2ED; }
