...
export function ModernoTemplateVerde({ invitation, guest, isPersonalized = false }: ModernoTemplateVerdeProps) {
  ...
  return (
    ...
    >
      ...
      {!isCoverOpen && (
        <div 
          style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100dvh', zIndex: 99999, backgroundColor: '#05120B', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', paddingTop: '25vh', overflow: 'hidden' }}
