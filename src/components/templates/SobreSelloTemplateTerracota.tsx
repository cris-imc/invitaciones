...
interface SobreSelloTemplateTerracotaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function SobreSelloTemplateTerracota({ invitation, guest, isPersonalized = false }: SobreSelloTemplateTerracotaProps) {
  const tx = useTextos();
