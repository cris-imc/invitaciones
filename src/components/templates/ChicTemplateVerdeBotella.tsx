  ...
  return (
    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="chic-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #3F5F4A',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#3F5F4A',
            }}>
              {monogram}
            </div>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#3F5F4A] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#FAFCF9]  text-[10px] font-semibold tracking-wider uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#EFF4EC]" aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #3F5F4A, transparent)' }} />
          <IconRings className="chic-scroll-doodle opacity-0" style={{ width: 26, height: 17, color: '#3F5F4A' }} />
          <IconHeartDoodle className="chic-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#3F5F4A' }} />
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #3F5F4A, transparent)' }} />
        </div>
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#EFF4EC' }} aria-hidden="true">
            <IconMusic className="chic-scroll-doodle opacity-0" style={{ width: 26, height: 26, color: '#3F5F4A' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
