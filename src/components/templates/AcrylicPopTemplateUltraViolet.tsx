      ...
      <div ref={scrollerRef} data-scroller="1" className="acp-scroller">
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="acp-section acp-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #221030 0%, #180D22 55%, #120A18 100%)" }}>
          ...
          <div className="acp-cd-grid">
            ...
            <AcpCdBox refEl={sRef} delay={280} dist={170} label="SEG" numColor="#FFD23D" />
          </div>
          <div className="acp-perf-strip" />
        </section>

        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="acp-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #241232 0%, #140A1C 52%, #120A18 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="acp-section" style={{ background: "#170D20" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="acp-section" style={{ background: "#170D20" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="acp-section acp-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #1E1029 0%, #170D20 55%, #120A18 100%)" }}>
