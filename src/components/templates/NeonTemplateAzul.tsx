    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="neon-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #3C8CFF',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#3C8CFF',
            }}>
              {monogram}
            </div>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#0D0D10]" aria-hidden="true">
          <IconDiscoBall className="neon-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(60,140,255,0.4)' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0D0D10' }} aria-hidden="true">
            <IconMusic className="neon-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#3C8CFF' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
