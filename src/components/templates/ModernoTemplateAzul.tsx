 ...
 * Cambia solo la capa visual: paleta grafito (#050B14) + dorado champagne (#C9A876)
...
interface ModernoTemplateAzulProps {
...
export function ModernoTemplateAzul({ invitation, guest, isPersonalized = false }: ModernoTemplateAzulProps) {
  ...
  if (eventStatus === "POST_EVENT") {
    return (
      <div className="min-h-screen w-full bg-gradient-to-b bg-[#050B14] text-white relative overflow-x-hidden flex flex-col justify-between" data-theme={theme}>
  ...
  return (
    <>
      <style>{`
        ...
        #rsvp.section.dark {
          background-color: #050B14 !important; /* Dark brown/black */
        ...
        #songs.d-sec.dark {
          background-color: #050B14 !important; /* Light theme */
        ...
        #songs.d-sec.dark input {
          ...
          background-color: #0A1321 !important; /* Pastel */
        ...
        .desktop-stage .d-foot {
          background-color: #050B14 !important; /* Matches light sections */
          color: #FFFFFF !important;
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.background = '#C9A876'; e.currentTarget.style.color = '#050B14'; }}
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#C9A876]/40 shadow-md ${isTicketMaximized ? 'bg-[#050B14]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#0A1321] font-sans text-[10px] font-semibold tracking-wider uppercase">Pase</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#050B14] relative">
        ...
        {(Boolean(invitation.frasePersonalizadaHabilitada) && Boolean(invitation.frasePersonalizadaTexto)) ? (
          <SectionWrapper id="quote" delay={100} className="w-full bg-[#0A1321] py-24 px-6 md:px-12 flex items-center justify-center">
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#050B14] py-20 px-6 md:px-12">
        ...
        {(invitation.galeriaPrincipalHabilitada ?? true) && allPhotos.length > 0 && (
          <SectionWrapper id="album" delay={200} className="w-full bg-[#0A1321] py-20 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#050B14] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                    ...
                    {showBankDetails && (
                      <div className="grid grid-cols-1 gap-6 text-left w-full mt-4 items-stretch">
                        ...
                        {pagoTarjetaHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#0A1321] space-y-2">
                        ...
                        <>
                          ...
                          {showBankDetails && (
                            <div className="w-full text-left mt-4">
                              <div className="px-4 py-5 sm:p-5 bg-[#0A1321] space-y-1">
        ...
        {triviaHabilitada && triviaPreguntas.length > 0 && (
          <SectionWrapper id="quiz" delay={300} className="w-full bg-[#0A1321] py-20 px-6 md:px-12">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-8">
