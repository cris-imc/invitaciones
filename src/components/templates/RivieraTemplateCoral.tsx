 ...
 * tinta café (#3E2E20) + acento terracota (#D97757, variable por color),
...
interface RivieraTemplateCoralProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#D97757]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#D97757] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(62,46,32,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(62,46,32,0.12)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#D97757] shrink-0" />
...
export function RivieraTemplateCoral({ invitation, guest, isPersonalized = false }: RivieraTemplateCoralProps) {
  ...
  return (
    ...
    >
      <style>{`
        ...
        /* RSVP Custom Aesthetics for RivieraTemplateCoral */
        #rsvp.section.dark {
          background-color: #FAF1E4 !important;
          color: #3E2E20 !important;
        ...
        #rsvp.section.dark input {
          ...
          border: 1px solid rgba(217,119,87, 0.2) !important;
        ...
        #songs.d-sec.dark .t-kicker {
          font-family: var(--font-body-custom, var(--font-inter)), sans-serif !important;
          color: #D97757 !important; /* Gold/Orange */
          font-size: 11px !important;
          font-weight: 600 !important;
          text-transform: uppercase !important;
          letter-spacing: 0.2em !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(217,119,87,0.14), transparent), radial-gradient(45% 40% at 85% 80%, rgba(232,165,121,0.24), transparent)',
          ...
          <IconArch className="riviera-doodle opacity-0 absolute" style={{ width: 30, height: 32, top: '9%', left: '11%', color: 'rgba(217,119,87,0.5)' }} />
          <IconSun className="riviera-doodle opacity-0 absolute" style={{ width: 22, height: 22, top: '15%', right: '13%', color: 'rgba(217,119,87,0.5)' }} />
          ...
          <IconSun className="riviera-doodle opacity-0 absolute" style={{ width: 14, height: 14, bottom: '26%', right: '17%', color: 'rgba(217,119,87,0.35)' }} />
          </div>
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="riviera-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #D97757',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#D97757',
            }}>
              {monogram}
            </div>
            ...
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.background = '#D97757'; e.currentTarget.style.color = '#FAF1E4'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(217,119,87,0.08)'; e.currentTarget.style.color = '#D97757'; }}
            >
              ABRIR INVITACIÓN
            </button>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#D97757]/40 shadow-md ${isTicketMaximized ? 'bg-[#FAF1E4]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#3E2E20]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#D97757] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
                <span className="text-[#3E2E20] font-bold text-sm leading-none" style={{ fontFamily: 'var(--font-cormorant), serif' }}>{guest.name}</span>
              </div>
              <div className="flex flex-col items-end border-l border-[#D97757]/20 pl-3">
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              <Ticket className="w-4 h-4 text-[#D97757]" />
      ...
      <aside className="d-left hide-mobile" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#D97757', margin: '6px 0 14px', animation: 'riviera-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#FAF1E4]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#FAF1E4] z-10 relative">
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#D97757] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            <h1 className="text-[4rem] font-light text-[#3E2E20] leading-[1.0] mb-3" style={{ fontFamily: 'var(--font-title, var(--font-cormorant)), serif' }}>
              {em ? (
                <>
                  <span className="block">{title.slice(0, title.indexOf(em)).trim()}</span>
                  <span className="block"><em style={{ fontFamily: 'var(--font-cormorant), serif', fontStyle: 'italic', color: '#D97757' }}>&amp;</em> {em.replace('& ', '').trim()}</span>
                </>
              ) : (
                <span className="block">{title}</span>
              )}
            </h1>
            <div style={{ width: 40, height: 2, background: '#D97757', margin: '0 0 20px', animation: 'riviera-lineExpand 1.2s ease-out' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#D97757] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden" style={{ borderRadius: "0 0 50% 50% / 0 0 9% 9%" }}>
            ...
            <div ref={heroGhostRef} className="pointer-events-none z-20" style={{ position: "absolute", width: 34, height: 34, borderRadius: "50%", background: "radial-gradient(circle, rgba(217,119,87,0.5), transparent 70%)", opacity: 0, transform: "translate(-50%,-50%)" }} />
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#FAF1E4]" aria-hidden="true">
          ...
          <IconSun className="riviera-scroll-doodle opacity-0" style={{ width: 22, height: 22, color: '#D97757' }} />
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#FAF1E4] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#D97757] p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#D97757] hover:text-[#3E2E20] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#D97757] p-6 sm:p-8 mb-10 shadow-sm">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#8A7862] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  FIESTA / SALÓN
                </span>
                {lugarNombre && (
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#D97757] hover:text-[#3E2E20] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
              ...
              <div className="mt-16">
                ...
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex flex-col sm:flex-row sm:items-center py-4 border-b border-[#D97757]/10 last:border-b-0">
                      {item.time && (
          ...
          <SectionWrapper id="album" delay={200} className="w-full bg-[#F5E9D8] py-20 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-10 flex items-center gap-2">
                <IconSun className="riviera-scroll-doodle opacity-0" style={{ width: 15, height: 15, color: '#D97757' }} />
                ÁLBUM
              </p>
            </div>
          ...
          <SectionWrapper id="quiz" delay={300} className="w-full py-20 px-6 md:px-12" style={{ background: "linear-gradient(160deg, #7A8F6B18, transparent 70%), #F0E4D0" }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-8 flex items-center gap-2">
                <IconSun className="riviera-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#D97757' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#F0E4D0' }} aria-hidden="true">
            <IconMusic className="riviera-scroll-doodle opacity-0" style={{ width: 26, height: 26, color: '#D97757' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
        ...
        <div className="w-full flex items-center justify-center gap-2 py-6" style={{ background: '#FAF1E4' }} aria-hidden="true">
          <div style={{ width: 28, height: 1, background: 'linear-gradient(90deg, transparent, #D97757, transparent)' }} />
          <IconOlive className="riviera-scroll-doodle opacity-0" style={{ width: 20, height: 10, color: '#7A8F6B' }} />
          <div style={{ width: 28, height: 1, background: 'linear-gradient(90deg, transparent, #D97757, transparent)' }} />
        </div>
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#D97757" surfaceColor="#FFFFFF" />}
      </div>
  );
}
