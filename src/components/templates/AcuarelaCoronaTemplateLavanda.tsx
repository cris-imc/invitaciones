...
/**
 * AcuarelaCoronaTemplateLavanda.tsx — Colección Paper · Papelería Viva · Familia 02 "Acuarela & Corona"
 * Variante: Lavanda (generada, no editar a mano).
 *
...
interface AcuarelaCoronaTemplateLavandaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function AcuarelaCoronaTemplateLavanda({ invitation, guest, isPersonalized = false }: AcuarelaCoronaTemplateLavandaProps) {
  const tx = useTextos();
