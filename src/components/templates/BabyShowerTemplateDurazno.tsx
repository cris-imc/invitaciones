...
export function BabyShowerTemplateDurazno({ invitation, guest, isPersonalized = false }: BabyShowerTemplateDuraznoProps) {
  ...
  const coverKickerText = showGuestNameInCover ? "UNA INVITACIÓN ESPECIAL PARA" : "ESPERAMOS CON AMOR LA LLEGADA DE";
  ...
  const portadaMensaje = String(
    invitation.portadaMensaje || "Guardá la fecha. Vamos a celebrar esta espera juntos."
  );
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="bbs-scroller">
        <section data-tone="dark" data-screen-label="Save the Date" className="bbs-section" style={{ background: "radial-gradient(120% 80% at 50% 0%, #17141F 0%, #191420 55%, #14101A 100%)" }}>
          <span data-xin="1" data-dist="-60" className="bbs-kicker">01 — GUARDÁ LA FECHA</span>
          ...
          <div data-drift="-70" className="bbs-medallion bbs-medallion--corner">
            <BbsMedallionCmp label="BB" sub="ACCESO" arcId="bbsArc1" arcText="BABY SHOWER · ACCESO · " spin="normal" />
          </div>
        </section>
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="bbs-section bbs-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #2A2032 0%, #0D0B10 55%, #14101A 100%)" }}>
          ...
          <div className="bbs-cd-grid">
            <BbsCdBox refEl={dRef} delay={40} dist={-90} label="DÍAS" />
            <BbsCdBox refEl={hRef} delay={120} dist={110} label="HORAS" />
            <BbsCdBox refEl={mRef} delay={200} dist={-140} label="MIN" />
            <BbsCdBox refEl={sRef} delay={280} dist={170} label="SEG" />
          </div>
          <div className="bbs-perf-strip" />
        </section>

        {hasFrase && (
          <section id="quote" data-tone="dark" data-screen-label="Frase" className="bbs-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1C1727 0%, #0C0B11 52%, #14101A 100%)" }}>
            <div data-drift="-130" className="bbs-glow-blob" />
            <span data-xin="1" data-dist="-60" className="bbs-kicker" style={{ position: "relative" }}>{knPre(3)} — UN MENSAJE PARA VOS</span>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label="El lugar" className="bbs-pan">
          <div className="bbs-pan-sticky">
            <div data-strip="1" className="bbs-strip">
              <div id="details" data-tone="light" className="bbs-panel bbs-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                ...
                <div className="bbs-facts">
                  ...
                  {dressCode && (
                    <div className="bbs-facts-row bbs-facts-row--last">
                      <span>CÓDIGO</span><span className="bbs-accent-serif-2">{dressCode.toUpperCase()}</span>
                    </div>
                  )}
                </div>
                {cronograma.length > 0 && (
                ...
                <div className="bbs-seguir">SEGUÍ BAJANDO <span className="bbs-side-hint">{scrollVertical ? "↓" : "→"}</span></div>
              </div>
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="bbs-panel bbs-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  ...
                  <div className="bbs-panel-block">
                    ...
                    <span className="bbs-panel-title-sm">Cómo llegar</span>
              ...
              <div data-tone="dark" className="bbs-panel bbs-panel--center" style={{ background: "#191420", color: "#F4F1EA" }}>
                <div className="bbs-medallion bbs-medallion--lg">
                  <BbsMedallionCmp label={dressCode ? dressCode.toUpperCase() : "ACCESO"} sub={`PASE Nº ${passNumber}`} arcId="bbsArc2" arcText={`ACCESO VIP · PASE Nº ${passNumber} · `} spin="reverse" title="Reservado" />
                </div>
                <span className="bbs-mini-label">{LUGAR_PANEL_COUNT} / {LUGAR_PANEL_COUNT} — TU UBICACIÓN</span>
                {/* mesa-en-ubicacion */}
        ...
        <section data-tone="dark" data-screen-label="Check-in" className="bbs-section" style={{ background: "radial-gradient(110% 70% at 50% 100%, #17141F 0%, #191420 60%, #14101A 100%)" }}>
          ...
          <h2 data-xin="1" data-delay="80" data-dist="130" className="bbs-h2">
            Confirmá<br /><span className="bbs-accent-italic">tu acceso</span>
          </h2>
          ...
          {rsvpEnabled ? (
            ...
            <p className="bbs-lead">La confirmación de asistencia está cerrada por el momento.</p>
          )}
        </section>
            ...
            <div data-strip="1" className="bbs-strip">
              {photoPages.map((page, pageIndex) => (
                <div key={pageIndex} data-tone="light" className="bbs-panel bbs-panel--gap" style={{ background: ALBUM_TONES[pageIndex % ALBUM_TONES.length], color: "#14141B" }}>
                  ...
                  {pageIndex === 0 && <h2 className="bbs-panel-title-md">Álbum <span className="bbs-accent-serif">de fotos</span></h2>}
                  <div className="bbs-mosaic">
                    {page.length > 0 ? page.map((url, i) => (
                      ...
                      <span className="bbs-photo-placeholder">Sin fotos todavía</span>
                    )}
                  </div>
                  <div className="bbs-seguir bbs-seguir--split">
                    <span>{allPhotos.length} FOTOS SUBIDAS</span>
                    <span className="bbs-accent-serif-2">SEGUÍ →</span>
                  </div>
                </div>
              ))}

              <div data-tone="light" className="bbs-panel bbs-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                <span className="bbs-panel-top" style={{ display: "block" }}>HOJA {String(photoPages.length + 1).padStart(2, "0")} — EN VIVO</span>
                <h2 className="bbs-panel-title">Todo lo que<br /><span className="bbs-accent-serif">vamos a recordar</span></h2>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="bbs-section" style={{ background: "#191420" }}>
            <span data-xin="1" data-dist="-60" className="bbs-kicker">{kn(6)} — SUGERENCIA DE MÚSICA</span>
            <h2 data-xin="1" data-delay="80" data-dist="140" className="bbs-h2">¿Qué nombre<br /><span className="bbs-accent-italic">te gusta más?</span></h2>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="bbs-section" style={{ background: "#191420" }}>
            <span data-xin="1" data-dist="-60" className="bbs-kicker">{sugerenciaMusicaHabilitada ? kn(7) : kn(6)} — REGALOS Y PAGOS</span>
            <h2 data-xin="1" data-delay="80" data-dist="140" className="bbs-h2">
              Si querés<br /><span className="bbs-accent-italic">sumarte</span>
            </h2>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="bbs-section" style={{ background: "#191420" }}>
            <span data-xin="1" data-dist="-60" className="bbs-kicker">{knAcc([sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6)} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="bbs-section bbs-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #191420 55%, #14101A 100%)" }}>
          <span data-xin="1" data-dist="-60" className="bbs-kicker">{knAcc([sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 6)} — GUARDÁ TU PASE</span>
          <div data-xin="1" data-delay="100" data-dist="130" className="bbs-final-card">
            <div className="bbs-medallion bbs-medallion--final">
              <BbsMedallionCmp label="BB" sub={confirmed ? "CONFIRMADO" : "PENDIENTE"} arcId="bbsArc3" arcText={textoArco(namesTitle, fechaCorta)} spin="reverse" />
            </div>
            <span className="bbs-mini-label bbs-accent-serif-2">PASE Nº {passNumber} · ADMIT {guestAdults + guestTeens + guestChildren || 1}</span>
          ...
          <div className="bbs-final-footer">
            ...
            <span className="bbs-replay" onClick={reset}>VER LA APERTURA OTRA VEZ ↺</span>
          </div>
      ...
      <div ref={railRef} className="bbs-rail">
        <span ref={railTopRef} className="bbs-rail-top">PASE Nº {passNumber}</span>
      ...
      <div ref={coverRef} className="bbs-cover" style={{ "--esc": escalaTitulo(largoTitulo(showGuestNameInCover ? coverGuestName : namesTitle)) } as React.CSSProperties}>
        <div ref={topRef} className="bbs-cover-half bbs-cover-half--top">
          ...
          >
            <div className="bbs-cover-cta">ABRIR INVITACIÓN</div>
          </BbsCoverHalf>
        </div>
        <div ref={bottomRef} className="bbs-cover-half bbs-cover-half--bottom">
          <BbsCoverHalf
            ...
            photoDesktop={photoDesktop}
          >
            <button onClick={open} className="bbs-cover-cta bbs-cover-cta--btn">ABRIR INVITACIÓN</button>
          </BbsCoverHalf>
        </div>
      </div>

      <div ref={hintRef} className="bbs-hint">DESLIZÁ ↓</div>
  ...
  return (
    <>
      ...
      <div className="bbs-medallion-core">
        {title && <span className="bbs-medallion-sub">SECTOR</span>}
  ...
  if (status === "DECLINED") {
    return (
      <div className="bbs-rsvp-declined">
        <p className="bbs-rsvp-declined-text">Gracias por avisarnos. Si cambiás de idea, este mismo acceso sigue activo.</p>
  ...
  return (
    <>
      <div className="bbs-rsvp-rows">
        ...
        {status === "CONFIRMED" && (
          <>
            {totalGuests > 1 && adultCount > 0 && <div className="bbs-rsvp-row"><span>ADULTOS</span><span>{String(adultCount).padStart(2, "0")}</span></div>}
            {teenCount > 0 && <div className="bbs-rsvp-row"><span>ADOLESCENTES</span><span>{String(teenCount).padStart(2, "0")}</span></div>}
            {childCount > 0 && <div className="bbs-rsvp-row"><span>NIÑOS</span><span>{String(childCount).padStart(2, "0")}</span></div>}
          </>
        )}
          ...
          <div className="bbs-rsvp-row bbs-rsvp-row--payment">
            ...
            <div className="bbs-rsvp-payment-value">
              ...
              {paymentStatus === "PARTIAL" && (
                <div className="bbs-rsvp-payment-detail"><span>Pago parcial registrado</span></div>
              )}
    ...
    <div className="bbs-song">
      <form onSubmit={handleSubmit} className="bbs-song-row">
        <div className="bbs-song-inputs">
          <input value={artist} onChange={(e) => setArtist(e.target.value)} placeholder="ARTISTA" maxLength={80} className="bbs-song-input" />
          <span className="bbs-song-sep">—</span>
          <input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="TEMA" maxLength={100} className="bbs-song-input" />
        </div>
        ...
        <div className="bbs-song-list">
          {songs.slice(0, 12).map((s, i) => (
            <div key={s.id} className="bbs-song-item">
              ...
              <span className="bbs-song-item-by">Sumado por {s.guestName || "Invitado"}</span>
            </div>
          ))}
        </div>
      )}
    ...
    <div className="bbs-cover-inner">
      ...
      <div className="bbs-cover-content">
        <div className="bbs-cover-top-row">
          <span>PASE Nº {passNumber}</span><span className="bbs-accent-serif-2">ALL ACCESS</span>
        </div>
