    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="bonvoyage-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #C97A5C',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#C97A5C',
            }}>
              {monogram}
            </div>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#C97A5C] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#F4F9FB]" aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #C97A5C, transparent)' }} />
          <IconSunWaves className="bonvoyage-scroll-doodle opacity-0" style={{ width: 34, height: 17, color: '#C97A5C' }} />
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #C97A5C, transparent)' }} />
        </div>
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#F4F9FB' }} aria-hidden="true">
            <IconMusic className="bonvoyage-scroll-doodle opacity-0" style={{ width: 26, height: 26, color: '#C97A5C' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
