...
export function ElegantTemplateGreen({ invitation, guest, isPersonalized = false }: ConviteTemplateProps) {
  ...
  return (
    <>
      ...
      <div className="desktop-stage" data-theme={theme} style={{ '--t-acc': '#5C8A7A', '--t-acc2': '#5C8A7A', '--c-accent': '#5C8A7A' } as React.CSSProperties}>
                    ...
                    {showBankDetails && (
                      <div className="grid grid-cols-1 gap-6 text-left w-full mt-4 items-stretch">
                        ...
                        {pagoTarjetaHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#E5ECE9] space-y-2">
                            <div className="flex items-center gap-2 font-semibold text-[#1A2B33] text-sm border-b border-[#5C8A7A]/20 pb-2">
                              <CreditCard className="w-5 h-5 text-[#5C8A7A]" strokeWidth={1.5} />
                        ...
                        {regaloHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#E5ECE9] space-y-2">
                            <div className="flex items-center gap-2 font-semibold text-[#1A2B33] text-sm border-b border-[#5C8A7A]/20 pb-2">
                              <Gift className="w-5 h-5 text-[#5C8A7A]" strokeWidth={1.5} />
                        ...
                        <>
                          ...
                          {showBankDetails && (
                            <div className="w-full text-left mt-4">
                              <div className="px-4 py-5 sm:p-5 bg-[#E5ECE9] space-y-1">
