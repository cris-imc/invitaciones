  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="bte-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="bte-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #182038 0%, #0B1119 52%, #080D12 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="bte-section" style={{ background: "#0C121E" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="bte-section" style={{ background: "#0C121E" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu lámina" className="bte-section bte-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #141F34 0%, #0C121E 55%, #080D12 100%)" }}>
