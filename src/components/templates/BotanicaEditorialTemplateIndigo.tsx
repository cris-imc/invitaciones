            ...
            <div data-strip="1" className="bte-strip">
              {ceremoniaHabilitada && (
                <div id="ceremonia" data-tone="light" className="bte-panel bte-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                  ...
                  <div className="bte-seguir">SEGUÍ BAJANDO <span className="bte-side-hint">→</span></div>
                </div>
              )}
    ...
    <div className="bte-cover-inner">
      ...
      <div className="bte-cover-content">
        ...
        <div className="bte-cover-bottom">
          <div ref={perfRef} className="bte-perf-strip bte-perf-strip--reveal" />
          ...
          <div className="bte-barcode-wrap">
            <div className="bte-barcode" style={{ width: "62%" }} />
            <span className="bte-mini-label" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
...
const BTE_CSS = `
  ...
  .bte-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 0%, #17141F 0%, #080D12 60%, #080D12 100%); }
