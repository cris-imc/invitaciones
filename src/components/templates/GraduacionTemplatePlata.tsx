  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="grd-scroller">
        ...
        <div id="album" data-pan="1" data-screen-label="Álbum" className="grd-pan">
          <div className="grd-pan-sticky">
            <div data-strip="1" className="grd-strip">
      ...
      <div ref={coverRef} className="grd-cover">
...
const GP_CSS = `
  ...
  .grd-cover-names { margin: 0; font-family: var(--grd-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #EFF3F5; }
