  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="grd-scroller">
        ...
        <div data-pan="1" data-screen-label="El lugar" className="grd-pan">
          <div className="grd-pan-sticky">
            <div data-strip="1" className="grd-strip">
              <div id="details" data-tone="light" className="grd-panel grd-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                ...
                <div className="grd-seguir">SEGUÍ BAJANDO <span className="grd-side-hint">→</span></div>
              </div>
        ...
        {hasPayment && paymentAmount != null && !isExempt && (
          ...
          <div className="grd-rsvp-row grd-rsvp-row--payment">
            ...
            <div className="grd-rsvp-payment-value">
              <span className="grd-rsvp-payment-total">
                {formatARS(isPartialPayment ? paymentBalance : totalPayment)}
              </span>
              {isPaidInFull && (
                <div className="grd-rsvp-payment-detail"><span>Pago registrado ✓</span></div>
              )}
              {isPartialPayment && (
