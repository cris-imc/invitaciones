...
export function PapeleriaDeHotelDeLujoTemplateAzulMarinoPlata({ invitation, guest, isPersonalized = false }: PapeleriaDeHotelDeLujoTemplateProps) {
  ...
  const frase = frasePersonalizadaHabilitada && invitation.frasePersonalizadaTexto
    ...
    : "El lobby se abre una sola noche.";
          ...
          <div className="phl-hero-photo-frame">
            <div className="acp-mobile-only">
              {photoMobile ? (
                ...
                <div className="phl-hero-photo-placeholder" />
              )}
            </div>
...
const PHL_CSS = `
  ...
  .phl-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #0F2038 0%, #0B1A2C 60%, #0A1220 100%); }
