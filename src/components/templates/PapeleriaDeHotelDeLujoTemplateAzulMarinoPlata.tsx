  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="phl-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="phl-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1B2A44 0%, #0C0B11 52%, #0A1220 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="phl-section" style={{ background: "#0D1B2E" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="phl-section" style={{ background: "#0D1B2E" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="phl-section" style={{ background: "#0D1B2E" }}>
            <span data-xin="1" data-dist="-60" className="phl-kicker">{knAcc([sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6)} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu reserva" className="phl-section phl-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #141F33 0%, #0D1B2E 55%, #0A1220 100%)" }}>
          ...
          <div data-xin="1" data-delay="100" data-dist="130" className="phl-final-card">
            <div className="phl-medallion phl-medallion--final">
              <Medallion label="LM" sub={confirmed ? "CONFIRMADO" : "PENDIENTE"} arcId="phlArc3" arcText={textoArco(namesTitle, fechaCorta)} spin="reverse" />
            </div>
          ...
          <div className="phl-rsvp-row phl-rsvp-row--payment">
            ...
            <div className="phl-rsvp-payment-value">
              ...
              {paymentStatus === "PARTIAL" && (
                <div className="phl-rsvp-payment-detail"><span>Pago parcial registrado</span></div>
              )}
    ...
    <div className="phl-cover-inner">
      ...
      <div className="phl-cover-content">
        <div className="phl-cover-top-row">
          <span>SUITE Nº {passNumber}</span><span className="phl-accent-serif-2">ALL ACCESS</span>
        </div>
        ...
        <div className="phl-cover-bottom">
          ...
          <div className="phl-barcode-wrap">
            ...
            <span className="phl-mini-label phl-mini-label--cover" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
