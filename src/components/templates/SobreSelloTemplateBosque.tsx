...
/**
 * SobreSelloTemplateBosque.tsx — Colección Paper · Papelería Viva · Familia 01
 * "Sobre & Sello". Variante: Bosque (generada, no editar a mano). Las otras cuatro (Verde bosque,
...
interface SobreSelloTemplateBosqueProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function SobreSelloTemplateBosque({ invitation, guest, isPersonalized = false }: SobreSelloTemplateBosqueProps) {
  const tx = useTextos();
