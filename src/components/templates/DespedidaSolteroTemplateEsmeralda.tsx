  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="dpo-scroller">
        ...
        <div data-pan="1" data-screen-label="El lugar" className="dpo-pan">
          <div className="dpo-pan-sticky">
            <div data-strip="1" className="dpo-strip">
              <div id="details" data-tone="light" className="dpo-panel dpo-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                ...
                <div className="dpo-seguir">SEGUÍ BAJANDO <span className="dpo-side-hint">→</span></div>
              </div>
        ...
        {hasPayment && paymentAmount != null && !isExempt && (
          ...
          <div className="dpo-rsvp-row dpo-rsvp-row--payment">
            ...
            <div className="dpo-rsvp-payment-value">
              <span className="dpo-rsvp-payment-total">
                {formatARS(isPartialPayment ? paymentBalance : totalPayment)}
              </span>
              {isPaidInFull && (
                <div className="dpo-rsvp-payment-detail"><span>Pago registrado ✓</span></div>
              )}
              {isPartialPayment && (
