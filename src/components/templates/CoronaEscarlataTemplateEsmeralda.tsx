...
const CNE_CSS = `
  ...
  .cne-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(201,123,69,0.5), rgba(47,110,69,0.4), rgba(201,123,69,0.55), rgba(201,123,69,0.5)); filter: blur(64px); opacity: .62; animation: gpFoil 26s linear infinite; }
