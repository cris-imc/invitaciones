  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#14090B", tinta: "#F4F1EA", acento: "#FF3355", clase: `${acpPoppins.variable} ${acpMono.variable}`, fuente: "var(--acp-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#FF3355" guest={guest} />
      )}
