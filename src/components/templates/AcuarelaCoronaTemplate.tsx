...
/**
 * AcuarelaCoronaTemplate.tsx — Colección Paper · Papelería Viva · Familia 02 "Acuarela & Corona"
 * Variante: Rosa antiguo (base).
 *
...
interface AcuarelaCoronaTemplateProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function AcuarelaCoronaTemplate({ invitation, guest, isPersonalized = false }: AcuarelaCoronaTemplateProps) {
  const tx = useTextos();
