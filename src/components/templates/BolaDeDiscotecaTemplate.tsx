  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="bdd-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="bdd-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1C1727 0%, #0C0B11 52%, #08080E 100%)" }}>
          <div data-drift="-130" className="bdd-glow-blob" />
          <span data-xin="1" data-dist="-60" className="bdd-kicker" style={{ position: "relative" }}>{knPre(3)} — CUANDO LLEGUE A CERO</span>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="bdd-section" style={{ background: "#0A0A12" }}>
            <span data-xin="1" data-dist="-60" className="bdd-kicker">{kn(6)} — SUGERENCIA DE MÚSICA</span>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="bdd-section" style={{ background: "#0A0A12" }}>
            <span data-xin="1" data-dist="-60" className="bdd-kicker">{sugerenciaMusicaHabilitada ? kn(7) : kn(6)} — REGALOS Y PAGOS</span>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="bdd-section" style={{ background: "#0A0A12" }}>
            <span data-xin="1" data-dist="-60" className="bdd-kicker">{knAcc([sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6)} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="bdd-section bdd-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #0A0A12 55%, #08080E 100%)" }}>
          ...
          <div className="bdd-rsvp-row bdd-rsvp-row--payment">
            ...
            <div className="bdd-rsvp-payment-value">
              ...
              {paymentStatus === "PARTIAL" && (
                <div className="bdd-rsvp-payment-detail"><span>Pago parcial registrado</span></div>
              )}
      ...
      <div className="bdd-cover-content">
        ...
        <div className="bdd-cover-bottom">
          ...
          <div className="bdd-barcode-wrap">
            ...
            <span className="bdd-mini-label bdd-mini-label--cover" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
