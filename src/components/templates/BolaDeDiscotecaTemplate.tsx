          ...
          <div className="bdd-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="8,8,14" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="8,8,14" />
              </div>
            )}
...
function BddCoverHalf({
  ...
  return (
    <div className="bdd-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#35E0FF" tintColor2="#08080E" effect="enfoque" scrimColorRgb="8,8,14" />
        </div>
      )}
