    ...
    <div className="ftg-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#2F6A4D" tintColor2="#0A0F0B" effect="enfoque" scrimColorRgb="10,15,11" />
        </div>
      )}
...
const FTG_CSS = `
  ...
  .ftg-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 0%, #17141F 0%, #0A0F0B 60%, #0A0F0B 100%); }
