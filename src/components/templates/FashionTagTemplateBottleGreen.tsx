  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0A0F0B", tinta: "#F4F1EA", acento: "#2F6A4D", clase: `${ftgPlayfair.variable} ${ftgMono.variable}`, fuente: "var(--ftg-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="ftg-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label={tx("invitacion.frase.etiqueta")} className="ftg-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #152920 0%, #0A1410 52%, #0A0F0B 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="ftg-section" style={{ background: "#101A13" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="ftg-section" style={{ background: "#101A13" }}>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#2F6A4D" guest={guest} />
      )}
