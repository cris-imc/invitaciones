...
/**
 * AcuarelaCoronaTemplateDurazno.tsx — Colección Paper · Papelería Viva · Familia 02 "Acuarela & Corona"
 * Variante: Durazno (generada, no editar a mano).
 *
...
interface AcuarelaCoronaTemplateDuraznoProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function AcuarelaCoronaTemplateDurazno({ invitation, guest, isPersonalized = false }: AcuarelaCoronaTemplateDuraznoProps) {
  const tx = useTextos();
