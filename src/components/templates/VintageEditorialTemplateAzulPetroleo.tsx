  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="vte-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="vte-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #101E24 0%, #090F12 52%, #0A1113 100%)" }}>
            ...
            <div data-strip="1" className="vte-strip">
              ...
              <div data-tone="light" className="vte-panel vte-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                ...
                <div className="vte-album-embed">
                  {livePhotos.length > 0 ? (
                    <LiveAlbumStrip photos={livePhotos} tone="light" accentColor="#3C6470" />
                  ) : (
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="vte-section" style={{ background: "#0F1B20" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="vte-section" style={{ background: "#0F1B20" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu edición" className="vte-section vte-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #0F171B 0%, #0F1B20 55%, #0A1113 100%)" }}>
