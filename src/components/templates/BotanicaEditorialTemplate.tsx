  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0A0D08", tinta: "#F4F1EA", acento: "#5A6E4E", clase: `${bteSerif.variable} ${bteMono.variable}`, fuente: "var(--bte-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="bte-scroller">
            ...
            <div className="bte-hero-photo-frame">
              {photoMobile && (
                <div className="acp-mobile-only">
                  <AnimatedCoverPhoto photoSrc={photoMobile} tint={false} effect="enfoque" scrimColorRgb="10,13,8" />
                </div>
              )}
              {photoDesktop && (
                <div className="acp-desktop-only">
                  <AnimatedCoverPhoto photoSrc={photoDesktop} tint={false} effect="enfoque" scrimColorRgb="10,13,8" />
                </div>
              )}
            </div>
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label={tx("invitacion.frase.etiqueta")} className="bte-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1C1727 0%, #0C0B11 52%, #0A0D08 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="bte-section" style={{ background: "#0E120C" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="bte-section" style={{ background: "#0E120C" }}>
        ...
        <section data-tone="dark" data-screen-label={tx("invitacion.sabor.tuLamina")} className="bte-section bte-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #0E120C 55%, #0A0D08 100%)" }}>
...
function BteCoverHalf({
  ...
  return (
    <div className="bte-cover-inner">
      {photoMobile && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoMobile} tint tintColor1="#5A6E4E" tintColor2="#0A0D08" effect="enfoque" scrimColorRgb="10,13,8" />
        </div>
      )}
      {photoDesktop && (
        <div className="acp-desktop-only">
          <AnimatedCoverPhoto photoSrc={photoDesktop} tint tintColor1="#5A6E4E" tintColor2="#0A0D08" effect="enfoque" scrimColorRgb="10,13,8" />
        </div>
      )}
...
const BTE_CSS = `
  ...
  /* Foto principal (ver rama experimento-foto-storytelling). Mobile: la
     ...
     borde verde propio de la familia en vez de estirarse. */
  .bte-hero-photo-section { min-height: calc(var(--vh, 1vh) * 100); position: relative; overflow: hidden; background: #0A0D08; }
  ...
  @media (min-width: 768px) {
    .bte-hero-photo-frame { inset: 64px max(24px, calc((100% - 900px) / 2)); border: 1px solid rgba(90,110,78,.3); }
  ...
  .bte-cal-link:hover { color: #5A6E4E; }
