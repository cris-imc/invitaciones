...
/**
 * BotanicaEditorialTemplateBorgona.tsx
 *
 * Portado 1:1 desde el mockup "Botanica Editorial - Panoramica" (Colección
 * Storytelling, evento Casamiento): fondo verde-negro casi opaco (#120A0C),
 * acentos verde oliva/salvia (#7A3E4E / #C49AA0) con un toque de foil dorado
...
interface BotanicaEditorialTemplateBorgonaProps {
...
export function BotanicaEditorialTemplateBorgona({ invitation, guest, isPersonalized = false }: BotanicaEditorialTemplateBorgonaProps) {
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      ...
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#7A3E4E";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #7A3E4E";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#52222E" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#52222E" : "#7A3E4E";
        }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="bte-scroller">
        ...
        <section data-tone="dark" data-screen-label="Save the Date" className="bte-section" style={{ background: "radial-gradient(120% 80% at 50% 0%, #261018 0%, #180C10 55%, #120A0C 100%)" }}>
          ...
          <svg data-leaf="1" viewBox="0 0 200 400" className="bte-leaf-deco" aria-hidden="true">
            <path d="M100 398 C92 340 108 300 92 250 C78 205 100 175 84 130 C70 90 92 70 66 30" fill="none" stroke="#A9727C" strokeWidth={1.4} />
            <g fill="none" stroke="#A9727C" strokeWidth={1.1}>
            ...
            <div className="bte-hero-photo-frame">
              {photoMobile && (
                <div className="acp-mobile-only">
                  <AnimatedCoverPhoto photoSrc={photoMobile} tint={false} effect="enfoque" scrimColorRgb="18,10,12" />
                </div>
              )}
              {photoDesktop && (
                <div className="acp-desktop-only">
                  <AnimatedCoverPhoto photoSrc={photoDesktop} tint={false} effect="enfoque" scrimColorRgb="18,10,12" />
                </div>
              )}
            </div>
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="bte-section bte-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #2C1018 0%, #190C10 55%, #120A0C 100%)" }}>
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="bte-panel bte-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="bte-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#52222E" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#52222E" />
                  </svg>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#7A3E4E" guest={guest} />
      )}
...
function BteCoverHalf({
  ...
  return (
    <div className="bte-cover-inner">
      {photoMobile && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoMobile} tint tintColor1="#7A3E4E" tintColor2="#120A0C" effect="enfoque" scrimColorRgb="18,10,12" />
        </div>
      )}
      {photoDesktop && (
        <div className="acp-desktop-only">
          <AnimatedCoverPhoto photoSrc={photoDesktop} tint tintColor1="#7A3E4E" tintColor2="#120A0C" effect="enfoque" scrimColorRgb="18,10,12" />
        </div>
      )}
...
const BTE_CSS = `
  ...
  a { color: #7A3E4E; text-decoration: none; }
  a:hover { color: #C49AA0; }
  ...
  .bte-hero-photo-section { min-height: calc(var(--vh, 1vh) * 100); position: relative; overflow: hidden; background: #120A0C; }
  ...
  @media (min-width: 768px) {
    .bte-hero-photo-frame { inset: 64px max(24px, calc((100% - 900px) / 2)); border: 1px solid rgba(122,62,78,.3); }
  ...
  .bte-date-month { font-family: var(--bte-serif), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #7A3E4E; padding-left: 12%; }

  .bte-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .bte-divider-line { width: 52px; height: 1px; background: #7A3E4E; display: inline-block; }
  ...
  .bte-cal-link:hover { color: #7A3E4E; }
  ...
  .bte-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #52222E, #8C6F35, #7A3E4E, #C49AA0, #52222E); filter: saturate(.75); }
  ...
  .bte-medallion-label { font-family: var(--bte-serif), serif; font-size: 26px; line-height: 1; color: #C49AA0; }
  .bte-medallion-label-sm { font-family: var(--bte-serif), serif; font-size: 16px; color: #C49AA0; }
  .bte-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .bte-medallion-sub--accent { color: #7A3E4E; }
  ...
  .bte-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #7A3E4E; opacity: 0.4; font-family: var(--bte-mono), monospace; }
  ...
  .bte-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #C49AA0, transparent); animation: bteScan 6s linear infinite; pointer-events: none; }
  ...
  .bte-cd-num--accent { color: #C49AA0; }
  .bte-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #7A3E4E; }
  .bte-perf-strip { height: 12px; position: relative; background: radial-gradient(circle at 6px 50%, #120A0C 3.4px, transparent 3.8px) 0 0/12px 12px repeat-x; opacity: .85; }
  ...
  .bte-glow-blob { position: absolute; right: -26%; top: 4%; width: 82vw; max-width: 540px; aspect-ratio: 1; border-radius: 50%; background: conic-gradient(from 200deg, rgba(122,62,78,0.36), rgba(192,138,91,0.24), rgba(169,114,124,0.4), rgba(122,62,78,0.36)); filter: blur(80px); opacity: .4; animation: bteFoil 30s linear infinite; }
  ...
  .bte-accent-italic { font-style: italic; color: #7A3E4E; }
  .bte-accent-phrase { font-style: italic; color: #A9727C; }
  .bte-accent-serif { font-style: italic; color: #52222E; font-family: var(--bte-serif), serif; }
  .bte-accent-serif-2 { color: #52222E; }
  .bte-accent-dark-2 { color: #7A3E4E; }
  ...
  .bte-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #52222E; margin-top: auto; }
  ...
  .bte-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #52222E; }
  ...
  .bte-crono-time { font-family: var(--bte-mono), monospace; color: #52222E; min-width: 42px; }
  ...
  .bte-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #C49AA0, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .bte-rsvp-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 12px 0; border-bottom: 1px solid rgba(122,62,78,0.18); font-size: 10.5px; letter-spacing: 0.18em; color: #8A8577; }
  ...
  .bte-rsvp-payment-total { color: #C49AA0; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .bte-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #7A3E4E; background: transparent; color: #7A3E4E; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .bte-rsvp-input { background: transparent; border: none; border-bottom: 1px solid rgba(122,62,78,0.3); color: #F4F1EA; font-family: var(--bte-mono), monospace; font-size: 11px; letter-spacing: 0.02em; padding: 4px 2px; text-align: right; max-width: 55%; }
  .bte-rsvp-input::placeholder { color: #6E6A5D; }
  .bte-rsvp-input:focus { outline: none; border-bottom-color: #7A3E4E; }
  .bte-rsvp-btn { width: 100%; padding: 16px; font-family: var(--bte-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; border: 1px solid #7A3E4E; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; cursor: pointer; transition: background 200ms ease, color 200ms ease; }
  ...
  .bte-rsvp-btn--ghost { background: transparent; color: #7A3E4E; }
  .bte-rsvp-btn--ghost:hover:not(:disabled) { background: rgba(122,62,78,0.12); color: #7A3E4E; }
  .bte-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #7A3E4E; margin: 0; }
  ...
  .bte-bank-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(122,62,78,0.18); }
  ...
  .bte-bank-copy { flex-shrink: 0; font-family: var(--bte-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #7A3E4E; background: transparent; color: #7A3E4E; cursor: pointer; }
  .bte-bank-copy:hover { background: rgba(122,62,78,0.12); }
  ...
  .bte-song-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; border-bottom: 1px solid rgba(122,62,78,0.3); padding-bottom: 12px; }
  ...
  .bte-song-input { background: transparent; border: none; border-bottom: 1px solid rgba(122,62,78,0.3); color: #F4F1EA; font-family: var(--bte-mono), monospace; font-size: 12px; padding: 6px 2px; min-width: 0; flex: 1; }
  .bte-song-input::placeholder { color: #6E6A5D; }
  .bte-song-input:focus { outline: none; border-bottom-color: #7A3E4E; }
  .bte-song-sep { color: #8A8577; flex-shrink: 0; }
  .bte-song-submit { flex-shrink: 0; background: none; border: none; color: #7A3E4E; font-family: var(--bte-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .bte-song-submit:hover { color: #C49AA0; }
  .bte-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .bte-song-error { font-size: 10px; color: #7A3E4E; margin-top: 6px; }
  ...
  .bte-quiz-opt { font-family: var(--bte-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(122,62,78,0.4); background: transparent; color: #7A3E4E; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .bte-quiz-opt:disabled { cursor: default; }
  .bte-quiz-opt--picked { background: #7A3E4E; border-color: #7A3E4E; color: #0B0B10; }
  .bte-quiz-opt--correct { background: #7A3E4E; border-color: #7A3E4E; color: #0B0B10; }
  .bte-quiz-opt--wrong { border-color: #8A6A6A; color: #C99; opacity: 0.6; }
  .bte-quiz-result { padding-top: 18px; border-top: 1px solid rgba(122,62,78,0.2); }
  .bte-quiz-result-score { margin: 0 0 6px; font-family: var(--bte-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #C49AA0; }
  .bte-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .bte-final-card { border: 1px solid #7A3E4E; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  ...
  .bte-replay { cursor: pointer; color: #7A3E4E; }
  ...
  .bte-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#C49AA0, #7A3E4E); transition: height 260ms linear; display: block; }
  .bte-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #7A3E4E; transition: color 500ms ease; }
  ...
  .bte-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #221018 0%, #180C10 46%, #120A0C 100%); }
  .bte-cover-half--bottom .bte-cover-inner { top: auto; bottom: 0; }
  .bte-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(122,62,78,0.5), rgba(192,138,91,0.35), rgba(169,114,124,0.6), rgba(122,62,78,0.5)); filter: blur(64px); opacity: .62; animation: bteFoil 26s linear infinite; }
  ...
  .bte-cover-linen { position: absolute; inset: 0; background-image: repeating-linear-gradient(78deg, rgba(196,154,160,.16) 0 1px, transparent 1px 40px), repeating-linear-gradient(-32deg, rgba(196,154,160,.1) 0 1px, transparent 1px 64px); }
  ...
  .bte-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#7A3E4E, transparent); display: block; }
  ...
  .bte-cover-cta { border: 1px solid #7A3E4E; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--bte-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .bte-lightbox { position: fixed; inset: 0; z-index: 200; background: rgba(18,10,12,0.96); display: flex; align-items: center; justify-content: center; padding: 24px; cursor: zoom-out; }
  .bte-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #7A3E4E; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
