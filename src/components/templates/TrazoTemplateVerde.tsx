...
/**
 * TrazoTemplateVerde.tsx — Colección Paper · Papel Prensado · Familia 05 "Trazo"
 * Variante: Verde (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Tinta, Terracota, Verde,
...
interface TrazoTemplateVerdeProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function TrazoTemplateVerde({ invitation, guest, isPersonalized = false }: TrazoTemplateVerdeProps) {
  const tx = useTextos();
