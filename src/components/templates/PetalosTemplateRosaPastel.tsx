 ...
 *   --t-bg #FFF7F8 · --t-surface #FCE9EE · --petalos-ink #452832
 *   --t-muted #93707a · --t-acc #E8A8BC (rojo vibrante) · --t-acc2 #C77E96 (rojo profundo)
 *
...
interface PetalosTemplateRosaPastelProps {
...
export function PetalosTemplateRosaPastel({ invitation, guest, isPersonalized = false }: PetalosTemplateRosaPastelProps) {
  ...
  // Portada animada -- mismo criterio que la base de Petalos (tema claro):
  // sin tinte, effect="shimmer", texto con clases CSS + media query
  // (.petalos-cover-text/-muted). scrimColorRgb = rgb del ink oscuro propio.
    ...
    return (
      <div className="min-h-dvh w-full text-white relative overflow-x-hidden flex flex-col justify-between" style={{ background: "linear-gradient(180deg, var(--t-bg) 0%, var(--t-surface) 55%, #FFFFFF 100%)" }} data-theme={theme}>
        ...
        <footer className="relative z-10 pt-4 pb-2 text-center font-sans" style={{ borderTop: "1px solid color-mix(in srgb, var(--t-acc) 10%, transparent)" }}>
          <LogoFooterCredit bgColor="transparent" textColor="var(--chic-ink, #452832)" />
        </footer>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <h2 className={`text-4xl sm:text-5xl font-light tracking-wide leading-relaxed${portadaFondoAnimado ? " petalos-cover-text" : ""}`} style={{ fontFamily: 'var(--font-title, var(--font-cormorant)), serif', color: portadaFondoAnimado ? undefined : 'var(--petalos-ink)' }}>
              {guestNameDisplay}
            </h2>

            {Boolean(activeDressCode) && (
              <p className={`text-sm font-medium tracking-wide uppercase${portadaFondoAnimado ? " petalos-cover-text-muted" : ""}`} style={{ fontFamily: "var(--font-body-custom, var(--font-inter)), sans-serif", letterSpacing: "0.2em", opacity: 0.8, color: portadaFondoAnimado ? undefined : 'var(--t-muted)' }}>
          ...
          <style jsx>{`
            ...
            .petalos-cover-text { color: #FFF7F8; }
            .petalos-cover-text-muted { color: #FFF7F8; }
            @media (min-width: 768px) {
              .petalos-cover-text { color: var(--petalos-ink); }
              .petalos-cover-text-muted { color: var(--t-muted); }
            }
          `}</style>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8" style={{ background: 'var(--t-bg)' }} aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, var(--t-acc), transparent)' }} />
          <IconBlossom className="petalos-scroll-doodle opacity-0" style={{ width: 22, height: 22, color: 'var(--t-acc)' }} />
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, var(--t-acc), transparent)' }} />
        </div>
        ...
        <SectionWrapper id="details" delay={150} className="w-full py-20 px-6 md:px-12" style={{ background: 'var(--t-bg)' }}>
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))", color: 'var(--t-acc)' }}>
              <IconArch className="petalos-scroll-doodle opacity-0" style={{ width: 15, height: 15 }} />
              CUÁNDO Y DÓNDE
            </p>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16">
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))", color: 'var(--t-acc)' }}>
                  <IconVine className="petalos-scroll-doodle opacity-0" style={{ width: 20, height: 10 }} />
                  CRONOGRAMA
                </p>
          ...
          <SectionWrapper id="banco" delay={200} className="w-full py-20 px-6 md:px-12 overflow-hidden" style={{ background: 'var(--t-surface)' }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                <p className="t-kicker mb-10 flex items-center gap-2" style={{ color: 'var(--t-acc)' }}>
                  <IconVine className="petalos-scroll-doodle opacity-0" style={{ width: 22, height: 11 }} />
          ...
          <SectionWrapper id="quiz" delay={300} className="w-full py-20 px-6 md:px-12" style={{ background: "linear-gradient(160deg, color-mix(in srgb, var(--t-acc2) 10%, transparent), transparent 70%), var(--t-bg)" }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-8 flex items-center gap-2">
                <IconHeartBud className="petalos-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: 'var(--t-acc2)' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: 'var(--t-bg)' }} aria-hidden="true">
            <IconMusic className="petalos-scroll-doodle opacity-0" style={{ width: 24, height: 24, color: 'var(--t-acc)' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
        ...
        <LogoFooterCredit bgColor="var(--t-bg)" textColor="var(--chic-ink, #452832)" />
        </div>
      </div>

      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#E8A8BC" surfaceColor="#FCE9EE" inactiveColor="#452832" solid />}
      </div>
  );
}
