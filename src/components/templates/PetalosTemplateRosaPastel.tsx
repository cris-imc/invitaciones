  ...
  if (finished) {
    ...
    return (
      <div className="quiz-box text-center flex flex-col items-center">
        ...
        <p style={{ marginTop: "12px", opacity: 0.8, fontFamily: "var(--font-sans)", textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "0.8rem", color: "var(--petalos-ink)" }}>{tx("invitacion.quiz.respondisteCorrectamentePorcentaje", { aciertos: score, total: preguntas.length, pct: percent }).toUpperCase()}</p>
            ...
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "color-mix(in srgb, var(--t-acc) 8%, transparent)", padding: "8px 16px", borderRadius: "99px", border: "1px solid color-mix(in srgb, var(--t-acc) 15%, transparent)", textAlign: "left", maxWidth: "90%" }}>
                ...
                <p style={{ fontSize: "11.5px", margin: 0, opacity: 0.85, lineHeight: 1.4, color: "var(--petalos-ink)" }}>
                  {tx("invitacion.quiz.promedioGlobal", { n: stats.count })} <strong style={{ color: "var(--petalos-ink)" }}>{stats.avg}%</strong>.
                </p>
              </div>
            </div>
          )
      ...
      <div className="d-right tpl">
        ...
        {songsEnabled && (
          <SongSuggestion
            ...
            kicker={tx("invitacion.musica.sugeriUnaCancion").toUpperCase()}
            hideHeader
            dark
            showPublicList
            variant="moderno"
