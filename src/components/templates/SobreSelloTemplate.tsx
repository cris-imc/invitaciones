...
interface SobreSelloTemplateProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function SobreSelloTemplate({ invitation, guest, isPersonalized = false }: SobreSelloTemplateProps) {
  const tx = useTextos();
