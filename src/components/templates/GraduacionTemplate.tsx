...
interface GraduacionTemplateProps {
...
export function GraduacionTemplate({ invitation, guest, isPersonalized = false }: GraduacionTemplateProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      if (statusRef.current) {
        ...
        statusRef.current.style.color = "#F3ECD8";
      }
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#C6A860";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #C6A860";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#7A6230" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#7A6230" : "#C6A860";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0A0D18", tinta: "#F4F1EA", acento: "#C6A860", clase: `${grdDisplay.variable} ${grdMono.variable}`, fuente: "var(--grd-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="grd-panel grd-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="grd-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#7A6230" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#7A6230" />
                  </svg>
          ...
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="grd-section" style={{ background: "#0D111E" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="grd-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="grd-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F3ECD8" : "#C6A860" }} />
              ))}
            </div>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#C6A860" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #C6A860; text-decoration: none; }
  ...
  .grd-date-month { font-family: var(--grd-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #C6A860; padding-left: 12%; }

  .grd-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .grd-divider-line { width: 52px; height: 1px; background: #C6A860; display: inline-block; }
  ...
  .grd-cal-link:hover { color: #C6A860; }
  ...
  .grd-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #C6A860, #F3ECD8, #6E5AA8); filter: saturate(.75); }
  ...
  .grd-medallion-label { font-family: var(--grd-display), serif; font-size: 26px; line-height: 1; color: #F3ECD8; }
  .grd-medallion-label-sm { font-family: var(--grd-display), serif; font-size: 16px; color: #F3ECD8; }
  .grd-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .grd-medallion-sub--accent { color: #C6A860; }
  ...
  .grd-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #C6A860; opacity: 0.4; font-family: var(--grd-mono), monospace; }
  ...
  .grd-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #F3ECD8, transparent); animation: grdScan 6s linear infinite; pointer-events: none; }
  ...
  .grd-cd-num { font-family: var(--grd-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F3ECD8; display: inline-block; }
  .grd-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #C6A860; }
  ...
  .grd-accent-italic { font-style: italic; color: #C6A860; }
  .grd-accent-serif { font-style: italic; color: #7A6230; font-family: var(--grd-display), serif; }
  .grd-accent-serif-2 { color: #7A6230; }
  ...
  .grd-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #7A6230; margin-top: auto; }
  ...
  .grd-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #7A6230; }
  ...
  .grd-crono-time { font-family: var(--grd-mono), monospace; color: #7A6230; min-width: 42px; }
  ...
  .grd-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #F3ECD8, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .grd-rsvp-payment-total { color: #F3ECD8; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .grd-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #C6A860; background: transparent; color: #C6A860; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .grd-rsvp-input:focus { outline: none; border-bottom-color: #C6A860; }
  .grd-rsvp-btn { width: 100%; padding: 16px; font-family: var(--grd-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #C6A860, #7A6230); border: 1px solid #C6A860; color: #0D111E; cursor: pointer; }
  .grd-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .grd-rsvp-btn--ghost { background: transparent; color: #C6A860; }
  .grd-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #C6A860; margin: 0; }
  ...
  .grd-bank-copy { flex-shrink: 0; font-family: var(--grd-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #C6A860; background: transparent; color: #C6A860; cursor: pointer; }
  ...
  .grd-song-input:focus { outline: none; border-bottom-color: #C6A860; }
  .grd-song-sep { color: #8A8577; flex-shrink: 0; }
  .grd-song-submit { flex-shrink: 0; background: none; border: none; color: #C6A860; font-family: var(--grd-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .grd-song-submit:hover { color: #F3ECD8; }
  .grd-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .grd-song-error { font-size: 10px; color: #C6A860; margin-top: 6px; }
  ...
  .grd-quiz-opt { font-family: var(--grd-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #C6A860; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .grd-quiz-opt:disabled { cursor: default; }
  .grd-quiz-opt--picked { background: #C6A860; border-color: #C6A860; color: #0D111E; }
  .grd-quiz-opt--correct { background: #C6A860; border-color: #C6A860; color: #0D111E; }
  ...
  .grd-quiz-result-score { margin: 0 0 6px; font-family: var(--grd-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #F3ECD8; }
  .grd-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .grd-final-card { border: 1px solid #C6A860; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .grd-final-names { font-family: var(--grd-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #F3ECD8; }
  ...
  .grd-replay { cursor: pointer; color: #C6A860; }
  ...
  .grd-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F3ECD8, #C6A860); transition: height 260ms linear; display: block; }
  .grd-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #C6A860; transition: color 500ms ease; }
  ...
  .grd-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(28,43,74,0.55), rgba(198,168,96,0.32), rgba(198,168,96,0.55), rgba(28,43,74,0.55)); filter: blur(64px); opacity: .62; animation: grdFoil 26s linear infinite; }
  .grd-cover-texture { position: absolute; inset: 0; background-image: repeating-linear-gradient(90deg, rgba(243,236,216,.06) 0 1px, transparent 1px 40px); }
  ...
  .grd-cover-names { margin: 0; font-family: var(--grd-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #F3ECD8; }
  .grd-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#C6A860, transparent); display: block; }
  ...
  .grd-cover-cta { border: 1px solid #C6A860; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--grd-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .grd-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #C6A860; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
