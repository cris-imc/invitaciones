...
export function ModernoTemplatePurpura({ invitation, guest, isPersonalized = false }: ModernoTemplatePurpuraProps) {
  ...
  if (eventStatus === "POST_EVENT") {
    return (
      <div className="min-h-screen w-full bg-gradient-to-b bg-[#0D0412] text-white relative overflow-x-hidden flex flex-col justify-between" data-theme={theme}>
  ...
  return (
    <>
      <style>{`
        ...
        #songs.d-sec.dark {
          background-color: #0D0412 !important; /* Light theme */
        ...
        #songs.d-sec.dark input {
          ...
          background-color: #15081A !important; /* Pastel */
        ...
        >
          {isTicketMaximized ? (
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#15081A] font-sans text-[10px] font-semibold tracking-wider uppercase">Pase</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0D0412] relative">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t from-[#0D0412] via-[#0D0412]/50 to-transparent" />
          </div>
        ...
        {(Boolean(invitation.frasePersonalizadaHabilitada) && Boolean(invitation.frasePersonalizadaTexto)) ? (
          <SectionWrapper id="quote" delay={100} className="w-full bg-[#15081A] py-24 px-6 md:px-12 flex items-center justify-center">
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#0D0412] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                    ...
                    {showBankDetails && (
                      <div className="grid grid-cols-1 gap-6 text-left w-full mt-4 items-stretch">
                        ...
                        {pagoTarjetaHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#15081A] space-y-2">
                        ...
                        <>
                          ...
                          {showBankDetails && (
                            <div className="w-full text-left mt-4">
                              <div className="px-4 py-5 sm:p-5 bg-[#15081A] space-y-1">
        ...
        {triviaHabilitada && triviaPreguntas.length > 0 && (
          <SectionWrapper id="quiz" delay={300} className="w-full bg-[#15081A] py-20 px-6 md:px-12">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-8">
