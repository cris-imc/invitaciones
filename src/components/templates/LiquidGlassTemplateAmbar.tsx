  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="lqg-scroller">
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="lqg-section" style={{ background: "#110D0A" }}>
    ...
    <div className="lqg-cover-inner">
      ...
      <div className="lqg-cover-content">
        <div className="lqg-cover-top-row">
          <span>PANEL Nº {panelNumber}</span><span className="lqg-accent-navy-solid" style={{ color: "#C9A86F" }}>ADMIT TWO</span>
        </div>
