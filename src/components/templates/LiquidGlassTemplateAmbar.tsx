...
/**
 * LiquidGlassTemplateAmbar.tsx
 *
 * Variante de color "Ámbar Dorado" de LiquidGlassTemplate.tsx (Colección
 ...
 * Design (panel de acceso de vidrio para boda: fondo casi negro con tinte ámbar,
 * acento vidrio ámbar dorado #C9A86F, Cormorant Garamond + IBM Plex Mono,
...
export function LiquidGlassTemplateAmbar({ invitation, guest, isPersonalized = false }: LiquidGlassTemplateProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      ...
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#C9A86F";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(201,168,111,.35), 0 18px 50px -30px #C9A86F";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#30251C" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#30251C" : "#C9A86F";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0D0A08", tinta: "#F4F1EA", acento: "#C9A86F", clase: `${lqgCormorant.variable} ${lqgMono.variable}`, fuente: "var(--lqg-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="lqg-scroller">
            ...
            <div className="lqg-hero-photo-frame">
              {photoMobile && (
                <div className="acp-mobile-only">
                  <AnimatedCoverPhoto photoSrc={photoMobile} tint={false} effect="enfoque" scrimColorRgb="13,10,8" />
                </div>
              )}
              {photoDesktop && (
                <div className="acp-desktop-only">
                  <AnimatedCoverPhoto photoSrc={photoDesktop} tint={false} effect="enfoque" scrimColorRgb="13,10,8" />
                </div>
              )}
            </div>
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label={tx("invitacion.frase.etiqueta")} className="lqg-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #27171C 0%, #110B0C 52%, #0D0A08 100%)" }}>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label={tx("invitacion.ubicacion.cuandoYDonde")} className="lqg-pan" style={!scrollVertical && ceremoniaHabilitada ? { height: "340vh" } : undefined}>
          <div className="lqg-pan-sticky">
            <div data-strip="1" className="lqg-strip">
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="lqg-panel lqg-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="lqg-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#30251C" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#30251C" />
                  </svg>
              ...
              <div data-tone="dark" className="lqg-panel lqg-panel--center" style={{ background: "#110D0A", color: "#F4F1EA" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="lqg-section" style={{ background: "#110D0A" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="lqg-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="lqg-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F5F8F9" : "#C9A86F" }} />
              ))}
            </div>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="lqg-section" style={{ background: "#110D0A" }}>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#C9A86F" guest={guest} />
      )}
    ...
    <div className="lqg-cover-inner">
      ...
      <div className="lqg-cover-content">
        <div className="lqg-cover-top-row">
          <span>{tx("invitacion.pase.numeroPanel", { n: panelNumber }).toUpperCase()}</span><span className="lqg-accent-navy-solid" style={{ color: "#C9A86F" }}>ALL ACCESS</span>
        </div>
...
const LQG_CSS = `
  ...
  a { color: #C9A86F; text-decoration: none; }
  ...
  .lqg-date-month { font-family: var(--lqg-cormorant), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #C9A86F; padding-left: 12%; }

  .lqg-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .lqg-divider-line { width: 52px; height: 1px; background: #C9A86F; display: inline-block; }
  ...
  .lqg-cal-link:hover { color: #C9A86F; }
  ...
  .lqg-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #30251C, #16110E, #C9A86F, #F5F8F9, #30251C); filter: saturate(.75); }
  .lqg-medallion-core { position: absolute; inset: 3px; border-radius: 50%; background: #110C0C; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 3px; text-align: center; padding: 6px; }
  ...
  .lqg-medallion-sub--accent { color: #C9A86F; }
  ...
  .lqg-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #C9A86F; opacity: 0.4; font-family: var(--lqg-mono), monospace; }
  ...
  .lqg-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #C9A86F; }
  .lqg-perf-strip { height: 12px; position: relative; background: radial-gradient(circle at 6px 50%, #0D0A08 3.4px, transparent 3.8px) 0 0/12px 12px repeat-x; opacity: .85; }
  ...
  .lqg-glow-blob { position: absolute; right: -26%; top: 4%; width: 82vw; max-width: 540px; aspect-ratio: 1; border-radius: 50%; background: conic-gradient(from 200deg, rgba(201,168,111,0.3), rgba(242,240,232,0.2), rgba(201,168,111,0.34), rgba(201,168,111,0.3)); filter: blur(80px); opacity: .4; animation: lqgFoil 30s linear infinite; }
  ...
  .lqg-accent-italic { font-style: italic; color: #C9A86F; }
  .lqg-accent-serif { font-style: italic; color: #C9A86F; font-family: var(--lqg-cormorant), serif; }
  .lqg-accent-navy { font-style: italic; color: #30251C; font-family: var(--lqg-cormorant), serif; }
  .lqg-accent-navy-solid { color: #30251C; }
  ...
  .lqg-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #30251C; margin-top: auto; }
  ...
  .lqg-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #30251C; }
  ...
  .lqg-crono-time { font-family: var(--lqg-mono), monospace; color: #30251C; min-width: 42px; }
  ...
  .lqg-rsvp-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 12px 0; border-bottom: 1px solid rgba(201,168,111,0.18); font-size: 10.5px; letter-spacing: 0.18em; color: #8A8577; }
  ...
  .lqg-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #C9A86F; background: transparent; color: #C9A86F; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .lqg-rsvp-input { background: transparent; border: none; border-bottom: 1px solid rgba(201,168,111,0.3); color: #F4F1EA; font-family: var(--lqg-mono), monospace; font-size: 11px; letter-spacing: 0.02em; padding: 4px 2px; text-align: right; max-width: 55%; }
  .lqg-rsvp-input::placeholder { color: #6E6A5D; }
  .lqg-rsvp-input:focus { outline: none; border-bottom-color: #C9A86F; }
  .lqg-rsvp-btn { width: 100%; padding: 16px; font-family: var(--lqg-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #C9A86F, #967A4A); border: 1px solid #C9A86F; color: #0B0B10; cursor: pointer; }
  .lqg-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .lqg-rsvp-btn--ghost { background: transparent; color: #C9A86F; }
  .lqg-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #C9A86F; margin: 0; }
  ...
  .lqg-bank-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(201,168,111,0.18); }
  ...
  .lqg-bank-copy { flex-shrink: 0; font-family: var(--lqg-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #C9A86F; background: transparent; color: #C9A86F; cursor: pointer; }
  .lqg-bank-copy:hover { background: rgba(201,168,111,0.12); }
  ...
  .lqg-song-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; border-bottom: 1px solid rgba(201,168,111,0.3); padding-bottom: 12px; }
  ...
  .lqg-song-input { background: transparent; border: none; border-bottom: 1px solid rgba(201,168,111,0.3); color: #F4F1EA; font-family: var(--lqg-mono), monospace; font-size: 12px; padding: 6px 2px; min-width: 0; flex: 1; }
  .lqg-song-input::placeholder { color: #6E6A5D; }
  .lqg-song-input:focus { outline: none; border-bottom-color: #C9A86F; }
  .lqg-song-sep { color: #8A8577; flex-shrink: 0; }
  .lqg-song-submit { flex-shrink: 0; background: none; border: none; color: #C9A86F; font-family: var(--lqg-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .lqg-song-submit:hover { color: #F5F8F9; }
  .lqg-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .lqg-song-error { font-size: 10px; color: #C9A86F; margin-top: 6px; }
  ...
  .lqg-quiz-opt { font-family: var(--lqg-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(201,168,111,0.4); background: transparent; color: #C9A86F; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .lqg-quiz-opt:disabled { cursor: default; }
  .lqg-quiz-opt--picked { background: #C9A86F; border-color: #C9A86F; color: #0B0B10; }
  .lqg-quiz-opt--correct { background: #C9A86F; border-color: #C9A86F; color: #0B0B10; }
  .lqg-quiz-opt--wrong { border-color: #8A6A6A; color: #C99; opacity: 0.6; }
  .lqg-quiz-result { padding-top: 18px; border-top: 1px solid rgba(201,168,111,0.2); }
  ...
  .lqg-final-card { border: 1px solid #C9A86F; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  ...
  .lqg-replay { cursor: pointer; color: #C9A86F; }
  ...
  .lqg-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F5F8F9, #C9A86F); transition: height 260ms linear; display: block; }
  .lqg-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #C9A86F; transition: color 500ms ease; }
  ...
  .lqg-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #16110E 0%, #110D0A 46%, #0D0A08 100%); }
  .lqg-cover-half--bottom .lqg-cover-inner { top: auto; bottom: 0; }
  .lqg-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(201,168,111,0.4), rgba(242,240,232,0.3), rgba(201,168,111,0.5), rgba(201,168,111,0.4)); filter: blur(64px); opacity: .62; animation: lqgFoil 26s linear infinite; }
  ...
  .lqg-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#C9A86F, transparent); display: block; }
  ...
  .lqg-cover-cta { border: 1px solid #C9A86F; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--lqg-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .lqg-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #C9A86F; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
