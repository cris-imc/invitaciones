  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="ftg-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="ftg-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #2B2012 0%, #150F09 52%, #100D08 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="ftg-section" style={{ background: "#1A140C" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="ftg-section" style={{ background: "#1A140C" }}>
