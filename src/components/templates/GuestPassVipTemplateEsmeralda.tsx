  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="gpv-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="gpv-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #152420 0%, #0A1210 52%, #080B09 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="gpv-section" style={{ background: "#0A100D" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="gpv-section" style={{ background: "#0A100D" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="gpv-section gpv-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #141F1A 0%, #0A100D 55%, #080B09 100%)" }}>
