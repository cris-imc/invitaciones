  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="gpv-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="gpv-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1A1E22 0%, #0B0D0F 52%, #08090B 100%)" }}>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label="El lugar" className="gpv-pan" style={!scrollVertical && ceremoniaHabilitada ? { height: "340vh" } : undefined}>
            ...
            <div data-strip="1" className="gpv-strip">
              {ceremoniaHabilitada && (
                <div id="ceremonia" data-tone="light" className="gpv-panel gpv-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                  ...
                  <div className="gpv-seguir">SEGUÍ BAJANDO <span className="gpv-side-hint">{scrollVertical ? "↓" : "→"}</span></div>
                </div>
              )}
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="gpv-section" style={{ background: "#0A0C0E" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="gpv-section" style={{ background: "#0A0C0E" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="gpv-section" style={{ background: "#0A0C0E" }}>
            <span data-xin="1" data-dist="-60" className="gpv-kicker">{knAcc([sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6)} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="gpv-section gpv-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #171B1F 0%, #0A0C0E 55%, #08090B 100%)" }}>
