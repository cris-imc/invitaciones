 ...
 * (#FFF7F2) + tinta violeta oscuro (#2A2140) + acento coral (#9B7FE8,
...
interface InfantilTemplateLavandaProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#9B7FE8]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#9B7FE8] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,92,138,0.08)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,92,138,0.18)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#9B7FE8] shrink-0" />
...
export function InfantilTemplateLavanda({ invitation, guest, isPersonalized = false }: InfantilTemplateLavandaProps) {
  const tx = useTextos();
    ...
    >
      <style>{`
        ...
        #rsvp.section.dark .t-btn {
          ...
          background-color: #9B7FE8 !important;
          color: #FFFFFF !important;
          font-weight: 700 !important;
          border: none !important;
          text-transform: uppercase !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div className={portadaFondoAnimado ? "acp-desktop-only" : undefined}>
            <div style={{ position: 'absolute', width: 200, height: 200, borderRadius: '50%', background: '#9B7FE8', opacity: 0.16, top: '6%', left: '-8%', filter: 'blur(14px)', animation: 'infantil-blobFloat 7s ease-in-out infinite', pointerEvents: 'none' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <button
              ...
              style={{
                ...
                background: '#9B7FE8', boxShadow: '0 10px 24px rgba(255,92,138,0.35)',
                marginTop: '1rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#E8447A'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = '#9B7FE8'; }}
            >
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#9B7FE8]/40 shadow-md rounded-full ${isTicketMaximized ? 'bg-[#FFF7F2]/95 backdrop-blur-md w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#241B38]/95 backdrop-blur-md px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-bold uppercase tracking-[0.15em] text-[#9B7FE8] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{tx("invitacion.pase.paseEspecial")}</span>
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              <Ticket className="w-4 h-4 text-[#9B7FE8]" />
          ...
          <h1 className="text-5xl font-extrabold text-white leading-tight mb-2 drop-shadow-md" style={{ fontFamily: 'var(--font-title, var(--font-cormorant)), sans-serif' }}>
            {em ? (
              <>
                ...
                <span className="block"><em style={{ fontFamily: 'var(--font-cormorant), sans-serif', fontStyle: 'normal', color: '#9B7FE8' }}>&amp;</em> {em.replace('& ', '').trim()}</span>
              </>
            ) : (
              <span className="block">{title}</span>
            )}
          </h1>
          <div style={{ width: 40, height: 4, background: '#9B7FE8', borderRadius: 4, margin: '6px 0 14px' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#FFF7F2]">
          <div className="px-8 pt-16 pb-12 text-left bg-[#FFF7F2] z-10 relative">
            ...
            <p className=" text-xs font-bold uppercase tracking-[0.15em] text-[#9B7FE8] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            ...
            <div style={{ width: 40, height: 4, background: '#9B7FE8', borderRadius: 4, margin: '0 0 20px' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-bold text-[#9B7FE8] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                {tx("invitacion.ubicacion.dressCode")} {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
              ...
              <IconStar style={{ position: "absolute", top: -12, left: -8, width: 24, height: 24, color: "#9B7FE8" }} />
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#FFF7F2] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            ...
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-bold tracking-[0.15em] uppercase text-[#9B7FE8]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              ...
              <div className="bg-white border-l-[4px] border-l-[#3FBF9F] p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-bold tracking-wider text-[#9B7FE8] hover:text-[#2A2140] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-white border-l-[4px] border-l-[#3FBF9F] p-6 sm:p-8 mb-10 shadow-sm">
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-bold tracking-wider text-[#9B7FE8] hover:text-[#2A2140] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16" id="schedule">
                ...
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-bold tracking-[0.15em] uppercase text-[#9B7FE8]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  CRONOGRAMA
                </p>
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#FFF0E4] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                ...
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#9B7FE8]">
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#9B7FE8" surfaceColor="#FFFFFF" />}
      </div>
  );
}
