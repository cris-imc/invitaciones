        ...
        {hasPayment && paymentAmount != null && !isExempt && (
          ...
          <div className="bcw-rsvp-row bcw-rsvp-row--payment">
            ...
            <div className="bcw-rsvp-payment-value">
              <span className="bcw-rsvp-payment-total">
                {formatARS(isPartialPayment ? paymentBalance : totalPayment)}
              </span>
              {isPaidInFull && (
                <div className="bcw-rsvp-payment-detail"><span>Pago registrado ✓</span></div>
              )}
              {isPartialPayment && (
...
const GP_CSS = `
  ...
  .bcw-cover-names { margin: 0; font-family: var(--bcw-bodoni), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #0A0A0A; }
