 ...
 * rosa-hueso (#F1E4E6) + acento oro-rosado fijo (#7FA8D9), tipografía
...
interface OnixTemplateZafiroProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#7FA8D9]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#7FA8D9] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#7FA8D9] shrink-0" />
...
export function OnixTemplateZafiro({ invitation, guest, isPersonalized = false }: OnixTemplateZafiroProps) {
    ...
    >
      <style>{`
        ...
        #countdown[data-style="clasico"].dark > div > div > div {
          ...
          border-color: rgba(127, 168, 217, 0.2) !important;
        }

        /* RSVP Custom Aesthetics for OnixTemplateZafiro */
        #rsvp.section.dark {
          background-color: #140B14 !important;
          color: #FFFFFF !important;
        ...
        #rsvp.section.dark input {
          ...
          border: 1px solid rgba(127, 168, 217, 0.2) !important;
        ...
        #songs.d-sec.dark .t-kicker {
          font-family: var(--font-body-custom, var(--font-inter)), sans-serif !important;
          color: #7FA8D9 !important; /* Gold/Orange */
          font-size: 11px !important;
          font-weight: 600 !important;
          text-transform: uppercase !important;
          letter-spacing: 0.2em !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(127,168,217,0.13), transparent), radial-gradient(45% 40% at 85% 80%, rgba(120,70,110,0.2), transparent)',
            backgroundSize: '160% 160%',
            animation: 'onix-meshDrift 14s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', width: 220, height: 220, borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(127,168,217,0.13), transparent 70%)',
          ...
          <IconRings className="onix-doodle opacity-0 absolute" style={{ width: 22, height: 22, top: '10%', left: '10%', color: 'rgba(127,168,217,0.55)' }} />
          <IconHeartDoodle className="onix-doodle opacity-0 absolute" style={{ width: 24, height: 24, top: '15%', right: '12%', color: 'rgba(127,168,217,0.4)' }} />
          <IconRibbon className="onix-doodle opacity-0 absolute" style={{ width: 34, height: 18, bottom: '18%', left: '12%', color: 'rgba(127,168,217,0.45)' }} />
          <IconRings className="onix-doodle opacity-0 absolute" style={{ width: 14, height: 14, bottom: '24%', right: '18%', color: 'rgba(127,168,217,0.4)' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="onix-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #7FA8D9',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#7FA8D9',
            }}>
              {monogram}
            </div>
            ...
            <button
              ...
              style={{
                fontFamily: 'var(--font-body-custom, var(--font-inter)), sans-serif', border: '1px solid #7FA8D9', color: '#7FA8D9',
                background: 'rgba(127,168,217,0.08)', backdropFilter: 'blur(6px)',
                marginTop: '1rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#7FA8D9'; e.currentTarget.style.color = '#140B14'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(127,168,217,0.08)'; e.currentTarget.style.color = '#7FA8D9'; }}
            >
              ABRIR INVITACIÓN
            </button>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#7FA8D9]/40 shadow-md ${isTicketMaximized ? 'bg-[#140B14]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#7FA8D9] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
                <span className="text-[#FFFFFF] font-bold text-sm leading-none" style={{ fontFamily: 'var(--font-cormorant), serif' }}>{guest.name}</span>
              </div>
              <div className="flex flex-col items-end border-l border-[#7FA8D9]/20 pl-3">
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#7FA8D9', margin: '6px 0 14px', animation: 'onix-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#140B14]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#140B14] z-10 relative">
            <IconHeartDoodle className="onix-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 12, right: 28, color: 'rgba(127,168,217,0.4)' }} />
            <IconRings className="onix-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 64, right: 52, color: 'rgba(127,168,217,0.45)' }} />
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#7FA8D9] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            <h1 className="text-[4rem] font-light text-[#F1E4E6] leading-[1.0] mb-3" style={{ fontFamily: 'var(--font-title, var(--font-cormorant)), serif' }}>
              {em ? (
                <>
                  <span className="block">{title.slice(0, title.indexOf(em)).trim()}</span>
                  <span className="block"><em style={{ fontFamily: 'var(--font-cormorant), serif', fontStyle: 'italic', color: '#7FA8D9' }}>&amp;</em> {em.replace('& ', '').trim()}</span>
                </>
              ) : (
                <span className="block">{title}</span>
              )}
            </h1>
            <div style={{ width: 40, height: 2, background: '#7FA8D9', margin: '0 0 20px', animation: 'onix-lineExpand 1.2s ease-out' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#7FA8D9] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
              <div className="absolute inset-0" style={{ border: "1px solid rgba(127,168,217,0.6)" }} />
              <IconChurch style={{ position: "absolute", top: -14, right: -14, width: 28, height: 28, color: "#7FA8D9" }} />
            </div>
            ...
            <div
              ...
              style={{
                ...
                background: "linear-gradient(90deg, transparent, rgba(127,168,217,0.5) 45%, rgba(255,238,225,0.6) 50%, rgba(127,168,217,0.5) 55%, transparent)",
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#140B14]" aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #7FA8D9, transparent)' }} />
          <IconRibbon className="onix-scroll-doodle opacity-0" style={{ width: 26, height: 14, color: '#7FA8D9' }} />
          <IconRings className="onix-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#7FA8D9' }} />
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #7FA8D9, transparent)' }} />
        </div>
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#140B14] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#7FA8D9]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#7FA8D9] p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#7FA8D9] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#7FA8D9] p-6 sm:p-8 mb-10 shadow-sm">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#B9A6B4] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  FIESTA / SALÓN
                </span>
                {lugarNombre && (
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#7FA8D9] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16">
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#7FA8D9]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  <IconRibbon className="onix-scroll-doodle opacity-0" style={{ width: 20, height: 11 }} />
                  CRONOGRAMA
                </p>
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex flex-col sm:flex-row sm:items-center py-4 border-b border-[#7FA8D9]/10 last:border-b-0">
                      {item.time && (
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#1C141C] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#7FA8D9]">
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#1C141C' }} aria-hidden="true">
            <IconMusic className="onix-scroll-doodle opacity-0" style={{ width: 24, height: 24, color: '#7FA8D9' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
        ...
        <div className="w-full flex items-center justify-center gap-2 py-6" style={{ background: '#140B14' }} aria-hidden="true">
          <div style={{ width: 28, height: 1, background: 'linear-gradient(90deg, transparent, #7FA8D9, transparent)' }} />
          <IconRings className="onix-scroll-doodle opacity-0" style={{ width: 12, height: 12, color: '#7FA8D9' }} />
          <div style={{ width: 28, height: 1, background: 'linear-gradient(90deg, transparent, #7FA8D9, transparent)' }} />
        </div>
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#7FA8D9" surfaceColor="#1C141C" />}
      </div>
  );
}
