...
export function ElegantTemplateDarkYellow({ invitation, guest, isPersonalized = false }: ConviteTemplateProps) {
  ...
  return (
    <>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className="font-sans text-[8px] font-semibold uppercase tracking-[0.2em] text-[#B8964C] leading-none mb-1">Pase Especial</span>
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#F2EFE6] font-sans text-[10px] font-semibold tracking-wider uppercase">Pase</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="desktop-stage" data-theme={theme} style={{ '--t-acc': '#B8964C', '--t-acc2': '#B8964C', '--c-accent': '#B8964C' } as React.CSSProperties}>
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#F9F7F1]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#F9F7F1] z-10 relative">
            <p className="font-sans text-xs font-semibold uppercase tracking-[0.2em] text-[#B8964C] mb-6">
              {eyebrow}
            </p>
            ...
            {Boolean(activeDressCode) && (
              <p className="font-sans text-xs font-semibold text-[#B8964C] tracking-widest uppercase mt-4">
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="bg-[#FAF8F5] border border-[#B8964C]/20 rounded-xl p-5 sm:p-7 mb-6 shadow-sm transition-all hover:shadow-md">
                <div>
                  <span className="font-sans text-[10px] font-semibold uppercase tracking-[0.2em] text-[#8A7039] block mb-3">
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-2 font-sans text-xs font-semibold tracking-wider text-[#1A2B33] uppercase underline underline-offset-4 decoration-[#B8964C] hover:text-[#B8964C] transition-colors">
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-[#FAF8F5] border border-[#B8964C]/20 rounded-xl p-5 sm:p-7 mb-10 shadow-sm transition-all hover:shadow-md">
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-2 font-sans text-xs font-semibold tracking-wider text-[#1A2B33] uppercase underline underline-offset-4 decoration-[#B8964C] hover:text-[#B8964C] transition-colors">
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
                ...
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex items-center py-5 border-b border-[#B8964C]/30 last:border-b-0">
                      {item.time && (
                        <span className="font-sans text-lg sm:text-xl text-[#B8964C]/90 font-light tracking-widest w-28 sm:w-32 flex-shrink-0">
                          {item.time}
                        </span>
                      )}
                    ...
                    {showBankDetails && (
                      <div className="grid grid-cols-1 gap-6 text-left w-full mt-4 items-stretch">
                        ...
                        {pagoTarjetaHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#F2EFE6] space-y-2">
                            <div className="flex items-center gap-2 font-semibold text-[#1A2B33] text-sm border-b border-[#B8964C]/20 pb-2">
                              <CreditCard className="w-5 h-5 text-[#B8964C]" strokeWidth={1.5} />
                        ...
                        {regaloHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#F2EFE6] space-y-2">
                            <div className="flex items-center gap-2 font-semibold text-[#1A2B33] text-sm border-b border-[#B8964C]/20 pb-2">
                              <Gift className="w-5 h-5 text-[#B8964C]" strokeWidth={1.5} />
                        ...
                        <>
                          ...
                          {showBankDetails && (
                            <div className="w-full text-left mt-4">
                              <div className="px-4 py-5 sm:p-5 bg-[#F2EFE6] space-y-1">
