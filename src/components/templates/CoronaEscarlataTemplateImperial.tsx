  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="cne-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="cne-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1F1329 0%, #120A18 52%, #150720 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="cne-section" style={{ background: "#2A0E3A" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="cne-section" style={{ background: "#2A0E3A" }}>
