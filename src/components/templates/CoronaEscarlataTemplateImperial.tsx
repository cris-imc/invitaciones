...
const CNE_CSS = `
  ...
  .cne-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(227,169,187,0.5), rgba(122,63,140,0.4), rgba(227,169,187,0.55), rgba(227,169,187,0.5)); filter: blur(64px); opacity: .62; animation: gpFoil 26s linear infinite; }
