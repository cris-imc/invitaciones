          ...
          <div className="cne-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="21,7,32" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="21,7,32" />
              </div>
            )}
...
function CneCoverHalf({
  ...
  return (
    <div className="cne-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#E3A9BB" tintColor2="#150720" effect="enfoque" scrimColorRgb="21,7,32" />
        </div>
      )}
