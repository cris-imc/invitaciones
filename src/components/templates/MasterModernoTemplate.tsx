 ...
 * Cambia solo la capa visual: paleta grafito (#0F0E13) + dorado champagne (#C9A876)
...
interface ModernoTemplateProps {
  ...
  return (
    <>
      <style>{`
        ...
        #rsvp.section.dark {
          background-color: #0F0E13 !important; /* Dark brown/black */
        ...
        #rsvp.section.dark input {
          background-color: #1C1926 !important;
        ...
        #songs.d-sec.dark {
          background-color: #0F0E13 !important; /* Light theme */
        ...
        #songs.d-sec.dark input {
          ...
          background-color: #1C1926 !important; /* Pastel */
        ...
        >
          {isTicketMaximized ? (
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#1C1926] font-sans text-[10px] font-semibold tracking-wider uppercase">Pase</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0F0E13] relative">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t from-[#0F0E13] via-[#0F0E13]/50 to-transparent" />
          </div>
        ...
        {(Boolean(invitation.frasePersonalizadaHabilitada) && Boolean(invitation.frasePersonalizadaTexto)) ? (
          <SectionWrapper id="quote" delay={100} className="w-full bg-[#1C1926] py-24 px-6 md:px-12 flex items-center justify-center">
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#0F0E13] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                    ...
                    {showBankDetails && (
                      <div className="grid grid-cols-1 gap-6 text-left w-full mt-4 items-stretch">
                        ...
                        {pagoTarjetaHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#1C1926] space-y-2">
                        ...
                        <>
                          ...
                          {showBankDetails && (
                            <div className="w-full text-left mt-4">
                              <div className="px-4 py-5 sm:p-5 bg-[#1C1926] space-y-1">
        ...
        {triviaHabilitada && triviaPreguntas.length > 0 && (
          <SectionWrapper id="quiz" delay={300} className="w-full bg-[#1C1926] py-20 px-6 md:px-12">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-8">
