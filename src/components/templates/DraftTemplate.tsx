          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#C79A4B] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{tx("invitacion.pase.paseEspecial")}</span>
                ...
                {guest.mesas && guest.mesas.length > 0 && (
                  <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#C79A4B] leading-none mt-1.5" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{guest.mesas.join(" · ")}</span>
                )}
              </div>
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#EAE5D9]  text-[10px] font-semibold tracking-wider uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{tx("invitacion.pase.pase")}</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#F9F7F1]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#F9F7F1] z-10 relative">
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#C79A4B] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#C79A4B] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                {tx("invitacion.ubicacion.dressCode")} {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-[#FAF8F5] border border-[#C79A4B]/20 rounded-xl p-5 sm:p-7 mb-10 shadow-sm transition-all hover:shadow-md">
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-2  text-xs font-semibold tracking-wider text-[#1A2B33] uppercase underline underline-offset-4 decoration-[#C79A4B] hover:text-[#C79A4B] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                ...
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex items-center py-5 border-b border-[#C79A4B]/30 last:border-b-0">
                      {item.time && (
                        <span className=" text-lg sm:text-xl text-[#C79A4B]/90 font-light tracking-widest w-28 sm:w-32 flex-shrink-0" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                          {item.time}
                        </span>
                      )}
                        ...
                        {pagoTarjetaHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#EAE5D9] space-y-2">
                            <div className="flex items-center gap-2 font-semibold text-[#1A2B33] text-sm border-b border-[#C79A4B]/20 pb-2">
                              ...
                              <span>{String((invitation as any).pagoTarjetaTitulo || tx("invitacion.regalos.pagoTarjetas"))}</span>
                            </div>
                            ...
                            {Boolean((invitation as any).pagoTarjetaBanco) && (
                              <InfoRow label={tx("invitacion.regalos.banco").toUpperCase()} value={String((invitation as any).pagoTarjetaBanco)} />
                            )}
                            ...
                            {Boolean((invitation as any).pagoTarjetaTitular) && (
                              <InfoRow label={tx("invitacion.regalos.titular").toUpperCase()} value={String((invitation as any).pagoTarjetaTitular)} />
                            )}
                          </div>
                        )}
                        ...
                        {regaloHabilitado && (
                          <div className="px-4 py-5 sm:p-5 bg-[#EAE5D9] space-y-2">
                            <div className="flex items-center gap-2 font-semibold text-[#1A2B33] text-sm border-b border-[#C79A4B]/20 pb-2">
                              ...
                              <span>{String((invitation as any).regaloTitulo || tx("invitacion.regalos.tituloEvento"))}</span>
                            </div>
                            ...
                            {Boolean((invitation as any).regaloBanco) && (
                              <InfoRow label={tx("invitacion.regalos.banco").toUpperCase()} value={String((invitation as any).regaloBanco)} />
                            )}
                            ...
                            {Boolean((invitation as any).regaloTitular) && (
                              <InfoRow label={tx("invitacion.regalos.titular").toUpperCase()} value={String((invitation as any).regaloTitular)} />
                            )}
                          </div>
                        )}
                      </div>
                            ...
                            <div className="w-full text-left mt-4">
                              <div className="px-4 py-5 sm:p-5 bg-[#EAE5D9] space-y-1">
                                {Boolean(activeBank.banco) && (
                                  <InfoRow label={tx("invitacion.regalos.banco").toUpperCase()} value={activeBank.banco} />
                                )}
                                ...
                                {Boolean(activeBank.titular) && (
                                  <InfoRow label={tx("invitacion.regalos.titular").toUpperCase()} value={activeBank.titular} />
                                )}
                              </div>
                            </div>
                          )}
