...
/**
 * PrensaTemplateArena.tsx — Colección Paper · Papel Prensado · Familia 01 "Prensa"
 * Variante: Arena (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Hueso, Arena, Piedra, Humo) se
...
interface PrensaTemplateArenaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function PrensaTemplateArena({ invitation, guest, isPersonalized = false }: PrensaTemplateArenaProps) {
  const tx = useTextos();
