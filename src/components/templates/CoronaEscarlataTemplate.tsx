      ...
      <div ref={scrollerRef} data-scroller="1" className="cne-scroller">
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="cne-section" style={{ background: "#2A0A0E" }}>
            <span data-xin="1" data-dist="-60" className="cne-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 8} — EL JUEGO</span>
...
const CNE_CSS = `
  ...
  .cne-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #3A0E12 0%, #26131F 60%, #220709 100%); }
