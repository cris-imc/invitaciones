  ...
  return (
    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="gardenparty-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #E0709A',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#E0709A',
            }}>
              {monogram}
            </div>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#E0709A] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#FDF1F3]" aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #E0709A, transparent)' }} />
          <IconGarland className="gardenparty-scroll-doodle opacity-0" style={{ width: 30, height: 13, color: '#E0709A' }} />
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #E0709A, transparent)' }} />
        </div>
          ...
          <SectionWrapper id="album" delay={200} className="w-full py-20 overflow-hidden" style={{ background: "var(--t-surface)" }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-10 flex items-center gap-2">
                <IconFlower className="gardenparty-scroll-doodle opacity-0" style={{ width: 16, height: 16, color: '#E0709A' }} />
                ÁLBUM
              </p>
            </div>
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#FDF1F3' }} aria-hidden="true">
            <IconMusic className="gardenparty-scroll-doodle opacity-0" style={{ width: 26, height: 26, color: '#E0709A' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
