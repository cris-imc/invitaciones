  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#080808", tinta: "#F4F1EA", acento: "#D93A2B", clase: `${flbArchivo.variable} ${flbMono.variable}`, fuente: "var(--flb-mono), monospace" }}
      />
    );
  }
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="flb-scroller">
            ...
            <div data-strip="1" className="flb-strip">
              ...
              <div data-tone="dark" className="flb-panel flb-panel--center" style={{ background: "#0B0B0B", color: "#F4F1EA" }}>
                <div className="flb-medallion flb-medallion--lg">
                  <FlbMedallion kicker={tx("invitacion.pase.sector").toUpperCase()} main={tx("invitacion.pase.pasarela")} sub="LOOK 04" subColor="#D93A2B" arcId="flbArc2" arcText={tx("invitacion.pase.arcoAccesoVipLook", { n: passNumber }).toUpperCase()} spin="reverse" />
                </div>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="flb-section" style={{ background: "#0B0B0B" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="flb-section" style={{ background: "#0B0B0B" }}>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#D93A2B" guest={guest} />
      )}
