...
const FLB_CSS = `
  ...
  .flb-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #141414 0%, #0B0B0B 46%, #080808 100%); }
  .flb-cover-half--bottom .flb-cover-inner { top: auto; bottom: 0; }
  .flb-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(217,58,43,0.35), rgba(11,11,11,0.5), rgba(217,58,43,0.5), rgba(217,58,43,0.35)); filter: blur(64px); opacity: .62; animation: gpFoil 26s linear infinite; }
  ...
  .flb-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#D93A2B, transparent); display: block; }
  ...
  .flb-cover-cta { border: 1px solid #D93A2B; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--flb-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
