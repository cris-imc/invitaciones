...
/**
 * LiquidGlassTemplate.tsx
 *
 * Portado 1:1 desde el diseño "Liquid Glass — Panorámica" aprobado en Claude
 * Design (panel de acceso de vidrio para boda: fondo casi negro azulado,
 * acento celeste "vidrio" #6FA8C9, Cormorant Garamond + IBM Plex Mono,
...
export function LiquidGlassTemplate({ invitation, guest, isPersonalized = false }: LiquidGlassTemplateProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      ...
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#6FA8C9";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(111,168,201,.35), 0 18px 50px -30px #6FA8C9";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#1C2530" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#1C2530" : "#6FA8C9";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#080A0D", tinta: "#F4F1EA", acento: "#6FA8C9", clase: `${lqgCormorant.variable} ${lqgMono.variable}`, fuente: "var(--lqg-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="lqg-scroller">
        ...
        <section data-tone="dark" data-screen-label="Save the Date" className="lqg-section" style={{ background: "radial-gradient(120% 80% at 50% 0%, #17141F 0%, #0A0D11 55%, #080A0D 100%)" }}>
            ...
            <div className="lqg-hero-photo-frame">
              {photoMobile && (
                <div className="acp-mobile-only">
                  <AnimatedCoverPhoto photoSrc={photoMobile} tint={false} effect="enfoque" scrimColorRgb="8,10,13" />
                </div>
              )}
              {photoDesktop && (
                <div className="acp-desktop-only">
                  <AnimatedCoverPhoto photoSrc={photoDesktop} tint={false} effect="enfoque" scrimColorRgb="8,10,13" />
                </div>
              )}
            </div>
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="lqg-section lqg-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #141B22 0%, #0B0E12 55%, #080A0D 100%)" }}>
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label={tx("invitacion.frase.etiqueta")} className="lqg-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1C1727 0%, #0C0B11 52%, #080A0D 100%)" }}>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label={tx("invitacion.ubicacion.cuandoYDonde")} className="lqg-pan" style={!scrollVertical && ceremoniaHabilitada ? { height: "340vh" } : undefined}>
          <div className="lqg-pan-sticky">
            <div data-strip="1" className="lqg-strip">
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="lqg-panel lqg-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="lqg-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#1C2530" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#1C2530" />
                  </svg>
              ...
              <div data-tone="dark" className="lqg-panel lqg-panel--center" style={{ background: "#0A0D11", color: "#F4F1EA" }}>
        ...
        <section data-tone="dark" data-screen-label="Check-in" className="lqg-section" style={{ background: "radial-gradient(110% 70% at 50% 100%, #17141F 0%, #0A0D11 60%, #080A0D 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="lqg-section" style={{ background: "#0A0D11" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="lqg-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="lqg-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F5F8F9" : "#6FA8C9" }} />
              ))}
            </div>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="lqg-section" style={{ background: "#0A0D11" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="lqg-section" style={{ background: "#0A0D11" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu panel" className="lqg-section lqg-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #0A0D11 55%, #080A0D 100%)" }}>
    ...
    <div className="lqg-cover-inner">
      ...
      <div className="lqg-cover-content">
        <div className="lqg-cover-top-row">
          <span>{tx("invitacion.pase.numeroPanel", { n: panelNumber }).toUpperCase()}</span><span className="lqg-accent-navy-solid" style={{ color: "#6FA8C9" }}>ALL ACCESS</span>
        </div>
...
const LQG_CSS = `
  ...
  a { color: #6FA8C9; text-decoration: none; }
  ...
  .lqg-hero-photo-section { min-height: calc(var(--vh, 1vh) * 100); position: relative; overflow: hidden; background: #080A0D; }
  ...
  @media (min-width: 768px) {
    .lqg-hero-photo-frame { inset: 64px max(24px, calc((100% - 900px) / 2)); border: 1px solid rgba(111,168,201,.3); }
  ...
  .lqg-date-month { font-family: var(--lqg-cormorant), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #6FA8C9; padding-left: 12%; }

  .lqg-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .lqg-divider-line { width: 52px; height: 1px; background: #6FA8C9; display: inline-block; }
  ...
  .lqg-cal-link:hover { color: #6FA8C9; }
  ...
  .lqg-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #1C2530, #0E1116, #6FA8C9, #F5F8F9, #1C2530); filter: saturate(.75); }
  ...
  .lqg-medallion-sub--accent { color: #6FA8C9; }
  ...
  .lqg-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #6FA8C9; opacity: 0.4; font-family: var(--lqg-mono), monospace; }
  ...
  .lqg-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #6FA8C9; }
  .lqg-perf-strip { height: 12px; position: relative; background: radial-gradient(circle at 6px 50%, #080A0D 3.4px, transparent 3.8px) 0 0/12px 12px repeat-x; opacity: .85; }
  ...
  .lqg-glow-blob { position: absolute; right: -26%; top: 4%; width: 82vw; max-width: 540px; aspect-ratio: 1; border-radius: 50%; background: conic-gradient(from 200deg, rgba(111,168,201,0.3), rgba(232,240,242,0.2), rgba(111,168,201,0.34), rgba(111,168,201,0.3)); filter: blur(80px); opacity: .4; animation: lqgFoil 30s linear infinite; }
  ...
  .lqg-accent-italic { font-style: italic; color: #6FA8C9; }
  .lqg-accent-serif { font-style: italic; color: #6FA8C9; font-family: var(--lqg-cormorant), serif; }
  .lqg-accent-navy { font-style: italic; color: #1C2530; font-family: var(--lqg-cormorant), serif; }
  .lqg-accent-navy-solid { color: #1C2530; }
  ...
  .lqg-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #1C2530; margin-top: auto; }
  ...
  .lqg-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #1C2530; }
  ...
  .lqg-crono-time { font-family: var(--lqg-mono), monospace; color: #1C2530; min-width: 42px; }
  ...
  .lqg-rsvp-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 12px 0; border-bottom: 1px solid rgba(111,168,201,0.18); font-size: 10.5px; letter-spacing: 0.18em; color: #8A8577; }
  ...
  .lqg-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #6FA8C9; background: transparent; color: #6FA8C9; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .lqg-rsvp-input { background: transparent; border: none; border-bottom: 1px solid rgba(111,168,201,0.3); color: #F4F1EA; font-family: var(--lqg-mono), monospace; font-size: 11px; letter-spacing: 0.02em; padding: 4px 2px; text-align: right; max-width: 55%; }
  .lqg-rsvp-input::placeholder { color: #6E6A5D; }
  .lqg-rsvp-input:focus { outline: none; border-bottom-color: #6FA8C9; }
  .lqg-rsvp-btn { width: 100%; padding: 16px; font-family: var(--lqg-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #6FA8C9, #4A7A96); border: 1px solid #6FA8C9; color: #0B0B10; cursor: pointer; }
  .lqg-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .lqg-rsvp-btn--ghost { background: transparent; color: #6FA8C9; }
  .lqg-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #6FA8C9; margin: 0; }
  ...
  .lqg-bank-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(111,168,201,0.18); }
  ...
  .lqg-bank-copy { flex-shrink: 0; font-family: var(--lqg-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #6FA8C9; background: transparent; color: #6FA8C9; cursor: pointer; }
  .lqg-bank-copy:hover { background: rgba(111,168,201,0.12); }
  ...
  .lqg-song-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; border-bottom: 1px solid rgba(111,168,201,0.3); padding-bottom: 12px; }
  ...
  .lqg-song-input { background: transparent; border: none; border-bottom: 1px solid rgba(111,168,201,0.3); color: #F4F1EA; font-family: var(--lqg-mono), monospace; font-size: 12px; padding: 6px 2px; min-width: 0; flex: 1; }
  .lqg-song-input::placeholder { color: #6E6A5D; }
  .lqg-song-input:focus { outline: none; border-bottom-color: #6FA8C9; }
  .lqg-song-sep { color: #8A8577; flex-shrink: 0; }
  .lqg-song-submit { flex-shrink: 0; background: none; border: none; color: #6FA8C9; font-family: var(--lqg-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .lqg-song-submit:hover { color: #F5F8F9; }
  .lqg-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .lqg-song-error { font-size: 10px; color: #6FA8C9; margin-top: 6px; }
  ...
  .lqg-quiz-opt { font-family: var(--lqg-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(111,168,201,0.4); background: transparent; color: #6FA8C9; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .lqg-quiz-opt:disabled { cursor: default; }
  .lqg-quiz-opt--picked { background: #6FA8C9; border-color: #6FA8C9; color: #0B0B10; }
  .lqg-quiz-opt--correct { background: #6FA8C9; border-color: #6FA8C9; color: #0B0B10; }
  .lqg-quiz-opt--wrong { border-color: #8A6A6A; color: #C99; opacity: 0.6; }
  .lqg-quiz-result { padding-top: 18px; border-top: 1px solid rgba(111,168,201,0.2); }
  ...
  .lqg-final-card { border: 1px solid #6FA8C9; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  ...
  .lqg-replay { cursor: pointer; color: #6FA8C9; }
  ...
  .lqg-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F5F8F9, #6FA8C9); transition: height 260ms linear; display: block; }
  .lqg-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #6FA8C9; transition: color 500ms ease; }
  ...
  .lqg-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #0E1116 0%, #0A0D11 46%, #080A0D 100%); }
  .lqg-cover-half--bottom .lqg-cover-inner { top: auto; bottom: 0; }
  .lqg-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(111,168,201,0.4), rgba(232,240,242,0.3), rgba(111,168,201,0.5), rgba(111,168,201,0.4)); filter: blur(64px); opacity: .62; animation: lqgFoil 26s linear infinite; }
  ...
  .lqg-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#6FA8C9, transparent); display: block; }
  ...
  .lqg-cover-cta { border: 1px solid #6FA8C9; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--lqg-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .lqg-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #6FA8C9; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
