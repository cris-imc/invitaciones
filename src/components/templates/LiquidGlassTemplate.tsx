  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="lqg-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="lqg-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1C1727 0%, #0C0B11 52%, #080A0D 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="lqg-section" style={{ background: "#0A0D11" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="lqg-section" style={{ background: "#0A0D11" }}>
