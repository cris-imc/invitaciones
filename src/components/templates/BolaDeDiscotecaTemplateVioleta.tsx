  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="bdd-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="bdd-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #2A1938 0%, #170F1E 52%, #0B0714 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="bdd-section" style={{ background: "#120B1C" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="bdd-section" style={{ background: "#120B1C" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="bdd-section bdd-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #241531 0%, #120B1C 55%, #0B0714 100%)" }}>
