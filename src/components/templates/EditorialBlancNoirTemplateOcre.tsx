 ...
 * Variante: Ocre. Es la familia BASE de la sub-colección: las otras
...
export function EditorialBlancNoirTemplateOcre({ invitation, guest, isPersonalized = false }: EditorialBlancNoirTemplateProps) {
  const tx = useTextos();
