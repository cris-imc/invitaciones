...
/**
 * NocheTemplateBronce.tsx — Colección Paper · Papel Prensado · Familia 02 "Noche"
 * Variante: Bronce (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Tinta, Vino, Bosque, Bronce)
...
interface NocheTemplateBronceProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function NocheTemplateBronce({ invitation, guest, isPersonalized = false }: NocheTemplateBronceProps) {
  const tx = useTextos();
