...
/**
 * LumbreTemplateSombra.tsx — Colección Paper · Papel Prensado · Familia 06 "Lumbre"
 * Variante: Sombra (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Tostado, Arcilla, Ceniza, Sombra)
...
interface LumbreTemplateSombraProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function LumbreTemplateSombra({ invitation, guest, isPersonalized = false }: LumbreTemplateSombraProps) {
  const tx = useTextos();
