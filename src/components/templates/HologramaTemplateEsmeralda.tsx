    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="holo-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #2EE6A8',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#2EE6A8',
            }}>
              {monogram}
            </div>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#2EE6A8] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0D0D14]">
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(115deg, transparent 20%, rgba(46,230,168,0.35) 35%, rgba(34,211,238,0.45) 50%, rgba(255,255,255,0.3) 58%, transparent 75%)',
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#0D0D14]" aria-hidden="true">
          <IconPrism className="holo-scroll-doodle opacity-0" style={{ width: 24, height: 20, color: 'rgba(46,230,168,0.5)' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0D0D14' }} aria-hidden="true">
            <IconMusic className="holo-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#2EE6A8' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
