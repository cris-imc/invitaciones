/**
 * HologramaTemplateEsmeralda.tsx
 ...
 * Aitana): fondo casi negro violáceo (#0D0D14) + acentos violeta (#2EE6A8)
...
const PhotoCornerFrame = () => (
  <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
    <div
      ...
      style={{
        padding: 1,
        background: "linear-gradient(115deg, rgba(46,230,168,0.75), rgba(34,211,238,0.65), rgba(46,230,168,0.75))",
...
interface HologramaTemplateEsmeraldaProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#2EE6A8]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#2EE6A8] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#2EE6A8] shrink-0" />
...
export function HologramaTemplateEsmeralda({ invitation, guest, isPersonalized = false }: HologramaTemplateEsmeraldaProps) {
  const tx = useTextos();
  ...
  return (
    ...
    >
      <style>{`
        ...
        .holo-gradient-text {
          background: linear-gradient(120deg, #F1EEFF, #2EE6A8, #22D3EE, #F1EEFF);
        ...
        #countdown[data-style="clasico"].dark > div > div > div {
          ...
          border-color: rgba(46,230,168,0.3) !important;
          backdrop-filter: blur(6px);
          -webkit-backdrop-filter: blur(6px);
        }

        /* RSVP Custom Aesthetics for HologramaTemplateEsmeralda */
        #rsvp.section.dark {
          background-color: #0D0D14 !important;
          color: #FFFFFF !important;
        ...
        #rsvp.section.dark input {
          ...
          border: 1px solid rgba(46,230,168,0.2) !important;
        ...
        #rsvp.section.dark .t-btn {
          ...
          background-color: #2EE6A8 !important;
          color: #0D0D14 !important;
          font-weight: 600 !important;
          border: none !important;
          text-transform: uppercase !important;
        ...
        #songs.d-sec.dark .t-kicker {
          font-family: var(--font-body-custom, var(--font-inter)), sans-serif !important;
          color: #2EE6A8 !important; /* Gold/Orange */
          font-size: 11px !important;
          font-weight: 600 !important;
          text-transform: uppercase !important;
          letter-spacing: 0.2em !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(46,230,168,0.13), transparent), radial-gradient(45% 40% at 85% 80%, rgba(34,211,238,0.2), transparent)',
            backgroundSize: '160% 160%',
            animation: 'holo-meshDrift 14s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', width: 220, height: 220, borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(46,230,168,0.13), transparent 70%)',
          ...
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 34, height: 34, top: '10%', left: '12%', color: 'rgba(46,230,168,0.5)' }} />
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 26, height: 26, top: '14%', right: '14%', color: 'rgba(34,211,238,0.4)' }} />
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 30, height: 30, bottom: '16%', left: '18%', color: 'rgba(46,230,168,0.35)' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <button
              ...
              style={{
                ...
                background: 'linear-gradient(90deg, #2EE6A8, #22D3EE)',
                boxShadow: '0 8px 24px rgba(46,230,168,0.35)',
                marginTop: '1rem',
              }}
            >
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#2EE6A8]/40 shadow-md ${isTicketMaximized ? 'bg-[#0D0D14]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#2EE6A8] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{tx("invitacion.pase.paseEspecial")}</span>
                ...
                {guest.mesas && guest.mesas.length > 0 && (
                  <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#2EE6A8] leading-none mt-1.5" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{guest.mesas.join(" · ")}</span>
                )}
              </div>
              <div className="flex flex-col items-end border-l border-[#2EE6A8]/20 pl-3">
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              <Ticket className="w-4 h-4 text-[#2EE6A8]" />
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#2EE6A8', margin: '6px 0 14px', animation: 'holo-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0D0D14]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#0D0D14] z-10 relative">
            ...
            <IconParticle className="holo-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 60, right: 56, color: '#2EE6A8' }} />
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#2EE6A8] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            ...
            <div style={{ width: 40, height: 2, background: '#2EE6A8', margin: '0 0 20px', animation: 'holo-lineExpand 1.2s ease-out' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#2EE6A8] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                {tx("invitacion.ubicacion.dressCode")} {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div ref={orbBackRef} className="absolute pointer-events-none z-0" style={{ top: '8%', left: '-10%', width: 160, height: 160, borderRadius: '50%', background: 'radial-gradient(circle, rgba(46,230,168,0.35), transparent 70%)', filter: 'blur(4px)' }} aria-hidden="true" />
            ...
            <div
              ...
              style={{
                background: 'radial-gradient(ellipse 55% 42% at 50% 50%, rgba(46,230,168,0.32), rgba(34,211,238,0.22) 45%, transparent 72%)',
                filter: 'blur(16px)',
                opacity: 0,
              }}
            />
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#0D0D14] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            ...
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#2EE6A8]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {Boolean(invitation.ceremoniaHabilitada) && (
              <div className="bg-white/[0.04] border border-[#2EE6A8]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#2EE6A8] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-white/[0.04] border border-[#2EE6A8]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-10 shadow-sm">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#9490B4] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#2EE6A8] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16" id="schedule">
                ...
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#2EE6A8]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  CRONOGRAMA
                </p>
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex flex-col sm:flex-row sm:items-center py-4 border-b border-[#2EE6A8]/10 last:border-b-0">
                      {item.time && (
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#131228] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                ...
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#2EE6A8]">
        ...
        <div className="w-full flex justify-center py-6" style={{ background: '#0D0D14' }} aria-hidden="true">
          <svg className="holo-scroll-doodle opacity-0" viewBox="0 0 90 20" width="90" height="20" fill="none" stroke="rgba(46,230,168,0.6)" strokeWidth="1.2">
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#2EE6A8" surfaceColor="#16162C" />}
      </div>
  );
}
