...
/**
 * CorporativoAniversarioTemplatePlata.tsx
 *
...
interface CorporativoAniversarioTemplatePlataProps {
...
export function CorporativoAniversarioTemplatePlata({ invitation, guest, isPersonalized = false }: CorporativoAniversarioTemplatePlataProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      if (statusRef.current) {
        ...
        statusRef.current.style.color = "#EEF1F3";
      }
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#B8C0C9";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #B8C0C9";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#5C6570" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#5C6570" : "#B8C0C9";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0B0F13", tinta: "#F4F1EA", acento: "#B8C0C9", clase: `${cpaDisplay.variable} ${cpaMono.variable}`, fuente: "var(--cpa-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="cpa-panel cpa-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="cpa-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#5C6570" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#5C6570" />
                  </svg>
          ...
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="cpa-section" style={{ background: "#0E1319" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="cpa-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="cpa-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#EEF1F3" : "#B8C0C9" }} />
              ))}
            </div>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#B8C0C9" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #B8C0C9; text-decoration: none; }
  a:hover { color: #EEF1F3; }
  ...
  .cpa-date-month { font-family: var(--cpa-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #B8C0C9; padding-left: 12%; }

  .cpa-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .cpa-divider-line { width: 52px; height: 1px; background: #B8C0C9; display: inline-block; }
  ...
  .cpa-cal-link:hover { color: #B8C0C9; }
  ...
  .cpa-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #B8C0C9, #EEF1F3, #6E5AA8); filter: saturate(.75); }
  ...
  .cpa-medallion-label { font-family: var(--cpa-display), serif; font-size: 26px; line-height: 1; color: #EEF1F3; }
  .cpa-medallion-label-sm { font-family: var(--cpa-display), serif; font-size: 16px; color: #EEF1F3; }
  .cpa-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .cpa-medallion-sub--accent { color: #B8C0C9; }
  ...
  .cpa-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #B8C0C9; opacity: 0.4; font-family: var(--cpa-mono), monospace; }
  ...
  .cpa-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #EEF1F3, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .cpa-cd-num { font-family: var(--cpa-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #EEF1F3; display: inline-block; }
  .cpa-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #B8C0C9; }
  ...
  .cpa-accent-italic { font-style: italic; color: #B8C0C9; }
  .cpa-accent-serif { font-style: italic; color: #5C6570; font-family: var(--cpa-display), serif; }
  .cpa-accent-serif-2 { color: #5C6570; }
  ...
  .cpa-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #5C6570; margin-top: auto; }
  ...
  .cpa-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #5C6570; }
  ...
  .cpa-crono-time { font-family: var(--cpa-mono), monospace; color: #5C6570; min-width: 42px; }
  ...
  .cpa-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #EEF1F3, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .cpa-rsvp-payment-total { color: #EEF1F3; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .cpa-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #B8C0C9; background: transparent; color: #B8C0C9; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .cpa-rsvp-input:focus { outline: none; border-bottom-color: #B8C0C9; }
  .cpa-rsvp-btn { width: 100%; padding: 16px; font-family: var(--cpa-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #B8C0C9, #5C6570); border: 1px solid #B8C0C9; color: #0E1319; cursor: pointer; }
  .cpa-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .cpa-rsvp-btn--ghost { background: transparent; color: #B8C0C9; }
  .cpa-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #B8C0C9; margin: 0; }
  ...
  .cpa-bank-copy { flex-shrink: 0; font-family: var(--cpa-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #B8C0C9; background: transparent; color: #B8C0C9; cursor: pointer; }
  ...
  .cpa-song-input:focus { outline: none; border-bottom-color: #B8C0C9; }
  .cpa-song-sep { color: #8A8577; flex-shrink: 0; }
  .cpa-song-submit { flex-shrink: 0; background: none; border: none; color: #B8C0C9; font-family: var(--cpa-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .cpa-song-submit:hover { color: #EEF1F3; }
  .cpa-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .cpa-song-error { font-size: 10px; color: #B8C0C9; margin-top: 6px; }
  ...
  .cpa-quiz-opt { font-family: var(--cpa-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #B8C0C9; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .cpa-quiz-opt:disabled { cursor: default; }
  .cpa-quiz-opt--picked { background: #B8C0C9; border-color: #B8C0C9; color: #0E1319; }
  .cpa-quiz-opt--correct { background: #B8C0C9; border-color: #B8C0C9; color: #0E1319; }
  ...
  .cpa-quiz-result-score { margin: 0 0 6px; font-family: var(--cpa-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #EEF1F3; }
  .cpa-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .cpa-final-card { border: 1px solid #B8C0C9; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .cpa-final-names { font-family: var(--cpa-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #EEF1F3; }
  ...
  .cpa-replay { cursor: pointer; color: #B8C0C9; }
  ...
  .cpa-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#EEF1F3, #B8C0C9); transition: height 260ms linear; display: block; }
  .cpa-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #B8C0C9; transition: color 500ms ease; }
  ...
  .cpa-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(30,42,56,0.55), rgba(184,192,201,0.32), rgba(184,192,201,0.55), rgba(30,42,56,0.55)); filter: blur(64px); opacity: .62; animation: bbsFoil 26s linear infinite; }
  .cpa-cover-texture { position: absolute; inset: 0; background-image: radial-gradient(rgba(238,241,243,.08) 1px, transparent 1.2px); background-size: 22px 22px; }
  ...
  .cpa-cover-names { margin: 0; font-family: var(--cpa-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #EEF1F3; }
  .cpa-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#B8C0C9, transparent); display: block; }
  ...
  .cpa-cover-cta { border: 1px solid #B8C0C9; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--cpa-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .cpa-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #B8C0C9; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
