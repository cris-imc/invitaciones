  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="ifj-scroller">
        ...
        <div data-pan="1" data-screen-label="El lugar" className="ifj-pan">
          <div className="ifj-pan-sticky">
            <div data-strip="1" className="ifj-strip">
              <div id="details" data-tone="light" className="ifj-panel ifj-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                ...
                <div className="ifj-seguir">SEGUÍ BAJANDO <span className="ifj-side-hint">→</span></div>
              </div>
        ...
        {hasPayment && paymentAmount != null && !isExempt && (
          ...
          <div className="ifj-rsvp-row ifj-rsvp-row--payment">
            ...
            <div className="ifj-rsvp-payment-value">
              <span className="ifj-rsvp-payment-total">
                {formatARS(isPartialPayment ? paymentBalance : totalPayment)}
              </span>
              {isPaidInFull && (
                <div className="ifj-rsvp-payment-detail"><span>Pago registrado ✓</span></div>
              )}
              {isPartialPayment && (
