...
export function InfantilJurasicoTemplateAmarillo({ invitation, guest, isPersonalized = false }: InfantilJurasicoTemplateAmarilloProps) {
  ...
  return (
    ...
    >
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="ifj-section ifj-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #141A0C 55%, #101408 100%)" }}>
          ...
          <div data-xin="1" data-delay="100" data-dist="130" className="ifj-final-card">
            <div className="ifj-medallion ifj-medallion--final">
              <IfjMedallionCmp label="7" sub={confirmed ? "CONFIRMADO" : "PENDIENTE"} arcId="bbsArc3" arcText={`${namesTitle.toUpperCase()} · ${fechaCorta} · `} spin="reverse" />
            </div>
      ...
      <div ref={coverRef} className="ifj-cover">
    ...
    <div className="ifj-cover-inner">
      ...
      <div className="ifj-cover-content">
        <div className="ifj-cover-top-row">
          <span>PASE Nº {passNumber}</span><span className="ifj-accent-serif-2">ADMIT ONE</span>
        </div>
...
const GP_CSS = `
  ...
  .ifj-cover-names { margin: 0; font-family: var(--ifj-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #FAF3D8; }
