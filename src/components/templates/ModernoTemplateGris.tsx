...
export function ModernoTemplateGris({ invitation, guest, isPersonalized = false }: ModernoTemplateGrisProps) {
  ...
  const portadaTintColor2 = "#292A2D";
  ...
  if (eventStatus === "POST_EVENT") {
    return (
      <div className="min-h-dvh w-full bg-gradient-to-b bg-[#1E1F22] text-white relative overflow-x-hidden flex flex-col justify-between" data-theme={theme}>
  ...
  return (
    ...
    >
        ...
        >
          {isTicketMaximized ? (
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              ...
              <span className="text-[#292A2D]  text-[10px] font-semibold tracking-wider uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>{tx("invitacion.pase.pase")}</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <div className="d-right tpl">
        ...
        {mapUrl && (
          <section id="location" style={{ height: "220px", overflow: "hidden", background: "#1E1F22" }}>
        ...
        <LogoFooterCredit bgColor="#1E1F22" />
        </div>
      </div>
