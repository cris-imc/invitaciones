 ...
 * fondo azul-negro casi opaco (#0A0E16) + acentos celeste (#8FD3FF) y
...
interface Cristal3DTemplateProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#8FD3FF]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#8FD3FF] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#8FD3FF] shrink-0" />
...
export function Cristal3DTemplate({ invitation, guest, isPersonalized = false }: Cristal3DTemplateProps) {
  ...
  const portadaTintColor1 = "#8FD3FF";
  ...
  return (
    ...
    >
      <style>{`
        ...
        .crys-gradient-text {
          background: linear-gradient(120deg, #F0F6FF, #8FD3FF, #B9A6FF, #F0F6FF);
        ...
        /* RSVP Custom Aesthetics for Cristal3DTemplate */
        #rsvp.section.dark {
          background-color: #0A0E16 !important;
          color: #FFFFFF !important;
        ...
        #songs.d-sec.dark .t-kicker {
          font-family: var(--font-body-custom, var(--font-inter)), sans-serif !important;
          color: #8FD3FF !important; /* Gold/Orange */
          font-size: 11px !important;
          font-weight: 600 !important;
          text-transform: uppercase !important;
          letter-spacing: 0.2em !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <IconShard className="crys-doodle opacity-0 absolute" style={{ width: 16, height: 16, bottom: '22%', right: '28%', color: '#8FD3FF' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="crys-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #8FD3FF',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#8FD3FF',
            }}>
              {monogram}
            </div>
            ...
            <button
              ...
              style={{
                fontFamily: 'var(--font-body-custom, var(--font-inter)), sans-serif', border: '1px solid #8FD3FF', color: '#8FD3FF',
                background: 'rgba(143,211,255,0.08)', backdropFilter: 'blur(6px)',
                marginTop: '1rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#8FD3FF'; e.currentTarget.style.color = '#0A0E16'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(143,211,255,0.08)'; e.currentTarget.style.color = '#8FD3FF'; }}
            >
              ABRIR INVITACIÓN
            </button>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#8FD3FF]/40 shadow-md ${isTicketMaximized ? 'bg-[#0A0E16]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#8FD3FF] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
                <span className="text-[#FFFFFF] font-bold text-sm leading-none" style={{ fontFamily: 'var(--font-cormorant), serif' }}>{guest.name}</span>
              </div>
              <div className="flex flex-col items-end border-l border-[#8FD3FF]/20 pl-3">
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              <Ticket className="w-4 h-4 text-[#8FD3FF]" />
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#8FD3FF', margin: '6px 0 14px', animation: 'crys-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0A0E16]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#0A0E16] z-10 relative">
            ...
            <IconShard className="crys-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 60, right: 56, color: '#8FD3FF' }} />
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#8FD3FF] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            ...
            <div style={{ width: 40, height: 2, background: '#8FD3FF', margin: '0 0 20px', animation: 'crys-lineExpand 1.2s ease-out' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#8FD3FF] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#0A0E16] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#8FD3FF]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="crys-tilt-card bg-white/[0.04] border border-[#8FD3FF]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-6" style={{ boxShadow: '0 10px 30px rgba(10,14,22,0.45), 0 2px 0 rgba(143,211,255,0.06)' }}>
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#8FD3FF] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="crys-tilt-card bg-white/[0.04] border border-[#8FD3FF]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-10" style={{ boxShadow: '0 10px 30px rgba(10,14,22,0.45), 0 2px 0 rgba(143,211,255,0.06)', animationDelay: '1.4s' }}>
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#93A4B8] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  FIESTA / SALÓN
                </span>
                {lugarNombre && (
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#8FD3FF] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16">
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#8FD3FF]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
                  CRONOGRAMA
                </p>
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex flex-col sm:flex-row sm:items-center py-4 border-b border-[#8FD3FF]/10 last:border-b-0">
                      {item.time && (
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#0D141F] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#8FD3FF]">
                  <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0A0E16' }} aria-hidden="true">
            <IconMusic className="crys-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#8FD3FF' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#8FD3FF" surfaceColor="#121A28" />}
      </div>
  );
}
