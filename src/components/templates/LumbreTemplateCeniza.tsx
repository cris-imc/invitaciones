...
/**
 * LumbreTemplateCeniza.tsx — Colección Paper · Papel Prensado · Familia 06 "Lumbre"
 * Variante: Ceniza (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Tostado, Arcilla, Ceniza, Sombra)
...
interface LumbreTemplateCenizaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function LumbreTemplateCeniza({ invitation, guest, isPersonalized = false }: LumbreTemplateCenizaProps) {
  const tx = useTextos();
