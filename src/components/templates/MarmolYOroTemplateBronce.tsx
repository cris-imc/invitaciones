...
export function MarmolYOroTemplateBronce({ invitation, guest, isPersonalized = false }: MarmolYOroTemplateBronceProps) {
  ...
  const frase = frasePersonalizadaHabilitada && invitation.frasePersonalizadaTexto
    ...
    : "La piedra se talla una sola vez.";
          ...
          <div className="myo-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="8,7,10" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="8,7,10" />
              </div>
            )}
...
const MYO_CSS = `
  ...
  .myo-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #2A1B0D 0%, #120E0A 60%, #08070A 100%); }
