  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="myo-scroller">
        ...
        <div data-pan="1" data-screen-label="El lugar" className="myo-pan" style={ceremoniaHabilitada ? { height: "340vh" } : undefined}>
            ...
            <div data-strip="1" className="myo-strip">
              {ceremoniaHabilitada && (
                <div id="ceremonia" data-tone="light" className="myo-panel myo-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                  ...
                  <div className="myo-seguir">SEGUÍ BAJANDO <span className="myo-side-hint">→</span></div>
                </div>
              )}
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="myo-section" style={{ background: "#121010" }}>
            <span data-xin="1" data-dist="-60" className="myo-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6 + kOffset} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu pieza" className="myo-section myo-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #1C1710 0%, #121010 55%, #08070A 100%)" }}>
          <span data-xin="1" data-dist="-60" className="myo-kicker">{[sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 6 + kOffset} — GUARDÁ TU PIEZA</span>
      ...
      <div ref={coverRef} className="myo-cover">
    ...
    <div className="myo-cover-inner">
      ...
      <div className="myo-cover-content">
        ...
        <div className="myo-cover-bottom">
          <div ref={perfRef} className="myo-perf-strip myo-perf-strip--reveal" />
          ...
          <div className="myo-barcode-wrap">
            <div className="myo-barcode" style={{ width: "62%" }} />
            <span className="myo-mini-label" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
