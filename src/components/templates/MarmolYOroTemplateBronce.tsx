  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="myo-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="myo-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1D160E 0%, #100C09 52%, #08070A 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="myo-section" style={{ background: "#121010" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="myo-section" style={{ background: "#121010" }}>
