  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="cme-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="cme-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #181B1D 0%, #0B0D0E 52%, #121415 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="cme-section" style={{ background: "#1C2022" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="cme-section" style={{ background: "#1C2022" }}>
