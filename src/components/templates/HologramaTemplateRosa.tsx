 ...
 * Aitana): fondo casi negro violáceo (#0D0D14) + acentos violeta (#FF6FD8)
 * y cian (#7C4DFF), glassmorphism iridiscente (bordes con degradé, cards
...
const PhotoCornerFrame = () => (
  <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
    <div
      ...
      style={{
        padding: 1,
        background: "linear-gradient(115deg, rgba(255,111,216,0.75), rgba(124,77,255,0.65), rgba(255,111,216,0.75))",
    ...
    />
    <IconParticle style={{ position: "absolute", bottom: -9, right: -9, width: 16, height: 16, color: "#7C4DFF" }} />
  </div>
);
...
interface HologramaTemplateRosaProps {
...
export function HologramaTemplateRosa({ invitation, guest, isPersonalized = false }: HologramaTemplateRosaProps) {
  const tx = useTextos();
  ...
  return (
    ...
    >
      <style>{`
        ...
        .holo-gradient-text {
          background: linear-gradient(120deg, #F1EEFF, #FF6FD8, #7C4DFF, #F1EEFF);
        ...
        #countdown[data-style="clasico"].dark > div > div > div {
          ...
          border-color: rgba(255,111,216,0.3) !important;
          backdrop-filter: blur(6px);
          -webkit-backdrop-filter: blur(6px);
        }

        /* RSVP Custom Aesthetics for HologramaTemplateRosa */
        #rsvp.section.dark {
          background-color: #0D0D14 !important;
          color: #FFFFFF !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(255,111,216,0.13), transparent), radial-gradient(45% 40% at 85% 80%, rgba(124,77,255,0.2), transparent)',
            backgroundSize: '160% 160%',
            animation: 'holo-meshDrift 14s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', width: 220, height: 220, borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(255,111,216,0.13), transparent 70%)',
          ...
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 34, height: 34, top: '10%', left: '12%', color: 'rgba(255,111,216,0.5)' }} />
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 26, height: 26, top: '14%', right: '14%', color: 'rgba(124,77,255,0.4)' }} />
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 30, height: 30, bottom: '16%', left: '18%', color: 'rgba(255,111,216,0.35)' }} />
          <IconParticle className="holo-doodle opacity-0 absolute" style={{ width: 22, height: 22, top: '30%', right: '20%', color: '#7C4DFF' }} />
          <IconParticle className="holo-doodle opacity-0 absolute" style={{ width: 16, height: 16, bottom: '22%', right: '28%', color: '#FF6FD8' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <button
              ...
              style={{
                ...
                background: 'linear-gradient(90deg, #FF6FD8, #7C4DFF)',
                boxShadow: '0 8px 24px rgba(255,111,216,0.35)',
                marginTop: '1rem',
              }}
            >
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#FF6FD8]/40 shadow-md ${isTicketMaximized ? 'bg-[#0D0D14]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#FF6FD8', margin: '6px 0 14px', animation: 'holo-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0D0D14]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#0D0D14] z-10 relative">
            <IconOrb className="holo-scroll-doodle opacity-0 absolute" style={{ width: 24, height: 24, top: 10, right: 24, color: '#7C4DFF' }} />
            <IconParticle className="holo-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 60, right: 56, color: '#FF6FD8' }} />
            ...
            <div style={{ width: 40, height: 2, background: '#FF6FD8', margin: '0 0 20px', animation: 'holo-lineExpand 1.2s ease-out' }} />
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div ref={orbBackRef} className="absolute pointer-events-none z-0" style={{ top: '8%', left: '-10%', width: 160, height: 160, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,111,216,0.35), transparent 70%)', filter: 'blur(4px)' }} aria-hidden="true" />
            <div ref={orbFrontRef} className="absolute pointer-events-none z-30" style={{ bottom: '10%', right: '-8%', width: 120, height: 120, borderRadius: '50%', background: 'radial-gradient(circle, rgba(124,77,255,0.4), transparent 70%)', filter: 'blur(3px)' }} aria-hidden="true" />
            ...
            <div
              ...
              style={{
                background: 'radial-gradient(ellipse 55% 42% at 50% 50%, rgba(255,111,216,0.32), rgba(124,77,255,0.22) 45%, transparent 72%)',
                filter: 'blur(16px)',
                opacity: 0,
              }}
            />
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#0D0D14] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            ...
            {Boolean(invitation.ceremoniaHabilitada) && (
              <div className="bg-white/[0.04] border border-[#FF6FD8]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-6 shadow-sm">
                <div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-white/[0.04] border border-[#FF6FD8]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-10 shadow-sm">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#9490B4] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
        ...
        <div className="w-full flex justify-center py-6" style={{ background: '#0D0D14' }} aria-hidden="true">
          <svg className="holo-scroll-doodle opacity-0" viewBox="0 0 90 20" width="90" height="20" fill="none" stroke="rgba(255,111,216,0.6)" strokeWidth="1.2">
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#FF6FD8" surfaceColor="#16162C" />}
      </div>
  );
}
