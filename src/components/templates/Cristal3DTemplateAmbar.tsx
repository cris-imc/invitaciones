 ...
 * fondo azul-negro casi opaco (#0A0E16) + acentos celeste (#FFCB77) y
 * lavanda (#FF9AD5), tarjetas con tilt 3D ambiente continuo y capas con
...
const PhotoCornerFrame = () => (
  <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
    <div className="absolute inset-0" style={{ border: "1px solid rgba(255,203,119,0.6)" }} />
    <div className="absolute" style={{ inset: 5, border: "1px solid rgba(255,154,213,0.35)" }} />
    <div className="absolute" style={{ inset: 10, border: "1px solid rgba(240,246,255,0.18)" }} />
    <IconShard style={{ position: "absolute", bottom: -10, right: -6, width: 14, height: 22, color: "#FF9AD5" }} />
  </div>
);
...
interface Cristal3DTemplateAmbarProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#FFCB77]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#FFCB77] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#FFCB77] shrink-0" />
...
export function Cristal3DTemplateAmbar({ invitation, guest, isPersonalized = false }: Cristal3DTemplateAmbarProps) {
  ...
  const portadaTintColor1 = "#FFCB77";
  ...
  return (
    ...
    >
      <style>{`
        ...
        .crys-gradient-text {
          background: linear-gradient(120deg, #F0F6FF, #FFCB77, #FF9AD5, #F0F6FF);
        ...
        #countdown[data-style="clasico"].dark > div > div > div {
          ...
          border-color: rgba(255,203,119,0.3) !important;
        ...
        /* RSVP Custom Aesthetics for Cristal3DTemplateAmbar */
        #rsvp.section.dark {
          background-color: #0A0E16 !important;
          color: #FFFFFF !important;
        ...
        #rsvp.section.dark input {
          ...
          border: 1px solid rgba(255,203,119,0.2) !important;
        ...
        #songs.d-sec.dark .t-kicker {
          font-family: var(--font-body-custom, var(--font-inter)), sans-serif !important;
          color: #FFCB77 !important; /* Gold/Orange */
          font-size: 11px !important;
          font-weight: 600 !important;
          text-transform: uppercase !important;
          letter-spacing: 0.2em !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(255,203,119,0.13), transparent), radial-gradient(45% 40% at 85% 80%, rgba(255,154,213,0.2), transparent)',
            backgroundSize: '160% 160%',
            animation: 'crys-meshDrift 14s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', width: 220, height: 220, borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(255,203,119,0.13), transparent 70%)',
          ...
          <IconFacet className="crys-doodle opacity-0 absolute" style={{ width: 34, height: 34, top: '10%', left: '12%', color: 'rgba(255,203,119,0.5)' }} />
          <IconFacet className="crys-doodle opacity-0 absolute" style={{ width: 26, height: 26, top: '14%', right: '14%', color: 'rgba(255,154,213,0.4)' }} />
          <IconFacet className="crys-doodle opacity-0 absolute" style={{ width: 30, height: 30, bottom: '16%', left: '18%', color: 'rgba(255,203,119,0.35)' }} />
          <IconShard className="crys-doodle opacity-0 absolute" style={{ width: 22, height: 22, top: '30%', right: '20%', color: '#FF9AD5' }} />
          <IconShard className="crys-doodle opacity-0 absolute" style={{ width: 16, height: 16, bottom: '22%', right: '28%', color: '#FFCB77' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <button
              ...
              style={{
                fontFamily: 'var(--font-body-custom, var(--font-inter)), sans-serif', border: '1px solid #FFCB77', color: '#FFCB77',
                background: 'rgba(255,203,119,0.08)', backdropFilter: 'blur(6px)',
                marginTop: '1rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#FFCB77'; e.currentTarget.style.color = '#0A0E16'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(255,203,119,0.08)'; e.currentTarget.style.color = '#FFCB77'; }}
            >
              ABRIR INVITACIÓN
            </button>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#FFCB77]/40 shadow-md ${isTicketMaximized ? 'bg-[#0A0E16]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#FFCB77] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
                <span className="text-[#FFFFFF] font-bold text-sm leading-none" style={{ fontFamily: 'var(--font-cormorant), serif' }}>{guest.name}</span>
              </div>
              <div className="flex flex-col items-end border-l border-[#FFCB77]/20 pl-3">
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              <Ticket className="w-4 h-4 text-[#FFCB77]" />
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#FFCB77', margin: '6px 0 14px', animation: 'crys-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0A0E16]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#0A0E16] z-10 relative">
            <IconFacet className="crys-scroll-doodle opacity-0 absolute" style={{ width: 24, height: 24, top: 10, right: 24, color: '#FF9AD5' }} />
            <IconShard className="crys-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 60, right: 56, color: '#FFCB77' }} />
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#FFCB77] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            ...
            <div style={{ width: 40, height: 2, background: '#FFCB77', margin: '0 0 20px', animation: 'crys-lineExpand 1.2s ease-out' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#FFCB77] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(115deg, transparent 44%, rgba(255,203,119,0.45) 48%, rgba(255,255,255,0.5) 50%, rgba(255,154,213,0.45) 52%, transparent 56%)',
                opacity: 0,
              }}
            />
          </div>
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#0A0E16]" aria-hidden="true">
          <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(255,203,119,0.4)' }} />
          <div style={{ width: 48, height: 1, background: 'linear-gradient(90deg, transparent, #FF9AD5, transparent)' }} />
          <IconShard className="crys-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#FF9AD5' }} />
          <div style={{ width: 48, height: 1, background: 'linear-gradient(90deg, transparent, #FF9AD5, transparent)' }} />
          <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(255,203,119,0.4)' }} />
        </div>
        ...
        {(Boolean(invitation.frasePersonalizadaHabilitada) && Boolean(invitation.frasePersonalizadaTexto)) ? (
          <SectionWrapper id="quote" delay={100} className="w-full py-24 px-6 md:px-12 flex items-center justify-center" style={{ background: "linear-gradient(160deg, #FF9AD514, transparent 70%), #101826" }}>
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#0A0E16] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#FFCB77]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="crys-tilt-card bg-white/[0.04] border border-[#FFCB77]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-6" style={{ boxShadow: '0 10px 30px rgba(10,14,22,0.45), 0 2px 0 rgba(255,203,119,0.06)' }}>
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#FFCB77] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="crys-tilt-card bg-white/[0.04] border border-[#FFCB77]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-10" style={{ boxShadow: '0 10px 30px rgba(10,14,22,0.45), 0 2px 0 rgba(255,203,119,0.06)', animationDelay: '1.4s' }}>
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#93A4B8] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  FIESTA / SALÓN
                </span>
                {lugarNombre && (
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#FFCB77] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16">
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#FFCB77]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
                  CRONOGRAMA
                </p>
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex flex-col sm:flex-row sm:items-center py-4 border-b border-[#FFCB77]/10 last:border-b-0">
                      {item.time && (
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#0D141F] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#FFCB77]">
                  <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
        ...
        {triviaHabilitada && triviaPreguntas.length > 0 && (
          <SectionWrapper id="quiz" delay={300} className="w-full py-20 px-6 md:px-12" style={{ background: "linear-gradient(160deg, #FF9AD518, transparent 70%), #0D141F" }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0A0E16' }} aria-hidden="true">
            <IconMusic className="crys-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#FFCB77' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
        ...
        <div className="w-full flex justify-center gap-3 py-6" style={{ background: '#0A0E16' }} aria-hidden="true">
          <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 14, height: 15, color: 'rgba(255,203,119,0.5)' }} />
          <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 18, height: 19, color: 'rgba(255,154,213,0.5)' }} />
          <IconFacet className="crys-scroll-doodle opacity-0" style={{ width: 14, height: 15, color: 'rgba(255,203,119,0.5)' }} />
        </div>
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#FFCB77" surfaceColor="#121A28" />}
      </div>
  );
}
