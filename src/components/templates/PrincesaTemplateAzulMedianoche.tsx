  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="prc-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="prc-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #131D33 0%, #080B14 52%, #0F1B2E 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="prc-section" style={{ background: "#16294A" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="prc-section" style={{ background: "#16294A" }}>
