 ...
 * negro absoluto (#08080A) + acentos verde terminal (#C6FF3B) y magenta
...
const PhotoCornerFrame = () => (
  <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
    <div className="absolute inset-0" style={{ border: "1px solid rgba(198,255,59,0.55)" }} />
    <div className="absolute" style={{ top: -1, left: -1, width: 14, height: 14, borderTop: "2px solid #C6FF3B", borderLeft: "2px solid #C6FF3B" }} />
    <div className="absolute" style={{ top: -1, right: -1, width: 14, height: 14, borderTop: "2px solid #C6FF3B", borderRight: "2px solid #C6FF3B" }} />
    <div className="absolute" style={{ bottom: -1, left: -1, width: 14, height: 14, borderBottom: "2px solid #C6FF3B", borderLeft: "2px solid #C6FF3B" }} />
    <div className="absolute" style={{ bottom: -1, right: -1, width: 14, height: 14, borderBottom: "2px solid #C6FF3B", borderRight: "2px solid #C6FF3B" }} />
...
interface CircuitoTemplateLimaProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#C6FF3B]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#C6FF3B] uppercase tracking-wider mb-0.5">{label}</span>
          ...
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#C6FF3B] shrink-0" />
...
export function CircuitoTemplateLima({ invitation, guest, isPersonalized = false }: CircuitoTemplateLimaProps) {
  ...
  const portadaTintColor1 = "#C6FF3B";
    ...
    >
      <style>{`
        ...
        .circ-scanlines {
          ...
          background: repeating-linear-gradient(
            to bottom,
            rgba(198,255,59,0.025) 0px,
            rgba(198,255,59,0.025) 1px,
            transparent 1px,
            transparent 3px
          );
        ...
        .circ-scanlines::after {
          ...
          background: linear-gradient(to bottom, transparent, rgba(198,255,59,0.06), transparent);
        ...
        #countdown[data-style="clasico"].dark > div > div > div {
          background-color: rgba(198,255,59,0.05) !important;
          border-color: rgba(198,255,59,0.35) !important;
          box-shadow: inset 0 0 12px rgba(198,255,59,0.08) !important;
        }
        #countdown[data-style="clasico"].dark > div > div > div > *:first-child {
          text-shadow: 0 0 8px rgba(198,255,59,0.55);
        }

        /* RSVP Custom Aesthetics for CircuitoTemplateLima */
        #rsvp.section.dark {
          background-color: #08080A !important;
          color: #FFFFFF !important;
        ...
        #rsvp.section.dark input {
          ...
          border: 1px solid rgba(198,255,59,0.2) !important;
        ...
        #songs.d-sec.dark .t-kicker {
          font-family: var(--font-body-custom, var(--font-inter)), sans-serif !important;
          color: #C6FF3B !important; /* Gold/Orange */
          font-size: 11px !important;
          font-weight: 600 !important;
          text-transform: uppercase !important;
          letter-spacing: 0.2em !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(198,255,59,0.13), transparent), radial-gradient(45% 40% at 85% 80%, rgba(255,46,155,0.2), transparent)',
            backgroundSize: '160% 160%',
            animation: 'circ-meshDrift 14s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', width: 220, height: 220, borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(198,255,59,0.13), transparent 70%)',
          ...
          <IconHex className="circ-doodle opacity-0 absolute" style={{ width: 34, height: 34, top: '10%', left: '12%', color: 'rgba(198,255,59,0.5)' }} />
          <IconHex className="circ-doodle opacity-0 absolute" style={{ width: 26, height: 26, top: '14%', right: '14%', color: 'rgba(255,46,155,0.4)' }} />
          <IconHex className="circ-doodle opacity-0 absolute" style={{ width: 30, height: 30, bottom: '16%', left: '18%', color: 'rgba(198,255,59,0.35)' }} />
          <IconNode className="circ-doodle opacity-0 absolute" style={{ width: 22, height: 22, top: '30%', right: '20%', color: '#FF2E9B' }} />
          <IconNode className="circ-doodle opacity-0 absolute" style={{ width: 16, height: 16, bottom: '22%', right: '28%', color: '#C6FF3B' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="circ-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #C6FF3B',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#C6FF3B',
            }}>
              {monogram}
            </div>
            ...
            <button
              ...
              style={{
                fontFamily: 'var(--circ-mono), monospace', border: '1px solid #C6FF3B', color: '#C6FF3B',
                background: 'rgba(198,255,59,0.08)', backdropFilter: 'blur(6px)',
                marginTop: '1rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#C6FF3B'; e.currentTarget.style.color = '#08080A'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(198,255,59,0.08)'; e.currentTarget.style.color = '#C6FF3B'; }}
            >
              [ ABRIR_INVITACIÓN ]
            </button>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#C6FF3B]/40 shadow-md ${isTicketMaximized ? 'bg-[#08080A]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#C6FF3B] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
                <span className="text-[#FFFFFF] font-bold text-sm leading-none" style={{ fontFamily: 'var(--font-cormorant), serif' }}>{guest.name}</span>
              </div>
              <div className="flex flex-col items-end border-l border-[#C6FF3B]/20 pl-3">
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              <Ticket className="w-4 h-4 text-[#C6FF3B]" />
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#C6FF3B', margin: '6px 0 14px', animation: 'circ-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#08080A]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#08080A] z-10 relative">
            ...
            <IconNode className="circ-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 60, right: 56, color: '#C6FF3B' }} />
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#C6FF3B] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            <h1 className="text-[4rem] font-light text-[#E9FFF6] leading-[1.0] mb-3 circ-glitch-text" data-text={title} style={{ fontFamily: 'var(--font-title, var(--font-cormorant)), serif' }}>
              {em ? (
                <>
                  <span className="block">{title.slice(0, title.indexOf(em)).trim()}</span>
                  <span className="block"><em style={{ fontFamily: 'var(--font-cormorant), serif', fontStyle: 'italic', color: '#C6FF3B' }}>&amp;</em> {em.replace('& ', '').trim()}</span>
                </>
              ) : (
                <span className="block">{title}</span>
              )}
            </h1>
            <div style={{ width: 40, height: 2, background: '#C6FF3B', margin: '0 0 20px', animation: 'circ-lineExpand 1.2s ease-out' }} />
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#C6FF3B] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div
              ...
              style={{
                height: '18%',
                background: 'linear-gradient(to bottom, transparent, rgba(198,255,59,0.35) 45%, rgba(198,255,59,0.55) 50%, rgba(198,255,59,0.35) 55%, transparent)',
                opacity: 0,
              }}
            />
          </div>
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#08080A]" aria-hidden="true">
          <IconHex className="circ-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(198,255,59,0.4)' }} />
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#08080A] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#C6FF3B]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#C6FF3B] p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#C6FF3B] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#C6FF3B] p-6 sm:p-8 mb-10 shadow-sm">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#7C8C88] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  FIESTA / SALÓN
                </span>
                {lugarNombre && (
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#C6FF3B] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16">
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#C6FF3B]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  <IconHex className="circ-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
                  CRONOGRAMA
                </p>
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex flex-col sm:flex-row sm:items-center py-4 border-b border-[#C6FF3B]/10 last:border-b-0">
                      {item.time && (
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#0A0A0D] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#C6FF3B]">
                  <IconHex className="circ-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#08080A' }} aria-hidden="true">
            <IconMusic className="circ-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#C6FF3B' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
        ...
        <div className="w-full flex justify-center py-6" style={{ background: '#08080A' }} aria-hidden="true">
          <svg className="circ-scroll-doodle opacity-0" viewBox="0 0 90 12" width="90" height="12" fill="none" stroke="rgba(198,255,59,0.6)" strokeWidth="1.2">
            <path d="M2 6h24M64 6h24M32 6h8M46 6h8" />
            <circle cx="26" cy="6" r="2" fill="rgba(198,255,59,0.6)" stroke="none" />
            <circle cx="64" cy="6" r="2" fill="rgba(198,255,59,0.6)" stroke="none" />
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#C6FF3B" surfaceColor="#101014" />}
      </div>
  );
}
