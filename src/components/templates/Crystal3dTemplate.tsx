          ...
          <div className="c3d-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="8,11,16" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="8,11,16" />
              </div>
            )}
...
function C3dCoverHalf({
  ...
  return (
    <div className="c3d-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#7FD1E0" tintColor2="#080B10" effect="enfoque" scrimColorRgb="8,11,16" />
        </div>
      )}
