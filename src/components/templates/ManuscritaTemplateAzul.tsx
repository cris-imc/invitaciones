...
/**
 * ManuscritaTemplateAzul.tsx — Colección Paper · Papelería Viva · Familia 03 "Manuscrita"
 * Variante: Azul lavado (generada, no editar a mano).
 *
...
interface ManuscritaTemplateAzulProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function ManuscritaTemplateAzul({ invitation, guest, isPersonalized = false }: ManuscritaTemplateAzulProps) {
  const tx = useTextos();
