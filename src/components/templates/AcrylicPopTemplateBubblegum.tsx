      ...
      <div ref={scrollerRef} data-scroller="1" className="acp-scroller">
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="acp-section acp-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #161331 0%, #0D0E22 55%, #0B0E1C 100%)" }}>
          ...
          <div className="acp-cd-grid">
            ...
            <AcpCdBox refEl={sRef} delay={280} dist={170} label="SEG" numColor="#3DFFB8" />
          </div>
          <div className="acp-perf-strip" />
        </section>

        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="acp-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #181535 0%, #0C0D1E 52%, #0B0E1C 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="acp-section" style={{ background: "#0F1020" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="acp-section" style={{ background: "#0F1020" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="acp-section acp-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #131229 0%, #0F1020 55%, #0B0E1C 100%)" }}>
