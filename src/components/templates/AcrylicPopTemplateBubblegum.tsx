      ...
      <div ref={scrollerRef} data-scroller="1" className="acp-scroller">
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="acp-section" style={{ background: "#0F1020" }}>
            <span data-xin="1" data-dist="-60" className="acp-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6 + kOffset} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="acp-section acp-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #131229 0%, #0F1020 55%, #0B0E1C 100%)" }}>
          <span data-xin="1" data-dist="-60" className="acp-kicker">{[sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 6 + kOffset} — GUARDÁ TU PASE</span>
