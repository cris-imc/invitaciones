...
/**
 * TrazoTemplateTinta.tsx — Colección Paper · Papel Prensado · Familia 05 "Trazo"
 * Variante: Tinta (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Tinta, Terracota, Verde,
...
interface TrazoTemplateTintaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function TrazoTemplateTinta({ invitation, guest, isPersonalized = false }: TrazoTemplateTintaProps) {
  const tx = useTextos();
