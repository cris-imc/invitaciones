      ...
      <div ref={scrollerRef} data-scroller="1" className="jwb-scroller">
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="jwb-section" style={{ background: "#33303C" }}>
            <span data-xin="1" data-dist="-60" className="jwb-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 7} — EL JUEGO</span>
...
const JWB_CSS = `
  ...
  .jwb-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #4C4858 0%, #2A2732 60%, #201E26 100%); }
