          ...
          <div className="jwb-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="32,30,38" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="32,30,38" />
              </div>
            )}
...
function JwbCoverHalf({
  ...
  return (
    <div className="jwb-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#BDB4CC" tintColor2="#201E26" effect="enfoque" scrimColorRgb="32,30,38" />
        </div>
      )}
