  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="jwb-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="jwb-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1D1B22 0%, #101015 52%, #201E26 100%)" }}>
            ...
            <div data-strip="1" className="jwb-strip">
              ...
              <div data-tone="light" className="jwb-panel jwb-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                ...
                <div className="jwb-album-embed">
                  {livePhotos.length > 0 ? (
                    <LiveAlbumStrip photos={livePhotos} tone="light" accentColor="#D6D2DC" />
                  ) : (
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="jwb-section" style={{ background: "#33303C" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="jwb-section" style={{ background: "#33303C" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="jwb-section" style={{ background: "#33303C" }}>
            <span data-xin="1" data-dist="-60" className="jwb-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6 + kOffset} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu pieza" className="jwb-section jwb-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17161C 0%, #33303C 55%, #201E26 100%)" }}>
          <span data-xin="1" data-dist="-60" className="jwb-kicker">{[sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 6 + kOffset} — GUARDÁ TU PIEZA</span>
      ...
      <div ref={coverRef} className="jwb-cover">
    ...
    <div className="jwb-cover-inner">
      ...
      <div className="jwb-cover-content">
        <div className="jwb-cover-top-row">
          <span>PIEZA Nº {passNumber}</span><span className="jwb-accent-serif-2">ADMIT ONE</span>
        </div>
        ...
        <div className="jwb-cover-bottom">
          <div ref={perfRef} className="jwb-perf-strip jwb-perf-strip--reveal" />
          ...
          <div className="jwb-barcode-wrap">
            <div className="jwb-barcode" style={{ width: "62%" }} />
            <span className="jwb-mini-label" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
...
const JWB_CSS = `
  ...
  .jwb-pan { height: 260vh; position: relative; }
  ...
  .jwb-cover-names { margin: 0; font-family: var(--jwb-cormorant), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #F1EFF4; }
