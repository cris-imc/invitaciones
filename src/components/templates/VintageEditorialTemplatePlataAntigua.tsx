  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="vte-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="vte-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #191B20 0%, #0E0F11 52%, #101113 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="vte-section" style={{ background: "#181A1E" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="vte-section" style={{ background: "#181A1E" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu edición" className="vte-section vte-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #161A1F 0%, #181A1E 55%, #101113 100%)" }}>
