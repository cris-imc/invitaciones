...
const ENC_CSS = `
  ...
  .enc-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #172016 0%, #0D120D 46%, #0A0D0A 100%); }
  .enc-cover-half--bottom .enc-cover-inner { top: auto; bottom: 0; }
  .enc-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(28,26,24,0.5), rgba(140,133,119,0.3), rgba(63,138,85,0.55), rgba(28,26,24,0.5)); filter: blur(64px); opacity: .62; animation: encFoil 26s linear infinite; }
  ...
  .enc-cover-cta { border: 1px solid #3F8A55; background: linear-gradient(100deg, rgba(150,196,160,0.08), rgba(205,228,210,0.2), rgba(150,196,160,0.08)); color: #F6EFDD; font-family: var(--enc-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  .enc-cover-cta--btn { cursor: pointer; border-radius: 0; }
  .enc-cover-cta--btn:hover { background: linear-gradient(100deg, rgba(205,228,210,0.34), rgba(246,239,221,0.5), rgba(205,228,210,0.34)); color: #0B0B0F; }
