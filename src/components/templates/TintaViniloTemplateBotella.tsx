...
/**
 * TintaViniloTemplateBotella.tsx — Colección Paper · Papelería Viva · Familia 04 "Tinta & Vinilo"
 * Variante: Verde botella (generada, no editar a mano).
 *
...
interface TintaViniloTemplateBotellaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function TintaViniloTemplateBotella({ invitation, guest, isPersonalized = false }: TintaViniloTemplateBotellaProps) {
  const tx = useTextos();
