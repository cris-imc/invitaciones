          ...
          <div className="c3d-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="18,10,16" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="18,10,16" />
              </div>
            )}
...
function C3dCoverHalf({
  ...
  return (
    <div className="c3d-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#E8A9C4" tintColor2="#080B10" effect="enfoque" scrimColorRgb="18,10,16" />
        </div>
      )}
