    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="ing-scroller">
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="ing-section" style={{ background: "#0F2B20" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="ing-section" style={{ background: "#0F2B20" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu pase" className="ing-section ing-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #0F2B20 55%, #080808 100%)" }}>
          ...
          <div data-xin="1" data-delay="100" data-dist="130" className="ing-final-card">
            <div className="ing-medallion ing-medallion--final">
              <IngMedallionCmp label="GA" sub={confirmed ? "CONFIRMADO" : "PENDIENTE"} arcId="bbsArc3" arcText={`${namesTitle.toUpperCase()} · ${fechaCorta} · `} spin="reverse" />
            </div>
      ...
      <div ref={coverRef} className="ing-cover">
        ...
        {hasPayment && paymentAmount != null && !isExempt && (
          ...
          <div className="ing-rsvp-row ing-rsvp-row--payment">
            ...
            <div className="ing-rsvp-payment-value">
              <span className="ing-rsvp-payment-total">
                {formatARS(isPartialPayment ? paymentBalance : totalPayment)}
              </span>
              {isPaidInFull && (
                <div className="ing-rsvp-payment-detail"><span>Pago registrado ✓</span></div>
              )}
              {isPartialPayment && (
...
const GP_CSS = `
  ...
  .ing-cover-names { margin: 0; font-family: var(--ing-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #E7F5EF; }
