          ...
          <div className="bte-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="13,10,18" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="13,10,18" />
              </div>
            )}
...
function BteCoverHalf({
  ...
  return (
    <div className="bte-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#6E5A8A" tintColor2="#0D0A12" effect="enfoque" scrimColorRgb="13,10,18" />
        </div>
      )}
