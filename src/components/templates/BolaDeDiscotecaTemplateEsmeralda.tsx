          ...
          <div className="bdd-hero-photo-frame">
            {heroPhotoMobile && (
              <div className="acp-mobile-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoMobile} tint={false} effect="enfoque" scrimColorRgb="7,15,12" />
              </div>
            )}
            {heroPhotoDesktop && (
              <div className="acp-desktop-only">
                <AnimatedCoverPhoto photoSrc={heroPhotoDesktop} tint={false} effect="enfoque" scrimColorRgb="7,15,12" />
              </div>
            )}
...
function BddCoverHalf({
  ...
  return (
    <div className="bdd-cover-inner">
      {photoSrc && (
        <div className="acp-mobile-only">
          <AnimatedCoverPhoto photoSrc={photoSrc} tint tintColor1="#00E58A" tintColor2="#08080E" effect="enfoque" scrimColorRgb="7,15,12" />
        </div>
      )}
