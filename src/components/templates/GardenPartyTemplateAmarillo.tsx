    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="gardenparty-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #E8A33D',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#E8A33D',
            }}>
              {monogram}
            </div>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#FBF4EC]" aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #E8A33D, transparent)' }} />
          <IconGarland className="gardenparty-scroll-doodle opacity-0" style={{ width: 30, height: 13, color: '#E8A33D' }} />
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #E8A33D, transparent)' }} />
        </div>
        ...
        {(Boolean(invitation.frasePersonalizadaHabilitada) && Boolean(invitation.frasePersonalizadaTexto)) ? (
          <SectionWrapper id="quote" delay={100} className="w-full py-24 px-6 md:px-12 flex items-center justify-center" style={{ background: "linear-gradient(160deg, #6B8F7114, transparent 70%), #FFFFFF" }}>
          ...
          <SectionWrapper id="album" delay={200} className="w-full bg-[#FFFFFF] py-20 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-10 flex items-center gap-2">
                <IconFlower className="gardenparty-scroll-doodle opacity-0" style={{ width: 16, height: 16, color: '#E8A33D' }} />
                ÁLBUM
              </p>
            </div>
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#FBF4EC' }} aria-hidden="true">
            <IconMusic className="gardenparty-scroll-doodle opacity-0" style={{ width: 26, height: 26, color: '#E8A33D' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
