    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="flb-scroller">
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="flb-section flb-section--between">
          ...
          <span data-xin="1" data-dist="-60" className="flb-kicker" style={{ position: "relative" }}>02 — LA CAMPAÑA SALE EN</span>
        ...
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="flb-section">
          ...
          <span data-xin="1" data-dist="-60" className="flb-kicker" style={{ position: "relative" }}>03 — CUANDO LLEGUE A CERO</span>
            ...
            <div data-strip="1" className="flb-strip">
              ...
              <div data-tone="dark" className="flb-panel flb-panel--center" style={{ background: "#110B12", color: "#F4F1EA" }}>
                <div className="flb-medallion flb-medallion--lg">
                  <FlbMedallion kicker="SECTOR" main="Pasarela" sub="LOOK 04" subColor="#D93A93" arcId="flbArc2" arcText={`ACCESO VIP · LOOK Nº ${passNumber} · `} spin="reverse" />
                </div>
        ...
        <section data-tone="dark" data-screen-label="Check-in" className="flb-section">
          <span data-xin="1" data-dist="-60" className="flb-kicker">05 — CHECK-IN</span>
            ...
            <div data-strip="1" className="flb-strip">
              ...
              <div data-tone="light" className="flb-panel flb-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                ...
                <div className="flb-album-embed">
                  {livePhotos.length > 0 ? (
                    <LiveAlbumStrip photos={livePhotos} tone="light" accentColor="#D93A93" />
                  ) : (
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="flb-section" style={{ background: "#110B12" }}>
            <span data-xin="1" data-dist="-60" className="flb-kicker">07 — SUGERENCIA DE MÚSICA</span>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="flb-section" style={{ background: "#110B12" }}>
            <span data-xin="1" data-dist="-60" className="flb-kicker">{sugerenciaMusicaHabilitada ? "08" : "07"} — REGALOS Y PAGOS</span>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="flb-section" style={{ background: "#110B12" }}>
            <span data-xin="1" data-dist="-60" className="flb-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 7} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu look" className="flb-section flb-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))" }}>
          <span data-xin="1" data-dist="-60" className="flb-kicker">{[sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 7} — GUARDÁ TU LOOK</span>
...
const FLB_CSS = `
  ...
  .flb-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #221019 0%, #110B12 46%, #0A0709 100%); }
  .flb-cover-half--bottom .flb-cover-inner { top: auto; bottom: 0; }
  .flb-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(217,58,147,0.35), rgba(17,11,18,0.5), rgba(217,58,147,0.5), rgba(217,58,147,0.35)); filter: blur(64px); opacity: .62; animation: gpFoil 26s linear infinite; }
  ...
  .flb-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#D93A93, transparent); display: block; }
  ...
  .flb-cover-cta { border: 1px solid #D93A93; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--flb-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
