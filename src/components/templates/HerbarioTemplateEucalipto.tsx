...
/**
 * HerbarioTemplateEucalipto.tsx — Colección Paper · Papel Prensado · Familia 04 "Herbario"
 * Variante: Eucalipto (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Eucalipto, Oliva, Ceniza,
 ...
 */
const ACENTO = "#7C8B7A";
const FILTRO = "grayscale(1) sepia(1) hue-rotate(58deg) saturate(.55) brightness(1.02)";
...
interface HerbarioTemplateEucaliptoProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function HerbarioTemplateEucalipto({ invitation, guest, isPersonalized = false }: HerbarioTemplateEucaliptoProps) {
  const tx = useTextos();
