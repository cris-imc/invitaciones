...
interface BabyShowerTemplateCelesteProps {
...
export function BabyShowerTemplateCeleste({ invitation, guest, isPersonalized = false }: BabyShowerTemplateCelesteProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      if (statusRef.current) {
        ...
        statusRef.current.style.color = "#EEF5FB";
      }
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#8AAED0";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #8AAED0";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#4E7290" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#4E7290" : "#8AAED0";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#14101A", tinta: "#F4F1EA", acento: "#8AAED0", clase: `${bbsDisplay.variable} ${bbsMono.variable}`, fuente: "var(--bbs-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="bbs-panel bbs-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="bbs-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#4E7290" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#4E7290" />
                  </svg>
            ...
            <div data-strip="1" className="bbs-strip">
              ...
              <div data-tone="light" className="bbs-panel bbs-panel--gap" style={{ background: "#EDE8DE", color: "#14141B" }}>
                ...
                <div className="bbs-album-embed">
                  {livePhotos.length > 0 ? (
                    <LiveAlbumStrip photos={livePhotos} tone="light" accentColor="#4E7290" />
                  ) : (
          ...
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="bbs-section" style={{ background: "#191420" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="bbs-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="bbs-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#EEF5FB" : "#8AAED0" }} />
              ))}
            </div>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#8AAED0" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #8AAED0; text-decoration: none; }
  a:hover { color: #EEF5FB; }
  ...
  .bbs-date-month { font-family: var(--bbs-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #8AAED0; padding-left: 12%; }

  .bbs-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .bbs-divider-line { width: 52px; height: 1px; background: #8AAED0; display: inline-block; }
  ...
  .bbs-cal-link:hover { color: #8AAED0; }
  ...
  .bbs-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #8AAED0, #EEF5FB, #6E5AA8); filter: saturate(.75); }
  ...
  .bbs-medallion-label { font-family: var(--bbs-display), serif; font-size: 26px; line-height: 1; color: #EEF5FB; }
  .bbs-medallion-label-sm { font-family: var(--bbs-display), serif; font-size: 16px; color: #EEF5FB; }
  .bbs-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .bbs-medallion-sub--accent { color: #8AAED0; }
  ...
  .bbs-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #8AAED0; opacity: 0.4; font-family: var(--bbs-mono), monospace; }
  ...
  .bbs-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #EEF5FB, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .bbs-cd-num { font-family: var(--bbs-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #EEF5FB; display: inline-block; }
  ...
  .bbs-accent-italic { font-style: italic; color: #8AAED0; }
  .bbs-accent-serif { font-style: italic; color: #4E7290; font-family: var(--bbs-display), serif; }
  .bbs-accent-serif-2 { color: #4E7290; }
  ...
  .bbs-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #4E7290; margin-top: auto; }
  ...
  .bbs-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #4E7290; }
  ...
  .bbs-crono-time { font-family: var(--bbs-mono), monospace; color: #4E7290; min-width: 42px; }
  ...
  .bbs-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #EEF5FB, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .bbs-rsvp-payment-total { color: #EEF5FB; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .bbs-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #8AAED0; background: transparent; color: #8AAED0; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .bbs-rsvp-input:focus { outline: none; border-bottom-color: #8AAED0; }
  .bbs-rsvp-btn { width: 100%; padding: 16px; font-family: var(--bbs-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #8AAED0, #4E7290); border: 1px solid #8AAED0; color: #191420; cursor: pointer; }
  .bbs-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .bbs-rsvp-btn--ghost { background: transparent; color: #8AAED0; }
  .bbs-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #8AAED0; margin: 0; }
  ...
  .bbs-bank-copy { flex-shrink: 0; font-family: var(--bbs-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #8AAED0; background: transparent; color: #8AAED0; cursor: pointer; }
  ...
  .bbs-song-input:focus { outline: none; border-bottom-color: #8AAED0; }
  .bbs-song-sep { color: #8A8577; flex-shrink: 0; }
  .bbs-song-submit { flex-shrink: 0; background: none; border: none; color: #8AAED0; font-family: var(--bbs-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .bbs-song-submit:hover { color: #EEF5FB; }
  .bbs-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .bbs-song-error { font-size: 10px; color: #8AAED0; margin-top: 6px; }
  ...
  .bbs-quiz-opt { font-family: var(--bbs-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #8AAED0; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .bbs-quiz-opt:disabled { cursor: default; }
  .bbs-quiz-opt--picked { background: #8AAED0; border-color: #8AAED0; color: #191420; }
  .bbs-quiz-opt--correct { background: #8AAED0; border-color: #8AAED0; color: #191420; }
  ...
  .bbs-quiz-result-score { margin: 0 0 6px; font-family: var(--bbs-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #EEF5FB; }
  .bbs-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .bbs-final-card { border: 1px solid #8AAED0; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .bbs-final-names { font-family: var(--bbs-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #EEF5FB; }
  ...
  .bbs-replay { cursor: pointer; color: #8AAED0; }
  ...
  .bbs-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#EEF5FB, #8AAED0); transition: height 260ms linear; display: block; }
  .bbs-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #8AAED0; transition: color 500ms ease; }
  ...
  .bbs-cover-names { margin: 0; font-family: var(--bbs-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #EEF5FB; }
  .bbs-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#8AAED0, transparent); display: block; }
  ...
  .bbs-cover-cta { border: 1px solid #8AAED0; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--bbs-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .bbs-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #8AAED0; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
