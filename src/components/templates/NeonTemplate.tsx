 ...
 * (#0D0D10) + acentos neón cian (#39FFD0) y magenta (#FF2E9B), tipografía
...
export function NeonTemplate({ invitation, guest, isPersonalized = false }: NeonTemplateProps) {
  const tx = useTextos();
    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <button
              ...
              style={{
                fontFamily: 'var(--font-body-custom, var(--font-inter)), sans-serif', border: '1px solid #39FFD0', color: '#39FFD0',
                background: 'rgba(57,255,208,0.08)', backdropFilter: 'blur(6px)',
                marginTop: '1rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#39FFD0'; e.currentTarget.style.color = '#0D0D10'; }}
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#39FFD0]/40 shadow-md ${isTicketMaximized ? 'bg-[#0D0D10]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#39FFD0', margin: '6px 0 14px', animation: 'neon-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0D0D10]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#0D0D10] z-10 relative">
            ...
            <IconSpark className="neon-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 60, right: 56, color: '#39FFD0' }} />
            ...
            <div style={{ width: 40, height: 2, background: '#39FFD0', margin: '0 0 20px', animation: 'neon-lineExpand 1.2s ease-out' }} />
      ...
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#39FFD0" surfaceColor="#141418" />}
      </div>
  );
}
