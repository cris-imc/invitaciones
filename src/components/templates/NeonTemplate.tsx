    ...
    >
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#0D0D10]" aria-hidden="true">
          <IconDiscoBall className="neon-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(57,255,208,0.4)' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0D0D10' }} aria-hidden="true">
            <IconMusic className="neon-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#39FFD0' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
