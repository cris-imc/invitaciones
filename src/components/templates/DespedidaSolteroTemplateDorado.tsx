...
/**
 * DespedidaSolteroTemplateDorado.tsx
 *
...
interface DespedidaSolteroTemplateDoradoProps {
...
export function DespedidaSolteroTemplateDorado({ invitation, guest, isPersonalized = false }: DespedidaSolteroTemplateDoradoProps) {
  const tx = useTextos();
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#08090B", tinta: "#F4F1EA", acento: "#C8A45C", clase: `${dpoDisplay.variable} ${dpoMono.variable}`, fuente: "var(--dpo-mono), monospace" }}
      />
    );
  }
          ...
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="dpo-section" style={{ background: "#0B0D10" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="dpo-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="dpo-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F6EFDD" : "#C8A45C" }} />
              ))}
            </div>
...
const GP_CSS = `
  ...
  .dpo-date-month { font-family: var(--dpo-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #C8A45C; padding-left: 12%; }

  .dpo-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .dpo-divider-line { width: 52px; height: 1px; background: #C8A45C; display: inline-block; }
  ...
  .dpo-cal-link:hover { color: #C8A45C; }
  ...
  .dpo-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #C8A45C, #F6EFDD, #6E5AA8); filter: saturate(.75); }
  ...
  .dpo-medallion-label { font-family: var(--dpo-display), serif; font-size: 26px; line-height: 1; color: #F6EFDD; }
  .dpo-medallion-label-sm { font-family: var(--dpo-display), serif; font-size: 16px; color: #F6EFDD; }
  .dpo-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .dpo-medallion-sub--accent { color: #C8A45C; }
  ...
  .dpo-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #C8A45C; opacity: 0.4; font-family: var(--dpo-mono), monospace; }
  ...
  .dpo-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #F6EFDD, transparent); animation: dpoScan 6s linear infinite; pointer-events: none; }
  ...
  .dpo-cd-num { font-family: var(--dpo-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F6EFDD; display: inline-block; }
  .dpo-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #C8A45C; }
  ...
  .dpo-accent-italic { font-style: italic; color: #C8A45C; }
  .dpo-accent-serif { font-style: italic; color: #8C6F35; font-family: var(--dpo-display), serif; }
  .dpo-accent-serif-2 { color: #8C6F35; }
  ...
  .dpo-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #8C6F35; margin-top: auto; }
  ...
  .dpo-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #8C6F35; }
  ...
  .dpo-crono-time { font-family: var(--dpo-mono), monospace; color: #8C6F35; min-width: 42px; }
  ...
  .dpo-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #F6EFDD, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .dpo-rsvp-payment-total { color: #F6EFDD; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .dpo-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #C8A45C; background: transparent; color: #C8A45C; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .dpo-rsvp-input:focus { outline: none; border-bottom-color: #C8A45C; }
  .dpo-rsvp-btn { width: 100%; padding: 16px; font-family: var(--dpo-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #C8A45C, #8C6F35); border: 1px solid #C8A45C; color: #0B0D10; cursor: pointer; }
  .dpo-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .dpo-rsvp-btn--ghost { background: transparent; color: #C8A45C; }
  .dpo-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #C8A45C; margin: 0; }
  ...
  .dpo-bank-copy { flex-shrink: 0; font-family: var(--dpo-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #C8A45C; background: transparent; color: #C8A45C; cursor: pointer; }
  ...
  .dpo-song-input:focus { outline: none; border-bottom-color: #C8A45C; }
  .dpo-song-sep { color: #8A8577; flex-shrink: 0; }
  .dpo-song-submit { flex-shrink: 0; background: none; border: none; color: #C8A45C; font-family: var(--dpo-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .dpo-song-submit:hover { color: #F6EFDD; }
  .dpo-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .dpo-song-error { font-size: 10px; color: #C8A45C; margin-top: 6px; }
  ...
  .dpo-quiz-opt { font-family: var(--dpo-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #C8A45C; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .dpo-quiz-opt:disabled { cursor: default; }
  .dpo-quiz-opt--picked { background: #C8A45C; border-color: #C8A45C; color: #0B0D10; }
  .dpo-quiz-opt--correct { background: #C8A45C; border-color: #C8A45C; color: #0B0D10; }
  ...
  .dpo-quiz-result-score { margin: 0 0 6px; font-family: var(--dpo-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #F6EFDD; }
  .dpo-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .dpo-final-card { border: 1px solid #C8A45C; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .dpo-final-names { font-family: var(--dpo-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #F6EFDD; }
  ...
  .dpo-replay { cursor: pointer; color: #C8A45C; }
  ...
  .dpo-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F6EFDD, #C8A45C); transition: height 260ms linear; display: block; }
  .dpo-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #C8A45C; transition: color 500ms ease; }
  ...
  .dpo-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(36,36,36,0.5), rgba(200,164,92,0.32), rgba(200,164,92,0.55), rgba(36,36,36,0.5)); filter: blur(64px); opacity: .62; animation: dpoFoil 26s linear infinite; }
  .dpo-cover-texture { position: absolute; inset: 0; background-image: repeating-linear-gradient(0deg, rgba(246,239,221,.05) 0 1px, transparent 1px 22px), repeating-linear-gradient(90deg, rgba(246,239,221,.05) 0 1px, transparent 1px 22px); }
  ...
  .dpo-cover-names { margin: 0; font-family: var(--dpo-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #F6EFDD; }
  .dpo-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#C8A45C, transparent); display: block; }
  ...
  .dpo-cover-cta { border: 1px solid #C8A45C; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--dpo-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .dpo-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #C8A45C; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
