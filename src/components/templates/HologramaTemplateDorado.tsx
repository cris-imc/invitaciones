 ...
 * Aitana): fondo casi negro violáceo (#0D0D14) + acentos violeta (#F5C452)
 * y cian (#A78BFA), glassmorphism iridiscente (bordes con degradé, cards
...
const PhotoCornerFrame = () => (
  <div className="absolute inset-3 pointer-events-none z-20" aria-hidden="true">
    <div
      ...
      style={{
        padding: 1,
        background: "linear-gradient(115deg, rgba(245,196,82,0.75), rgba(167,139,250,0.65), rgba(245,196,82,0.75))",
    ...
    />
    <IconParticle style={{ position: "absolute", bottom: -9, right: -9, width: 16, height: 16, color: "#A78BFA" }} />
  </div>
);
...
interface HologramaTemplateDoradoProps {
...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3 border-b border-[#F5C452]/20 last:border-b-0">
      <div className="min-w-0 flex-1">
        <span className="block text-[10px] font-semibold text-[#F5C452] uppercase tracking-wider mb-0.5">{label}</span>
  ...
  if (finished) {
    ...
    return (
      <div className="quiz-box text-center flex flex-col items-center">
        ...
        <p style={{ marginTop: "12px", opacity: 0.8, fontFamily: "var(--font-sans)", textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "0.8rem", color: "#F1EEFF" }}>
          RESPONDISTE {score} DE {preguntas.length} CORRECTAMENTE ({percent}%)
        </p>
        
        {isSaving ? (
          <p style={{ marginTop: "16px", fontSize: "14px", opacity: 0.7, color: "#9490B4" }}>Guardando tus resultados...</p>
        ) : (
          stats && stats.count > 0 && (
            <div style={{ marginTop: "28px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", padding: "8px 16px", borderRadius: "99px", border: "1px solid rgba(255,255,255,0.1)", textAlign: "left", maxWidth: "90%" }}>
                <Users className="w-5 h-5 text-[#F5C452] shrink-0" />
                <p style={{ fontSize: "11.5px", margin: 0, opacity: 0.85, lineHeight: 1.4, color: "#F1EEFF" }}>
  ...
  return (
    <div className="quiz-box flex flex-col items-center text-center">
      <div className="quiz-q w-full max-w-lg" key={currentIdx}>
        <p className="text-[#F1EEFF] text-2xl md:text-3xl leading-relaxed tracking-wide" style={{ fontFamily: 'var(--font-cormorant), serif', fontStyle: 'italic', margin: 0, fontWeight: 500, marginBottom: "3.5rem" }}>
...
export function HologramaTemplateDorado({ invitation, guest, isPersonalized = false }: HologramaTemplateDoradoProps) {
  ...
  const portadaTintColor1 = "#F5C452";
  ...
  return (
    ...
    >
      <style>{`
        ...
        .holo-gradient-text {
          background: linear-gradient(120deg, #F1EEFF, #F5C452, #A78BFA, #F1EEFF);
        ...
        #countdown[data-style="clasico"].dark > div > div > div {
          ...
          border-color: rgba(245,196,82,0.3) !important;
          backdrop-filter: blur(6px);
          -webkit-backdrop-filter: blur(6px);
        }

        /* RSVP Custom Aesthetics for HologramaTemplateDorado */
        #rsvp.section.dark {
          background-color: #0D0D14 !important;
          color: #FFFFFF !important;
        ...
        #rsvp.section.dark input {
          ...
          border: 1px solid rgba(245,196,82,0.2) !important;
        ...
        #rsvp.section.dark .t-btn {
          ...
          background-color: #F5C452 !important;
          color: #0D0D14 !important;
          font-weight: 600 !important;
          border: none !important;
          text-transform: uppercase !important;
        ...
        #songs.d-sec.dark .t-kicker {
          font-family: var(--font-body-custom, var(--font-inter)), sans-serif !important;
          color: #F5C452 !important; /* Gold/Orange */
          font-size: 11px !important;
          font-weight: 600 !important;
          text-transform: uppercase !important;
          letter-spacing: 0.2em !important;
        ...
        .desktop-stage .d-foot {
          background-color: #0D0D14 !important; /* Matches light sections */
          color: #FFFFFF !important;
      ...
      {!isCoverOpen && (
        ...
        >
          ...
          <div style={{
            ...
            background: 'radial-gradient(50% 40% at 15% 15%, rgba(245,196,82,0.13), transparent), radial-gradient(45% 40% at 85% 80%, rgba(167,139,250,0.2), transparent)',
            backgroundSize: '160% 160%',
            animation: 'holo-meshDrift 14s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', width: 220, height: 220, borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(245,196,82,0.13), transparent 70%)',
          ...
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 34, height: 34, top: '10%', left: '12%', color: 'rgba(245,196,82,0.5)' }} />
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 26, height: 26, top: '14%', right: '14%', color: 'rgba(167,139,250,0.4)' }} />
          <IconOrb className="holo-doodle opacity-0 absolute" style={{ width: 30, height: 30, bottom: '16%', left: '18%', color: 'rgba(245,196,82,0.35)' }} />
          <IconParticle className="holo-doodle opacity-0 absolute" style={{ width: 22, height: 22, top: '30%', right: '20%', color: '#A78BFA' }} />
          <IconParticle className="holo-doodle opacity-0 absolute" style={{ width: 16, height: 16, bottom: '22%', right: '28%', color: '#F5C452' }} />
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="holo-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #F5C452',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#F5C452',
            }}>
              {monogram}
            </div>
            ...
            {Boolean(activeDressCode) && (
              <p className=" text-sm font-medium text-[#9490B4] tracking-wide uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter)), sans-serif", letterSpacing: "0.2em", opacity: 0.8 }}>
            ...
            <button
              ...
              style={{
                ...
                background: 'linear-gradient(90deg, #F5C452, #A78BFA)',
                boxShadow: '0 8px 24px rgba(245,196,82,0.35)',
                marginTop: '1rem',
              }}
            >
              ABRIR INVITACIÓN
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#F5C452]/40 shadow-md ${isTicketMaximized ? 'bg-[#0D0D14]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#FFFFFF]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#F5C452] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
                <span className="text-[#FFFFFF] font-bold text-sm leading-none" style={{ fontFamily: 'var(--font-cormorant), serif' }}>{guest.name}</span>
              </div>
              <div className="flex flex-col items-end border-l border-[#F5C452]/20 pl-3">
                <span className="text-[#FFFFFF] font-bold text-sm leading-none">{guest.expectedCount}</span>
                <span className="text-[#9490B4] text-[8px] uppercase tracking-wider leading-none mt-1">{guest.expectedCount === 1 ? 'Lugar' : 'Lugares'}</span>
              </div>
            </div>
          ) : (
            <div className="flex items-center gap-2 animate-in fade-in duration-300">
              <Ticket className="w-4 h-4 text-[#F5C452]" />
              <span className="text-[#17172E]  text-[10px] font-semibold tracking-wider uppercase" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase</span>
            </div>
          )}
        </div>,
        document.body
      ...
      <aside className="d-left hide-mobile">
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#F5C452', margin: '6px 0 14px', animation: 'holo-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#0D0D14]">
          {/* Text Container */}
          <div className="px-8 pt-16 pb-12 text-left bg-[#0D0D14] z-10 relative">
            <IconOrb className="holo-scroll-doodle opacity-0 absolute" style={{ width: 24, height: 24, top: 10, right: 24, color: '#A78BFA' }} />
            <IconParticle className="holo-scroll-doodle opacity-0 absolute" style={{ width: 16, height: 16, top: 60, right: 56, color: '#F5C452' }} />
            <p className=" text-xs font-semibold uppercase tracking-[0.2em] text-[#F5C452] mb-6" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {eyebrow}
            </p>
            ...
            <div style={{ width: 40, height: 2, background: '#F5C452', margin: '0 0 20px', animation: 'holo-lineExpand 1.2s ease-out' }} />
            <p className=" text-sm font-medium text-[#9490B4] tracking-wide" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
              {fechaStr}{lugarNombre ? ` · ${lugarNombre}` : ""}{ciudad ? ` — ${ciudad}` : ""}
            </p>
            {Boolean(activeDressCode) && (
              <p className=" text-xs font-semibold text-[#F5C452] tracking-widest uppercase mt-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                Dress code: {activeDressCode}
              </p>
            )}
          </div>
          ...
          <div ref={heroPhotoRef} className="flex-1 w-full relative overflow-hidden">
            ...
            <div ref={orbBackRef} className="absolute pointer-events-none z-0" style={{ top: '8%', left: '-10%', width: 160, height: 160, borderRadius: '50%', background: 'radial-gradient(circle, rgba(245,196,82,0.35), transparent 70%)', filter: 'blur(4px)' }} aria-hidden="true" />
            <div ref={orbFrontRef} className="absolute pointer-events-none z-30" style={{ bottom: '10%', right: '-8%', width: 120, height: 120, borderRadius: '50%', background: 'radial-gradient(circle, rgba(167,139,250,0.4), transparent 70%)', filter: 'blur(3px)' }} aria-hidden="true" />
            <div className="absolute inset-x-0 bottom-0 h-1/2 pointer-events-none z-10" style={{ background: 'linear-gradient(to bottom, transparent 0%, #0D0D14 100%)' }} />
            <div
            ...
            <div
              ...
              style={{
                background: 'radial-gradient(ellipse 55% 42% at 50% 50%, rgba(245,196,82,0.32), rgba(167,139,250,0.22) 45%, transparent 72%)',
                filter: 'blur(16px)',
                opacity: 0,
              }}
            />
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#0D0D14]" aria-hidden="true">
          <IconPrism className="holo-scroll-doodle opacity-0" style={{ width: 24, height: 20, color: 'rgba(245,196,82,0.5)' }} />
          <div style={{ width: 48, height: 1, background: 'linear-gradient(90deg, transparent, #A78BFA, transparent)' }} />
          <IconParticle className="holo-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#A78BFA' }} />
          <div style={{ width: 48, height: 1, background: 'linear-gradient(90deg, transparent, #A78BFA, transparent)' }} />
          <IconPrism className="holo-scroll-doodle opacity-0" style={{ width: 24, height: 20, color: 'rgba(245,196,82,0.5)' }} />
        </div>
        ...
        {(Boolean(invitation.frasePersonalizadaHabilitada) && Boolean(invitation.frasePersonalizadaTexto)) ? (
          <SectionWrapper id="quote" delay={100} className="w-full py-24 px-6 md:px-12 flex items-center justify-center" style={{ background: "linear-gradient(160deg, #A78BFA14, transparent 70%), #17172E" }}>
        ...
        <SectionWrapper id="details" delay={150} className="w-full bg-[#0D0D14] py-20 px-6 md:px-12">
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
            <p className="t-kicker mb-8 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#F5C452]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
            ...
            {(Boolean(invitation.ceremoniaHabilitada) || Boolean(invitation.ceremoniaNombre) || Boolean(invitation.ceremoniaDireccion)) && (
              <div className="bg-white/[0.04] border border-[#F5C452]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#9490B4] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  ...
                  {Boolean(invitation.ceremoniaHora) && (
                    <p className="text-[#9490B4]  text-sm sm:text-base mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      {String(invitation.ceremoniaHora)} hs
                    </p>
                  )}
                  {Boolean(invitation.ceremoniaDireccion) && (
                    <p className="text-[#9490B4]  text-sm sm:text-base mb-4" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      {String(invitation.ceremoniaDireccion)}
                    </p>
                  )}
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#F5C452] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-white/[0.04] border border-[#F5C452]/25 rounded-2xl backdrop-blur-sm p-6 sm:p-8 mb-10 shadow-sm">
                <span className=" text-[10px] font-semibold uppercase tracking-[0.2em] text-[#9490B4] block mb-3" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  FIESTA / SALÓN
                </span>
                {lugarNombre && (
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#F5C452] hover:text-white transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
            ...
            {cronograma.length > 0 && (
              <div className="mt-16">
                <p className="t-kicker mb-6 flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#F5C452]" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                  <IconOrb className="holo-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
                  CRONOGRAMA
                </p>
                <div className="flex flex-col w-full">
                  {cronograma.map((item, i) => (
                    <div key={i} className="flex flex-col sm:flex-row sm:items-center py-4 border-b border-[#F5C452]/10 last:border-b-0">
                      {item.time && (
                        <span className=" text-sm sm:text-base text-[#9490B4] font-medium w-24 flex-shrink-0 mb-1 sm:mb-0" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                          {item.time}
                        </span>
                      )}
        ...
        {showGiftSection && (
          <SectionWrapper id="banco" delay={200} className="w-full bg-[#131228] py-20 px-6 md:px-12 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
                <p className="t-kicker mb-10 flex items-center gap-2 text-[#F5C452]">
                  <IconOrb className="holo-scroll-doodle opacity-0" style={{ width: 16, height: 16 }} />
        ...
        {triviaHabilitada && triviaPreguntas.length > 0 && (
          <SectionWrapper id="quiz" delay={300} className="w-full py-20 px-6 md:px-12" style={{ background: "linear-gradient(160deg, #A78BFA18, transparent 70%), #131228" }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0D0D14' }} aria-hidden="true">
            <IconMusic className="holo-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#F5C452' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
        ...
        <div className="w-full flex justify-center py-6" style={{ background: '#0D0D14' }} aria-hidden="true">
          <svg className="holo-scroll-doodle opacity-0" viewBox="0 0 90 20" width="90" height="20" fill="none" stroke="rgba(245,196,82,0.6)" strokeWidth="1.2">
        ...
        <LogoFooterCredit bgColor="#0D0D14" />
        </div>
      </div>
      
      {isCoverOpen && <BottomNavPill sections={navSections} variant="moderno" accentColor="#F5C452" surfaceColor="#16162C" />}
      </div>
  );
}
