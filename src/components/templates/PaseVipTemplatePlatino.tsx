  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="pvp-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="pvp-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #122236 0%, #0A0E14 52%, #0A0D12 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="pvp-section" style={{ background: "#0A0E14" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="pvp-section" style={{ background: "#0A0E14" }}>
