...
/**
 * CorporativoAniversarioTemplate.tsx
 *
...
interface CorporativoAniversarioTemplateProps {
...
export function CorporativoAniversarioTemplate({ invitation, guest, isPersonalized = false }: CorporativoAniversarioTemplateProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      if (statusRef.current) {
        ...
        statusRef.current.style.color = "#F1E6CE";
      }
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#C9A25C";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #C9A25C";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#7A5C2E" : "#C9A25C";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0B0F13", tinta: "#F4F1EA", acento: "#C9A25C", clase: `${cpaDisplay.variable} ${cpaMono.variable}`, fuente: "var(--cpa-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
          ...
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="cpa-section" style={{ background: "#0E1319" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="cpa-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="cpa-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F1E6CE" : "#C9A25C" }} />
              ))}
            </div>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#C9A25C" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #C9A25C; text-decoration: none; }
  a:hover { color: #F1E6CE; }
  ...
  .cpa-date-month { font-family: var(--cpa-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #C9A25C; padding-left: 12%; }

  .cpa-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .cpa-divider-line { width: 52px; height: 1px; background: #C9A25C; display: inline-block; }
  ...
  .cpa-cal-link:hover { color: #C9A25C; }
  ...
  .cpa-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #C9A25C, #F1E6CE, #6E5AA8); filter: saturate(.75); }
  ...
  .cpa-medallion-label { font-family: var(--cpa-display), serif; font-size: 26px; line-height: 1; color: #F1E6CE; }
  .cpa-medallion-label-sm { font-family: var(--cpa-display), serif; font-size: 16px; color: #F1E6CE; }
  .cpa-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .cpa-medallion-sub--accent { color: #C9A25C; }
  ...
  .cpa-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #C9A25C; opacity: 0.4; font-family: var(--cpa-mono), monospace; }
  ...
  .cpa-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #F1E6CE, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .cpa-cd-num { font-family: var(--cpa-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F1E6CE; display: inline-block; }
  .cpa-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #C9A25C; }
  ...
  .cpa-accent-italic { font-style: italic; color: #C9A25C; }
  .cpa-accent-serif { font-style: italic; color: #7A5C2E; font-family: var(--cpa-display), serif; }
  .cpa-accent-serif-2 { color: #7A5C2E; }
  ...
  .cpa-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #7A5C2E; margin-top: auto; }
  ...
  .cpa-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #7A5C2E; }
  ...
  .cpa-crono-time { font-family: var(--cpa-mono), monospace; color: #7A5C2E; min-width: 42px; }
  ...
  .cpa-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #F1E6CE, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .cpa-rsvp-payment-total { color: #F1E6CE; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .cpa-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #C9A25C; background: transparent; color: #C9A25C; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .cpa-rsvp-input:focus { outline: none; border-bottom-color: #C9A25C; }
  .cpa-rsvp-btn { width: 100%; padding: 16px; font-family: var(--cpa-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #C9A25C, #7A5C2E); border: 1px solid #C9A25C; color: #0E1319; cursor: pointer; }
  .cpa-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .cpa-rsvp-btn--ghost { background: transparent; color: #C9A25C; }
  .cpa-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #C9A25C; margin: 0; }
  ...
  .cpa-bank-copy { flex-shrink: 0; font-family: var(--cpa-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #C9A25C; background: transparent; color: #C9A25C; cursor: pointer; }
  ...
  .cpa-song-input:focus { outline: none; border-bottom-color: #C9A25C; }
  .cpa-song-sep { color: #8A8577; flex-shrink: 0; }
  .cpa-song-submit { flex-shrink: 0; background: none; border: none; color: #C9A25C; font-family: var(--cpa-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .cpa-song-submit:hover { color: #F1E6CE; }
  .cpa-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .cpa-song-error { font-size: 10px; color: #C9A25C; margin-top: 6px; }
  ...
  .cpa-quiz-opt { font-family: var(--cpa-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #C9A25C; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .cpa-quiz-opt:disabled { cursor: default; }
  .cpa-quiz-opt--picked { background: #C9A25C; border-color: #C9A25C; color: #0E1319; }
  .cpa-quiz-opt--correct { background: #C9A25C; border-color: #C9A25C; color: #0E1319; }
  ...
  .cpa-quiz-result-score { margin: 0 0 6px; font-family: var(--cpa-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #F1E6CE; }
  .cpa-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .cpa-final-card { border: 1px solid #C9A25C; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .cpa-final-names { font-family: var(--cpa-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #F1E6CE; }
  ...
  .cpa-replay { cursor: pointer; color: #C9A25C; }
  ...
  .cpa-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F1E6CE, #C9A25C); transition: height 260ms linear; display: block; }
  .cpa-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #C9A25C; transition: color 500ms ease; }
  ...
  .cpa-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(30,42,56,0.55), rgba(201,162,92,0.32), rgba(201,162,92,0.55), rgba(30,42,56,0.55)); filter: blur(64px); opacity: .62; animation: bbsFoil 26s linear infinite; }
  .cpa-cover-texture { position: absolute; inset: 0; background-image: radial-gradient(rgba(241,230,206,.08) 1px, transparent 1.2px); background-size: 22px 22px; }
  ...
  .cpa-cover-names { margin: 0; font-family: var(--cpa-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #F1E6CE; }
  .cpa-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#C9A25C, transparent); display: block; }
  ...
  .cpa-cover-cta { border: 1px solid #C9A25C; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--cpa-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .cpa-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #C9A25C; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
