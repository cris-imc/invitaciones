...
/**
 * LumbreTemplateArcilla.tsx — Colección Paper · Papel Prensado · Familia 06 "Lumbre"
 * Variante: Arcilla (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Tostado, Arcilla, Ceniza, Sombra)
...
interface LumbreTemplateArcillaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function LumbreTemplateArcilla({ invitation, guest, isPersonalized = false }: LumbreTemplateArcillaProps) {
  const tx = useTextos();
