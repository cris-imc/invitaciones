...
/**
 * PrensaTemplateHueso.tsx — Colección Paper · Papel Prensado · Familia 01 "Prensa"
 * Variante: Hueso (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Hueso, Arena, Piedra, Humo) se
...
interface PrensaTemplateHuesoProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function PrensaTemplateHueso({ invitation, guest, isPersonalized = false }: PrensaTemplateHuesoProps) {
  const tx = useTextos();
