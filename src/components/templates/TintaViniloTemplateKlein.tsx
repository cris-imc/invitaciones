...
/**
 * TintaViniloTemplateKlein.tsx — Colección Paper · Papelería Viva · Familia 04 "Tinta & Vinilo"
 * Variante: Azul klein (generada, no editar a mano).
 *
...
interface TintaViniloTemplateKleinProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function TintaViniloTemplateKlein({ invitation, guest, isPersonalized = false }: TintaViniloTemplateKleinProps) {
  const tx = useTextos();
