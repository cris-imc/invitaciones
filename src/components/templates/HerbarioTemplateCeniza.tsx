...
/**
 * HerbarioTemplateCeniza.tsx — Colección Paper · Papel Prensado · Familia 04 "Herbario"
 * Variante: Ceniza (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Eucalipto, Oliva, Ceniza,
 ...
 */
const ACENTO = "#8A8A82";
const FILTRO = "grayscale(1) sepia(.35) saturate(.5)";
...
interface HerbarioTemplateCenizaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function HerbarioTemplateCeniza({ invitation, guest, isPersonalized = false }: HerbarioTemplateCenizaProps) {
  const tx = useTextos();
