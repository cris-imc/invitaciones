...
export function AtelierDePapelTemplateBorgonaVino({ invitation, guest, isPersonalized = false }: AtelierDePapelTemplateProps) {
  ...
  const frase = frasePersonalizadaHabilitada && invitation.frasePersonalizadaTexto
    ...
    : "El atelier se abre una sola vez.";
...
const ADP_CSS = `
  ...
  .adp-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 0%, rgba(21,15,16,1) 0%, rgba(21,15,16,1) 100%); }
