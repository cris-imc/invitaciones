  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="adp-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="adp-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #231523 0%, #120C12 52%, #150F10 100%)" }}>
        ...
        <div data-pan="1" data-screen-label="El lugar" className="adp-pan" style={ceremoniaHabilitada ? { height: "340vh" } : undefined}>
            ...
            <div data-strip="1" className="adp-strip">
              {ceremoniaHabilitada && (
                <div id="ceremonia" data-tone="light" className="adp-panel adp-panel--between" style={{ background: "#EFEBE1", color: "#14141B" }}>
                  ...
                  <div className="adp-seguir">SEGUÍ BAJANDO <span className="adp-side-hint">→</span></div>
                </div>
              )}
        ...
        <div id="album" data-pan="1" data-screen-label="Álbum" className="adp-pan">
          <div className="adp-pan-sticky">
            <div data-strip="1" className="adp-strip">
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="adp-section" style={{ background: "#150F10" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="adp-section" style={{ background: "#150F10" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="adp-section" style={{ background: "#150F10" }}>
            <span data-xin="1" data-dist="-60" className="adp-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6 + kOffset} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu lámina" className="adp-section adp-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #231523 0%, #150F10 55%, #150F10 100%)" }}>
          <span data-xin="1" data-dist="-60" className="adp-kicker">{[sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 6 + kOffset} — GUARDÁ TU LÁMINA</span>
