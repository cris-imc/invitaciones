...
interface BautismoTemplateCelesteProps {
...
export function BautismoTemplateCeleste({ invitation, guest, isPersonalized = false }: BautismoTemplateCelesteProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      if (statusRef.current) {
        ...
        statusRef.current.style.color = "#F0F6FA";
      }
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#A9C4D9";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #A9C4D9";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#5E7E90" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#5E7E90" : "#A9C4D9";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#11120E", tinta: "#F4F1EA", acento: "#A9C4D9", clase: `${btsDisplay.variable} ${btsMono.variable}`, fuente: "var(--bts-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="bts-panel bts-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="bts-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#5E7E90" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#5E7E90" />
                  </svg>
          ...
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="bts-section" style={{ background: "#161712" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="bts-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="bts-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F0F6FA" : "#A9C4D9" }} />
              ))}
            </div>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#A9C4D9" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #A9C4D9; text-decoration: none; }
  a:hover { color: #F0F6FA; }
  ...
  .bts-date-month { font-family: var(--bts-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #A9C4D9; padding-left: 12%; }

  .bts-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .bts-divider-line { width: 52px; height: 1px; background: #A9C4D9; display: inline-block; }
  ...
  .bts-cal-link:hover { color: #A9C4D9; }
  ...
  .bts-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #A9C4D9, #F0F6FA, #6E5AA8); filter: saturate(.75); }
  ...
  .bts-medallion-label { font-family: var(--bts-display), serif; font-size: 26px; line-height: 1; color: #F0F6FA; }
  .bts-medallion-label-sm { font-family: var(--bts-display), serif; font-size: 16px; color: #F0F6FA; }
  .bts-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .bts-medallion-sub--accent { color: #A9C4D9; }
  ...
  .bts-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #A9C4D9; opacity: 0.4; font-family: var(--bts-mono), monospace; }
  ...
  .bts-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #F0F6FA, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .bts-cd-num { font-family: var(--bts-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F0F6FA; display: inline-block; }
  .bts-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #A9C4D9; }
  ...
  .bts-accent-italic { font-style: italic; color: #A9C4D9; }
  .bts-accent-serif { font-style: italic; color: #5E7E90; font-family: var(--bts-display), serif; }
  .bts-accent-serif-2 { color: #5E7E90; }
  ...
  .bts-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #5E7E90; margin-top: auto; }
  ...
  .bts-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #5E7E90; }
  ...
  .bts-crono-time { font-family: var(--bts-mono), monospace; color: #5E7E90; min-width: 42px; }
  ...
  .bts-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #F0F6FA, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .bts-rsvp-payment-total { color: #F0F6FA; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .bts-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #A9C4D9; background: transparent; color: #A9C4D9; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .bts-rsvp-input:focus { outline: none; border-bottom-color: #A9C4D9; }
  .bts-rsvp-btn { width: 100%; padding: 16px; font-family: var(--bts-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #A9C4D9, #5E7E90); border: 1px solid #A9C4D9; color: #161712; cursor: pointer; }
  .bts-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .bts-rsvp-btn--ghost { background: transparent; color: #A9C4D9; }
  .bts-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #A9C4D9; margin: 0; }
  ...
  .bts-bank-copy { flex-shrink: 0; font-family: var(--bts-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #A9C4D9; background: transparent; color: #A9C4D9; cursor: pointer; }
  ...
  .bts-song-input:focus { outline: none; border-bottom-color: #A9C4D9; }
  .bts-song-sep { color: #8A8577; flex-shrink: 0; }
  .bts-song-submit { flex-shrink: 0; background: none; border: none; color: #A9C4D9; font-family: var(--bts-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .bts-song-submit:hover { color: #F0F6FA; }
  .bts-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .bts-song-error { font-size: 10px; color: #A9C4D9; margin-top: 6px; }
  ...
  .bts-quiz-opt { font-family: var(--bts-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #A9C4D9; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .bts-quiz-opt:disabled { cursor: default; }
  .bts-quiz-opt--picked { background: #A9C4D9; border-color: #A9C4D9; color: #161712; }
  .bts-quiz-opt--correct { background: #A9C4D9; border-color: #A9C4D9; color: #161712; }
  ...
  .bts-quiz-result-score { margin: 0 0 6px; font-family: var(--bts-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #F0F6FA; }
  .bts-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .bts-final-card { border: 1px solid #A9C4D9; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .bts-final-names { font-family: var(--bts-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #F0F6FA; }
  ...
  .bts-replay { cursor: pointer; color: #A9C4D9; }
  ...
  .bts-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F0F6FA, #A9C4D9); transition: height 260ms linear; display: block; }
  .bts-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #A9C4D9; transition: color 500ms ease; }
  ...
  .bts-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(124,142,122,0.4), rgba(169,196,217,0.3), rgba(169,196,217,0.5), rgba(124,142,122,0.4)); filter: blur(64px); opacity: .62; animation: bbsFoil 26s linear infinite; }
  .bts-cover-texture { position: absolute; inset: 0; background-image: repeating-linear-gradient(45deg, rgba(240,246,250,.06) 0 1px, transparent 1px 16px), repeating-linear-gradient(-45deg, rgba(240,246,250,.05) 0 1px, transparent 1px 16px); }
  ...
  .bts-cover-names { margin: 0; font-family: var(--bts-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #F0F6FA; }
  .bts-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#A9C4D9, transparent); display: block; }
  ...
  .bts-cover-cta { border: 1px solid #A9C4D9; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--bts-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .bts-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #A9C4D9; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
