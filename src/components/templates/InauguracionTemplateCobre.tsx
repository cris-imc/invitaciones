...
interface InauguracionTemplateCobreProps {
...
export function InauguracionTemplateCobre({ invitation, guest, isPersonalized = false }: InauguracionTemplateCobreProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      if (statusRef.current) {
        ...
        statusRef.current.style.color = "#F7E9DD";
      }
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#C97B4A";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #C97B4A";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#3A2416" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#3A2416" : "#C97B4A";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#080808", tinta: "#F4F1EA", acento: "#C97B4A", clase: `${ingDisplay.variable} ${ingMono.variable}`, fuente: "var(--ing-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="ing-scroller">
        ...
        <section data-tone="dark" data-screen-label="Save the Date" className="ing-section" style={{ background: "radial-gradient(120% 80% at 50% 0%, #17141F 0%, #3A2416 55%, #080808 100%)" }}>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label={tx("invitacion.ubicacion.elLugar")} className="ing-pan">
          <div className="ing-pan-sticky">
            <div data-strip="1" className="ing-strip">
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="ing-panel ing-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="ing-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#3A2416" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#3A2416" />
                  </svg>
              ...
              <div data-tone="dark" className="ing-panel ing-panel--center" style={{ background: "#3A2416", color: "#F4F1EA" }}>
        ...
        <section data-tone="dark" data-screen-label="Check-in" className="ing-section" style={{ background: "radial-gradient(110% 70% at 50% 100%, #17141F 0%, #3A2416 60%, #080808 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="ing-section" style={{ background: "#3A2416" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="ing-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="ing-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F7E9DD" : "#C97B4A" }} />
              ))}
            </div>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="ing-section" style={{ background: "#3A2416" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="ing-section" style={{ background: "#3A2416" }}>
        ...
        <section data-tone="dark" data-screen-label={tx("invitacion.pase.tuPase")} className="ing-section ing-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #17141F 0%, #3A2416 55%, #080808 100%)" }}>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#C97B4A" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #C97B4A; text-decoration: none; }
  a:hover { color: #F7E9DD; }
  ...
  .ing-date-month { font-family: var(--ing-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #C97B4A; padding-left: 12%; }

  .ing-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .ing-divider-line { width: 52px; height: 1px; background: #C97B4A; display: inline-block; }
  ...
  .ing-cal-link:hover { color: #C97B4A; }
  ...
  .ing-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #C97B4A, #F7E9DD, #6E5AA8); filter: saturate(.75); }
  ...
  .ing-medallion-label { font-family: var(--ing-display), serif; font-size: 26px; line-height: 1; color: #F7E9DD; }
  .ing-medallion-label-sm { font-family: var(--ing-display), serif; font-size: 16px; color: #F7E9DD; }
  .ing-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .ing-medallion-sub--accent { color: #C97B4A; }
  ...
  .ing-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #C97B4A; opacity: 0.4; font-family: var(--ing-mono), monospace; }
  ...
  .ing-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #F7E9DD, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .ing-cd-num { font-family: var(--ing-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F7E9DD; display: inline-block; }
  ...
  .ing-accent-italic { font-style: italic; color: #C97B4A; }
  .ing-accent-serif { font-style: italic; color: #3A2416; font-family: var(--ing-display), serif; }
  .ing-accent-serif-2 { color: #3A2416; }
  ...
  .ing-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #3A2416; margin-top: auto; }
  ...
  .ing-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #3A2416; }
  ...
  .ing-crono-time { font-family: var(--ing-mono), monospace; color: #3A2416; min-width: 42px; }
  ...
  .ing-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #F7E9DD, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .ing-rsvp-payment-total { color: #F7E9DD; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .ing-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #C97B4A; background: transparent; color: #C97B4A; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .ing-rsvp-input:focus { outline: none; border-bottom-color: #C97B4A; }
  .ing-rsvp-btn { width: 100%; padding: 16px; font-family: var(--ing-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #C97B4A, #3A2416); border: 1px solid #C97B4A; color: #3A2416; cursor: pointer; }
  .ing-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .ing-rsvp-btn--ghost { background: transparent; color: #C97B4A; }
  .ing-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #C97B4A; margin: 0; }
  ...
  .ing-bank-copy { flex-shrink: 0; font-family: var(--ing-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #C97B4A; background: transparent; color: #C97B4A; cursor: pointer; }
  ...
  .ing-song-input:focus { outline: none; border-bottom-color: #C97B4A; }
  .ing-song-sep { color: #8A8577; flex-shrink: 0; }
  .ing-song-submit { flex-shrink: 0; background: none; border: none; color: #C97B4A; font-family: var(--ing-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .ing-song-submit:hover { color: #F7E9DD; }
  .ing-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .ing-song-error { font-size: 10px; color: #C97B4A; margin-top: 6px; }
  ...
  .ing-quiz-opt { font-family: var(--ing-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #C97B4A; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .ing-quiz-opt:disabled { cursor: default; }
  .ing-quiz-opt--picked { background: #C97B4A; border-color: #C97B4A; color: #3A2416; }
  .ing-quiz-opt--correct { background: #C97B4A; border-color: #C97B4A; color: #3A2416; }
  ...
  .ing-quiz-result-score { margin: 0 0 6px; font-family: var(--ing-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #F7E9DD; }
  .ing-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .ing-final-card { border: 1px solid #C97B4A; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .ing-final-names { font-family: var(--ing-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #F7E9DD; }
  ...
  .ing-replay { cursor: pointer; color: #C97B4A; }
  ...
  .ing-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F7E9DD, #C97B4A); transition: height 260ms linear; display: block; }
  .ing-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #C97B4A; transition: color 500ms ease; }
  ...
  .ing-cover-names { margin: 0; font-family: var(--ing-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #F7E9DD; }
  .ing-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#C97B4A, transparent); display: block; }
  ...
  .ing-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #C97B4A; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
