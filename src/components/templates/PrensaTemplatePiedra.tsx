...
/**
 * PrensaTemplatePiedra.tsx — Colección Paper · Papel Prensado · Familia 01 "Prensa"
 * Variante: Piedra (generada por scripts/gen-papel-prensado-variants.js, no editar a mano). Las otras cuatro (Hueso, Arena, Piedra, Humo) se
...
interface PrensaTemplatePiedraProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function PrensaTemplatePiedra({ invitation, guest, isPersonalized = false }: PrensaTemplatePiedraProps) {
  const tx = useTextos();
