 ...
 * tinta café (#3E2E20) + acento terracota (#C1734A, variable por color),
...
interface RivieraTemplateProps {
...
export function RivieraTemplate({ invitation, guest, isPersonalized = false }: RivieraTemplateProps) {
  ...
  // Portada animada -- Riviera es tema claro (bg #FAF1E4, ink #3E2E20) ->
    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="riviera-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #C1734A',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#C1734A',
            }}>
              {monogram}
            </div>
            ...
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.background = '#C1734A'; e.currentTarget.style.color = '#FAF1E4'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(193,115,74,0.08)'; e.currentTarget.style.color = '#C1734A'; }}
            >
              ABRIR INVITACIÓN
            </button>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && createPortal(
        <div 
          ...
          className={`fixed top-3 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 cursor-pointer overflow-hidden border border-[#C1734A]/40 shadow-md ${isTicketMaximized ? 'bg-[#FAF1E4]/95 backdrop-blur-md rounded-full w-[90%] max-w-sm px-5 py-2.5' : 'bg-[#3E2E20]/95 backdrop-blur-md rounded-full px-5 py-2'}`}
        >
          {isTicketMaximized ? (
      ...
      <aside className="d-left hide-mobile" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="d-left-top drop-shadow-md">
          ...
          <div style={{ width: 40, height: 2, background: '#C1734A', margin: '6px 0 14px', animation: 'riviera-lineExpand 1.2s ease-out' }} />
      ...
      <div className="d-right tpl">
        <div className="hide-desktop w-full flex flex-col min-h-[100dvh] bg-[#FAF1E4]">
          ...
          <div className="px-8 pt-16 pb-12 text-left bg-[#FAF1E4] z-10 relative">
            ...
            <div style={{ width: 40, height: 2, background: '#C1734A', margin: '0 0 20px', animation: 'riviera-lineExpand 1.2s ease-out' }} />
        ...
        <div className="w-full flex items-center justify-center gap-3 py-8 bg-[#FAF1E4]" aria-hidden="true">
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #C1734A, transparent)' }} />
          <IconSun className="riviera-scroll-doodle opacity-0" style={{ width: 22, height: 22, color: '#C1734A' }} />
          ...
          <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              ...
              <div className="bg-black/20 border-l-[2px] border-l-[#C1734A] p-6 sm:p-8 mb-6 shadow-sm">
                <div>
                  ...
                  {Boolean(invitation.ceremoniaMapUrl) && (
                    <a href={String(invitation.ceremoniaMapUrl)} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#C1734A] hover:text-[#3E2E20] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                      Ver mapa ceremonia ↗
                    </a>
                  )}
                </div>
            ...
            {(lugarNombre || direccion) && (
              <div className="bg-black/20 border-l-[2px] border-l-[#C1734A] p-6 sm:p-8 mb-10 shadow-sm">
                ...
                {mapUrl && (
                  <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block mt-1  text-xs font-semibold tracking-wider text-[#C1734A] hover:text-[#3E2E20] transition-colors" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>
                    Ver mapa fiesta ↗
                  </a>
                )}
              </div>
          ...
          <SectionWrapper id="album" delay={200} className="w-full bg-[#F5E9D8] py-20 overflow-hidden">
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-10 flex items-center gap-2">
                <IconSun className="riviera-scroll-doodle opacity-0" style={{ width: 15, height: 15, color: '#C1734A' }} />
                ÁLBUM
              </p>
            </div>
          ...
          <SectionWrapper id="quiz" delay={300} className="w-full py-20 px-6 md:px-12" style={{ background: "linear-gradient(160deg, #7A8F6B18, transparent 70%), #F0E4D0" }}>
            <div className="w-full max-w-[340px] sm:max-w-xl mx-auto text-left">
              <p className="t-kicker mb-8 flex items-center gap-2">
                <IconSun className="riviera-scroll-doodle opacity-0" style={{ width: 14, height: 14, color: '#C1734A' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#F0E4D0' }} aria-hidden="true">
            <IconMusic className="riviera-scroll-doodle opacity-0" style={{ width: 26, height: 26, color: '#C1734A' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
