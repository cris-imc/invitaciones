  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="lqg-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="lqg-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #171C27 0%, #0B0C11 52%, #0A080D 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="lqg-section" style={{ background: "#0D0A11" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="lqg-section" style={{ background: "#0D0A11" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="lqg-section" style={{ background: "#0D0A11" }}>
            <span data-xin="1" data-dist="-60" className="lqg-kicker">{[sugerenciaMusicaHabilitada, showBankSection].filter(Boolean).length + 6 + kOffset} — EL JUEGO</span>
        ...
        <section data-tone="dark" data-screen-label="Tu panel" className="lqg-section lqg-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #14171F 0%, #0D0A11 55%, #0A080D 100%)" }}>
          <span data-xin="1" data-dist="-60" className="lqg-kicker">{[sugerenciaMusicaHabilitada, showBankSection, quizEnabled].filter(Boolean).length + 6 + kOffset} — GUARDÁ TU PANEL</span>
      ...
      <div ref={coverRef} className="lqg-cover">
    ...
    <div className="lqg-cover-inner">
      ...
      <div className="lqg-cover-content">
        <div className="lqg-cover-top-row">
          <span>PANEL Nº {panelNumber}</span><span className="lqg-accent-navy-solid" style={{ color: "#A86FC9" }}>ADMIT TWO</span>
        </div>
        ...
        <div className="lqg-cover-bottom">
          <div ref={perfRef} className="lqg-perf-strip lqg-perf-strip--reveal" />
          ...
          <div className="lqg-barcode-wrap">
            <div className="lqg-barcode" style={{ width: "62%" }} />
            <span className="lqg-mini-label" style={{ color: "#56534A" }}>NO TRANSFERIBLE</span>
          </div>
        </div>
      </div>
    </div>
...
const LQG_CSS = `
  ...
  .lqg-cover-names { margin: 0; font-family: var(--lqg-cormorant), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #F5F8F9; }
