...
export function LiquidGlassTemplateAmatista({ invitation, guest, isPersonalized = false }: LiquidGlassTemplateProps) {
  ...
  const frase = frasePersonalizadaHabilitada && invitation.frasePersonalizadaTexto
    ...
    : "El vidrio se aclara una sola vez.";
      ...
      <div ref={scrollerRef} data-scroller="1" className="lqg-scroller">
          ...
          <div className="lqg-hero-photo-frame">
            <div className="acp-mobile-only">
              {photoMobile ? (
                ...
                <div className="lqg-hero-photo-placeholder" />
              )}
            </div>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="lqg-section" style={{ background: "#0D0A11" }}>
            <span data-xin="1" data-dist="-60" className="lqg-kicker">{sugerenciaMusicaHabilitada ? "08" : "07"} — REGALOS Y PAGOS</span>
...
const LQG_CSS = `
  ...
  .lqg-hero-photo-placeholder { position: absolute; inset: 0; background: radial-gradient(120% 80% at 50% 30%, #221A2C 0%, #150F1A 60%, #0A080D 100%); }
