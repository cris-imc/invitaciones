...
/**
 * CorporativoAniversarioTemplateGrafito.tsx
 *
...
interface CorporativoAniversarioTemplateGrafitoProps {
...
export function CorporativoAniversarioTemplateGrafito({ invitation, guest, isPersonalized = false }: CorporativoAniversarioTemplateGrafitoProps) {
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      ...
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#A8A8AC";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #A8A8AC";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#5A5A61" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#5A5A61" : "#A8A8AC";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0B0F13", tinta: "#F4F1EA", acento: "#A8A8AC", clase: `${cpaDisplay.variable} ${cpaMono.variable}`, fuente: "var(--cpa-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="cpa-panel cpa-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="cpa-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#5A5A61" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#5A5A61" />
                  </svg>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#A8A8AC" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #A8A8AC; text-decoration: none; }
  ...
  .cpa-date-month { font-family: var(--cpa-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #A8A8AC; padding-left: 12%; }

  .cpa-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .cpa-divider-line { width: 52px; height: 1px; background: #A8A8AC; display: inline-block; }
  ...
  .cpa-cal-link:hover { color: #A8A8AC; }
  ...
  .cpa-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #A8A8AC, #EDEDEF, #6E5AA8); filter: saturate(.75); }
  ...
  .cpa-medallion-label { font-family: var(--cpa-display), serif; font-size: 26px; line-height: 1; color: #EDEDEF; }
  .cpa-medallion-label-sm { font-family: var(--cpa-display), serif; font-size: 16px; color: #EDEDEF; }
  .cpa-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .cpa-medallion-sub--accent { color: #A8A8AC; }
  ...
  .cpa-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #A8A8AC; opacity: 0.4; font-family: var(--cpa-mono), monospace; }
  ...
  .cpa-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #EDEDEF, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .cpa-cd-num { font-family: var(--cpa-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #EDEDEF; display: inline-block; }
  .cpa-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #A8A8AC; }
  ...
  .cpa-accent-italic { font-style: italic; color: #A8A8AC; }
  .cpa-accent-serif { font-style: italic; color: #5A5A61; font-family: var(--cpa-display), serif; }
  .cpa-accent-serif-2 { color: #5A5A61; }
  ...
  .cpa-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #5A5A61; margin-top: auto; }
  ...
  .cpa-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #5A5A61; }
  ...
  .cpa-crono-time { font-family: var(--cpa-mono), monospace; color: #5A5A61; min-width: 42px; }
  ...
  .cpa-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #EDEDEF, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .cpa-rsvp-payment-total { color: #EDEDEF; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .cpa-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #A8A8AC; background: transparent; color: #A8A8AC; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .cpa-rsvp-input:focus { outline: none; border-bottom-color: #A8A8AC; }
  .cpa-rsvp-btn { width: 100%; padding: 16px; font-family: var(--cpa-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #A8A8AC, #5A5A61); border: 1px solid #A8A8AC; color: #0E1319; cursor: pointer; }
  .cpa-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .cpa-rsvp-btn--ghost { background: transparent; color: #A8A8AC; }
  .cpa-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #A8A8AC; margin: 0; }
  ...
  .cpa-bank-copy { flex-shrink: 0; font-family: var(--cpa-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #A8A8AC; background: transparent; color: #A8A8AC; cursor: pointer; }
  ...
  .cpa-song-input:focus { outline: none; border-bottom-color: #A8A8AC; }
  .cpa-song-sep { color: #8A8577; flex-shrink: 0; }
  .cpa-song-submit { flex-shrink: 0; background: none; border: none; color: #A8A8AC; font-family: var(--cpa-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .cpa-song-submit:hover { color: #EDEDEF; }
  .cpa-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .cpa-song-error { font-size: 10px; color: #A8A8AC; margin-top: 6px; }
  ...
  .cpa-quiz-opt { font-family: var(--cpa-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #A8A8AC; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .cpa-quiz-opt:disabled { cursor: default; }
  .cpa-quiz-opt--picked { background: #A8A8AC; border-color: #A8A8AC; color: #0E1319; }
  .cpa-quiz-opt--correct { background: #A8A8AC; border-color: #A8A8AC; color: #0E1319; }
  ...
  .cpa-quiz-result-score { margin: 0 0 6px; font-family: var(--cpa-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #EDEDEF; }
  .cpa-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .cpa-final-card { border: 1px solid #A8A8AC; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .cpa-final-names { font-family: var(--cpa-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #EDEDEF; }
  ...
  .cpa-replay { cursor: pointer; color: #A8A8AC; }
  ...
  .cpa-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#EDEDEF, #A8A8AC); transition: height 260ms linear; display: block; }
  .cpa-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #A8A8AC; transition: color 500ms ease; }
  ...
  .cpa-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(30,42,56,0.55), rgba(168,168,172,0.32), rgba(168,168,172,0.55), rgba(30,42,56,0.55)); filter: blur(64px); opacity: .62; animation: bbsFoil 26s linear infinite; }
  .cpa-cover-texture { position: absolute; inset: 0; background-image: radial-gradient(rgba(237,237,239,.08) 1px, transparent 1.2px); background-size: 22px 22px; }
  ...
  .cpa-cover-names { margin: 0; font-family: var(--cpa-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #EDEDEF; }
  .cpa-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#A8A8AC, transparent); display: block; }
  ...
  .cpa-cover-cta { border: 1px solid #A8A8AC; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--cpa-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .cpa-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #A8A8AC; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
