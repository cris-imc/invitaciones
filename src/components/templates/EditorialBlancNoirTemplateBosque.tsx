 ...
 * Variante: Bosque. Es la familia BASE de la sub-colección: las otras
...
export function EditorialBlancNoirTemplateBosque({ invitation, guest, isPersonalized = false }: EditorialBlancNoirTemplateProps) {
  const tx = useTextos();
