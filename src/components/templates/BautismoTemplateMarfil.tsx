...
interface BautismoTemplateMarfilProps {
...
export function BautismoTemplateMarfil({ invitation, guest, isPersonalized = false }: BautismoTemplateMarfilProps) {
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      ...
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#D9CBAE";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(200,164,92,.35), 0 18px 50px -30px #D9CBAE";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#8C7A54" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#8C7A54" : "#D9CBAE";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#11120E", tinta: "#F4F1EA", acento: "#D9CBAE", clase: `${btsDisplay.variable} ${btsMono.variable}`, fuente: "var(--bts-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="bts-panel bts-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="bts-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#8C7A54" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#8C7A54" />
                  </svg>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#D9CBAE" guest={guest} />
      )}
...
const GP_CSS = `
  ...
  a { color: #D9CBAE; text-decoration: none; }
  a:hover { color: #FBF7EE; }
  ...
  .bts-date-month { font-family: var(--bts-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #D9CBAE; padding-left: 12%; }

  .bts-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .bts-divider-line { width: 52px; height: 1px; background: #D9CBAE; display: inline-block; }
  ...
  .bts-cal-link:hover { color: #D9CBAE; }
  ...
  .bts-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #D9CBAE, #FBF7EE, #6E5AA8); filter: saturate(.75); }
  ...
  .bts-medallion-label { font-family: var(--bts-display), serif; font-size: 26px; line-height: 1; color: #FBF7EE; }
  .bts-medallion-label-sm { font-family: var(--bts-display), serif; font-size: 16px; color: #FBF7EE; }
  .bts-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .bts-medallion-sub--accent { color: #D9CBAE; }
  ...
  .bts-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #D9CBAE; opacity: 0.4; font-family: var(--bts-mono), monospace; }
  ...
  .bts-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #FBF7EE, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .bts-cd-num { font-family: var(--bts-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #FBF7EE; display: inline-block; }
  .bts-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #D9CBAE; }
  ...
  .bts-accent-italic { font-style: italic; color: #D9CBAE; }
  .bts-accent-serif { font-style: italic; color: #8C7A54; font-family: var(--bts-display), serif; }
  .bts-accent-serif-2 { color: #8C7A54; }
  ...
  .bts-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #8C7A54; margin-top: auto; }
  ...
  .bts-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #8C7A54; }
  ...
  .bts-crono-time { font-family: var(--bts-mono), monospace; color: #8C7A54; min-width: 42px; }
  ...
  .bts-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #FBF7EE, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .bts-rsvp-payment-total { color: #FBF7EE; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .bts-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #D9CBAE; background: transparent; color: #D9CBAE; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .bts-rsvp-input:focus { outline: none; border-bottom-color: #D9CBAE; }
  .bts-rsvp-btn { width: 100%; padding: 16px; font-family: var(--bts-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #D9CBAE, #8C7A54); border: 1px solid #D9CBAE; color: #161712; cursor: pointer; }
  .bts-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .bts-rsvp-btn--ghost { background: transparent; color: #D9CBAE; }
  .bts-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #D9CBAE; margin: 0; }
  ...
  .bts-bank-copy { flex-shrink: 0; font-family: var(--bts-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #D9CBAE; background: transparent; color: #D9CBAE; cursor: pointer; }
  ...
  .bts-song-input:focus { outline: none; border-bottom-color: #D9CBAE; }
  .bts-song-sep { color: #8A8577; flex-shrink: 0; }
  .bts-song-submit { flex-shrink: 0; background: none; border: none; color: #D9CBAE; font-family: var(--bts-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .bts-song-submit:hover { color: #FBF7EE; }
  .bts-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .bts-song-error { font-size: 10px; color: #D9CBAE; margin-top: 6px; }
  ...
  .bts-quiz-opt { font-family: var(--bts-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #D9CBAE; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .bts-quiz-opt:disabled { cursor: default; }
  .bts-quiz-opt--picked { background: #D9CBAE; border-color: #D9CBAE; color: #161712; }
  .bts-quiz-opt--correct { background: #D9CBAE; border-color: #D9CBAE; color: #161712; }
  ...
  .bts-quiz-result-score { margin: 0 0 6px; font-family: var(--bts-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #FBF7EE; }
  .bts-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .bts-final-card { border: 1px solid #D9CBAE; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .bts-final-names { font-family: var(--bts-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #FBF7EE; }
  ...
  .bts-replay { cursor: pointer; color: #D9CBAE; }
  ...
  .bts-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#FBF7EE, #D9CBAE); transition: height 260ms linear; display: block; }
  .bts-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #D9CBAE; transition: color 500ms ease; }
  ...
  .bts-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(124,142,122,0.4), rgba(217,203,174,0.3), rgba(217,203,174,0.5), rgba(124,142,122,0.4)); filter: blur(64px); opacity: .62; animation: bbsFoil 26s linear infinite; }
  .bts-cover-texture { position: absolute; inset: 0; background-image: repeating-linear-gradient(45deg, rgba(251,247,238,.06) 0 1px, transparent 1px 16px), repeating-linear-gradient(-45deg, rgba(251,247,238,.05) 0 1px, transparent 1px 16px); }
  ...
  .bts-cover-names { margin: 0; font-family: var(--bts-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #FBF7EE; }
  .bts-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#D9CBAE, transparent); display: block; }
  ...
  .bts-cover-cta { border: 1px solid #D9CBAE; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--bts-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .bts-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #D9CBAE; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
