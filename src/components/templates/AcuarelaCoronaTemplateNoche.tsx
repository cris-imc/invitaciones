...
/**
 * AcuarelaCoronaTemplateNoche.tsx — Colección Paper · Papelería Viva · Familia 02 "Acuarela & Corona"
 * Variante: Azul noche (generada, no editar a mano).
 *
...
interface AcuarelaCoronaTemplateNocheProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function AcuarelaCoronaTemplateNoche({ invitation, guest, isPersonalized = false }: AcuarelaCoronaTemplateNocheProps) {
  const tx = useTextos();
