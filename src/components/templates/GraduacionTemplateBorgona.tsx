...
interface GraduacionTemplateBorgonaProps {
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#0A0D18", tinta: "#F4F1EA", acento: "#BE6774", clase: `${grdDisplay.variable} ${grdMono.variable}`, fuente: "var(--grd-mono), monospace" }}
      />
    );
  }
...
const GP_CSS = `
  ...
  .grd-date-month { font-family: var(--grd-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #BE6774; padding-left: 12%; }

  .grd-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .grd-divider-line { width: 52px; height: 1px; background: #BE6774; display: inline-block; }
  ...
  .grd-cal-link:hover { color: #BE6774; }
  ...
  .grd-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #BE6774, #F7E9EB, #6E5AA8); filter: saturate(.75); }
  ...
  .grd-medallion-label { font-family: var(--grd-display), serif; font-size: 26px; line-height: 1; color: #F7E9EB; }
  .grd-medallion-label-sm { font-family: var(--grd-display), serif; font-size: 16px; color: #F7E9EB; }
  .grd-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .grd-medallion-sub--accent { color: #BE6774; }
  ...
  .grd-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #BE6774; opacity: 0.4; font-family: var(--grd-mono), monospace; }
  ...
  .grd-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #F7E9EB, transparent); animation: grdScan 6s linear infinite; pointer-events: none; }
  ...
  .grd-cd-num { font-family: var(--grd-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F7E9EB; display: inline-block; }
  .grd-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #BE6774; }
  ...
  .grd-accent-italic { font-style: italic; color: #BE6774; }
  .grd-accent-serif { font-style: italic; color: #7A2E38; font-family: var(--grd-display), serif; }
  .grd-accent-serif-2 { color: #7A2E38; }
  ...
  .grd-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #7A2E38; margin-top: auto; }
  ...
  .grd-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #7A2E38; }
  ...
  .grd-crono-time { font-family: var(--grd-mono), monospace; color: #7A2E38; min-width: 42px; }
  ...
  .grd-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #F7E9EB, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .grd-rsvp-payment-total { color: #F7E9EB; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .grd-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #BE6774; background: transparent; color: #BE6774; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .grd-rsvp-input:focus { outline: none; border-bottom-color: #BE6774; }
  .grd-rsvp-btn { width: 100%; padding: 16px; font-family: var(--grd-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #BE6774, #7A2E38); border: 1px solid #BE6774; color: #0D111E; cursor: pointer; }
  .grd-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .grd-rsvp-btn--ghost { background: transparent; color: #BE6774; }
  .grd-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #BE6774; margin: 0; }
  ...
  .grd-bank-copy { flex-shrink: 0; font-family: var(--grd-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #BE6774; background: transparent; color: #BE6774; cursor: pointer; }
  ...
  .grd-song-input:focus { outline: none; border-bottom-color: #BE6774; }
  .grd-song-sep { color: #8A8577; flex-shrink: 0; }
  .grd-song-submit { flex-shrink: 0; background: none; border: none; color: #BE6774; font-family: var(--grd-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .grd-song-submit:hover { color: #F7E9EB; }
  .grd-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .grd-song-error { font-size: 10px; color: #BE6774; margin-top: 6px; }
  ...
  .grd-quiz-opt { font-family: var(--grd-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #BE6774; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .grd-quiz-opt:disabled { cursor: default; }
  .grd-quiz-opt--picked { background: #BE6774; border-color: #BE6774; color: #0D111E; }
  .grd-quiz-opt--correct { background: #BE6774; border-color: #BE6774; color: #0D111E; }
  ...
  .grd-quiz-result-score { margin: 0 0 6px; font-family: var(--grd-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #F7E9EB; }
  .grd-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .grd-final-card { border: 1px solid #BE6774; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .grd-final-names { font-family: var(--grd-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #F7E9EB; }
  ...
  .grd-replay { cursor: pointer; color: #BE6774; }
  ...
  .grd-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F7E9EB, #BE6774); transition: height 260ms linear; display: block; }
  .grd-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #BE6774; transition: color 500ms ease; }
  ...
  .grd-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(28,43,74,0.55), rgba(190,103,116,0.32), rgba(190,103,116,0.55), rgba(28,43,74,0.55)); filter: blur(64px); opacity: .62; animation: grdFoil 26s linear infinite; }
  .grd-cover-texture { position: absolute; inset: 0; background-image: repeating-linear-gradient(90deg, rgba(247,233,235,.06) 0 1px, transparent 1px 40px); }
  ...
  .grd-cover-names { margin: 0; font-family: var(--grd-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #F7E9EB; }
  .grd-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#BE6774, transparent); display: block; }
  ...
  .grd-cover-cta { border: 1px solid #BE6774; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--grd-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .grd-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #BE6774; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
