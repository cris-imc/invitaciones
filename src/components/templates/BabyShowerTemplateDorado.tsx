...
interface BabyShowerTemplateDoradoProps {
...
export function BabyShowerTemplateDorado({ invitation, guest, isPersonalized = false }: BabyShowerTemplateDoradoProps) {
  const tx = useTextos();
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#14101A", tinta: "#F4F1EA", acento: "#D4B483", clase: `${bbsDisplay.variable} ${bbsMono.variable}`, fuente: "var(--bbs-mono), monospace" }}
      />
    );
  }
          ...
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="bbs-section" style={{ background: "#191420" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="bbs-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="bbs-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#FBF4E7" : "#D4B483" }} />
              ))}
            </div>
...
const GP_CSS = `
  ...
  .bbs-date-month { font-family: var(--bbs-display), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #D4B483; padding-left: 12%; }

  .bbs-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .bbs-divider-line { width: 52px; height: 1px; background: #D4B483; display: inline-block; }
  ...
  .bbs-cal-link:hover { color: #D4B483; }
  ...
  .bbs-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #6E5AA8, #4E7F86, #D4B483, #FBF4E7, #6E5AA8); filter: saturate(.75); }
  ...
  .bbs-medallion-label { font-family: var(--bbs-display), serif; font-size: 26px; line-height: 1; color: #FBF4E7; }
  .bbs-medallion-label-sm { font-family: var(--bbs-display), serif; font-size: 16px; color: #FBF4E7; }
  .bbs-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #8A8577; }
  .bbs-medallion-sub--accent { color: #D4B483; }
  ...
  .bbs-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #D4B483; opacity: 0.4; font-family: var(--bbs-mono), monospace; }
  ...
  .bbs-scanline { position: absolute; left: 0; right: 0; top: 30%; height: 2px; background: linear-gradient(90deg, transparent, #FBF4E7, transparent); animation: bbsScan 6s linear infinite; pointer-events: none; }
  ...
  .bbs-cd-num { font-family: var(--bbs-display), serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #FBF4E7; display: inline-block; }
  .bbs-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #D4B483; }
  ...
  .bbs-accent-italic { font-style: italic; color: #D4B483; }
  .bbs-accent-serif { font-style: italic; color: #8C6F35; font-family: var(--bbs-display), serif; }
  .bbs-accent-serif-2 { color: #8C6F35; }
  ...
  .bbs-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #8C6F35; margin-top: auto; }
  ...
  .bbs-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #8C6F35; }
  ...
  .bbs-crono-time { font-family: var(--bbs-mono), monospace; color: #8C6F35; min-width: 42px; }
  ...
  .bbs-beam { position: absolute; left: 0; right: 0; top: 0; height: 2px; background: linear-gradient(90deg, transparent, #FBF4E7, transparent); opacity: 0; transition: transform 900ms cubic-bezier(.16,1,.3,1), opacity 300ms ease; }
  ...
  .bbs-rsvp-payment-total { color: #FBF4E7; font-size: 13px; letter-spacing: 0.02em; font-weight: 600; }
  ...
  .bbs-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #D4B483; background: transparent; color: #D4B483; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .bbs-rsvp-input:focus { outline: none; border-bottom-color: #D4B483; }
  .bbs-rsvp-btn { width: 100%; padding: 16px; font-family: var(--bbs-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #D4B483, #8C6F35); border: 1px solid #D4B483; color: #191420; cursor: pointer; }
  .bbs-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .bbs-rsvp-btn--ghost { background: transparent; color: #D4B483; }
  .bbs-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #D4B483; margin: 0; }
  ...
  .bbs-bank-copy { flex-shrink: 0; font-family: var(--bbs-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #D4B483; background: transparent; color: #D4B483; cursor: pointer; }
  ...
  .bbs-song-input:focus { outline: none; border-bottom-color: #D4B483; }
  .bbs-song-sep { color: #8A8577; flex-shrink: 0; }
  .bbs-song-submit { flex-shrink: 0; background: none; border: none; color: #D4B483; font-family: var(--bbs-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .bbs-song-submit:hover { color: #FBF4E7; }
  .bbs-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .bbs-song-error { font-size: 10px; color: #D4B483; margin-top: 6px; }
  ...
  .bbs-quiz-opt { font-family: var(--bbs-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(200,164,92,0.4); background: transparent; color: #D4B483; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .bbs-quiz-opt:disabled { cursor: default; }
  .bbs-quiz-opt--picked { background: #D4B483; border-color: #D4B483; color: #191420; }
  .bbs-quiz-opt--correct { background: #D4B483; border-color: #D4B483; color: #191420; }
  ...
  .bbs-quiz-result-score { margin: 0 0 6px; font-family: var(--bbs-mono), monospace; font-size: 11px; letter-spacing: 0.16em; color: #FBF4E7; }
  .bbs-quiz-result-stat { margin: 0; font-size: 11.5px; line-height: 1.5; color: #A8A292; }

  .bbs-final-card { border: 1px solid #D4B483; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  .bbs-final-names { font-family: var(--bbs-display), serif; font-size: clamp(34px, 10vw, 46px); line-height: .9; color: #FBF4E7; }
  ...
  .bbs-replay { cursor: pointer; color: #D4B483; }
  ...
  .bbs-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#FBF4E7, #D4B483); transition: height 260ms linear; display: block; }
  .bbs-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #D4B483; transition: color 500ms ease; }
  ...
  .bbs-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(138,174,208,0.4), rgba(212,180,131,0.32), rgba(212,180,131,0.5), rgba(138,174,208,0.4)); filter: blur(64px); opacity: .62; animation: bbsFoil 26s linear infinite; }
  .bbs-cover-texture { position: absolute; inset: 0; background-image: radial-gradient(rgba(251,244,231,.5) 1.6px, transparent 1.8px); background-size: 34px 34px; }
  ...
  .bbs-cover-names { margin: 0; font-family: var(--bbs-display), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), calc(12.5vh * var(--esc, 1))); line-height: 0.86; letter-spacing: -0.02em; color: #FBF4E7; }
  .bbs-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#D4B483, transparent); display: block; }
  ...
  .bbs-cover-cta { border: 1px solid #D4B483; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--bbs-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .bbs-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #D4B483; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
