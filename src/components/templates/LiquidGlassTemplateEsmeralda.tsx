...
/**
 * LiquidGlassTemplateEsmeralda.tsx
 *
 * Variante de color "Esmeralda" de LiquidGlassTemplate.tsx (Colección
 ...
 * Design (panel de acceso de vidrio para boda: fondo casi negro con tinte verde esmeralda,
 * acento vidrio esmeralda #6FC9A8, Cormorant Garamond + IBM Plex Mono,
...
export function LiquidGlassTemplateEsmeralda({ invitation, guest, isPersonalized = false }: LiquidGlassTemplateProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      ...
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#6FC9A8";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(111,201,168,.35), 0 18px 50px -30px #6FC9A8";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#1C3025" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#1C3025" : "#6FC9A8";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#080D0A", tinta: "#F4F1EA", acento: "#6FC9A8", clase: `${lqgCormorant.variable} ${lqgMono.variable}`, fuente: "var(--lqg-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="lqg-scroller">
        ...
        <section data-tone="dark" data-screen-label="Save the Date" className="lqg-section" style={{ background: "radial-gradient(120% 80% at 50% 0%, #171F14 0%, #0A110D 55%, #080D0A 100%)" }}>
            ...
            <div className="lqg-hero-photo-frame">
              {photoMobile && (
                <div className="acp-mobile-only">
                  <AnimatedCoverPhoto photoSrc={photoMobile} tint={false} effect="enfoque" scrimColorRgb="8,13,10" />
                </div>
              )}
              {photoDesktop && (
                <div className="acp-desktop-only">
                  <AnimatedCoverPhoto photoSrc={photoDesktop} tint={false} effect="enfoque" scrimColorRgb="8,13,10" />
                </div>
              )}
            </div>
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="lqg-section lqg-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #14221B 0%, #0B120E 55%, #080D0A 100%)" }}>
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label={tx("invitacion.frase.etiqueta")} className="lqg-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #1C2717 0%, #0C110B 52%, #080D0A 100%)" }}>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label={tx("invitacion.ubicacion.cuandoYDonde")} className="lqg-pan" style={!scrollVertical && ceremoniaHabilitada ? { height: "340vh" } : undefined}>
          <div className="lqg-pan-sticky">
            <div data-strip="1" className="lqg-strip">
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="lqg-panel lqg-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="lqg-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#1C3025" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#1C3025" />
                  </svg>
              ...
              <div data-tone="dark" className="lqg-panel lqg-panel--center" style={{ background: "#0A110D", color: "#F4F1EA" }}>
        ...
        <section data-tone="dark" data-screen-label="Check-in" className="lqg-section" style={{ background: "radial-gradient(110% 70% at 50% 100%, #171F14 0%, #0A110D 60%, #080D0A 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="lqg-section" style={{ background: "#0A110D" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="lqg-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="lqg-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F5F8F9" : "#6FC9A8" }} />
              ))}
            </div>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="lqg-section" style={{ background: "#0A110D" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="lqg-section" style={{ background: "#0A110D" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu panel" className="lqg-section lqg-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #171F14 0%, #0A110D 55%, #080D0A 100%)" }}>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#6FC9A8" guest={guest} />
      )}
    ...
    <div className="lqg-cover-inner">
      ...
      <div className="lqg-cover-content">
        <div className="lqg-cover-top-row">
          <span>{tx("invitacion.pase.numeroPanel", { n: panelNumber }).toUpperCase()}</span><span className="lqg-accent-navy-solid" style={{ color: "#6FC9A8" }}>ALL ACCESS</span>
        </div>
...
const LQG_CSS = `
  ...
  a { color: #6FC9A8; text-decoration: none; }
  ...
  .lqg-hero-photo-section { min-height: calc(var(--vh, 1vh) * 100); position: relative; overflow: hidden; background: #080D0A; }
  ...
  @media (min-width: 768px) {
    .lqg-hero-photo-frame { inset: 64px max(24px, calc((100% - 900px) / 2)); border: 1px solid rgba(111,201,168,.3); }
  ...
  .lqg-date-month { font-family: var(--lqg-cormorant), serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #6FC9A8; padding-left: 12%; }

  .lqg-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .lqg-divider-line { width: 52px; height: 1px; background: #6FC9A8; display: inline-block; }
  ...
  .lqg-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #1C3025, #0E1611, #6FC9A8, #F5F8F9, #1C3025); filter: saturate(.75); }
  .lqg-medallion-core { position: absolute; inset: 3px; border-radius: 50%; background: #0C110C; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 3px; text-align: center; padding: 6px; }
  ...
  .lqg-medallion-sub--accent { color: #6FC9A8; }
  ...
  .lqg-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #6FC9A8; opacity: 0.4; font-family: var(--lqg-mono), monospace; }
  ...
  .lqg-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #6FC9A8; }
  .lqg-perf-strip { height: 12px; position: relative; background: radial-gradient(circle at 6px 50%, #080D0A 3.4px, transparent 3.8px) 0 0/12px 12px repeat-x; opacity: .85; }
  ...
  .lqg-glow-blob { position: absolute; right: -26%; top: 4%; width: 82vw; max-width: 540px; aspect-ratio: 1; border-radius: 50%; background: conic-gradient(from 200deg, rgba(111,201,168,0.3), rgba(232,242,240,0.2), rgba(111,201,168,0.34), rgba(111,201,168,0.3)); filter: blur(80px); opacity: .4; animation: lqgFoil 30s linear infinite; }
  ...
  .lqg-accent-italic { font-style: italic; color: #6FC9A8; }
  .lqg-accent-serif { font-style: italic; color: #6FC9A8; font-family: var(--lqg-cormorant), serif; }
  .lqg-accent-navy { font-style: italic; color: #1C3025; font-family: var(--lqg-cormorant), serif; }
  .lqg-accent-navy-solid { color: #1C3025; }
  ...
  .lqg-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #1C3025; margin-top: auto; }
  ...
  .lqg-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #1C3025; }
  ...
  .lqg-crono-time { font-family: var(--lqg-mono), monospace; color: #1C3025; min-width: 42px; }
  ...
  .lqg-rsvp-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 12px 0; border-bottom: 1px solid rgba(111,201,168,0.18); font-size: 10.5px; letter-spacing: 0.18em; color: #8A8577; }
  ...
  .lqg-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #6FC9A8; background: transparent; color: #6FC9A8; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .lqg-rsvp-input { background: transparent; border: none; border-bottom: 1px solid rgba(111,201,168,0.3); color: #F4F1EA; font-family: var(--lqg-mono), monospace; font-size: 11px; letter-spacing: 0.02em; padding: 4px 2px; text-align: right; max-width: 55%; }
  .lqg-rsvp-input::placeholder { color: #6E6A5D; }
  .lqg-rsvp-input:focus { outline: none; border-bottom-color: #6FC9A8; }
  .lqg-rsvp-btn { width: 100%; padding: 16px; font-family: var(--lqg-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #6FC9A8, #4A967A); border: 1px solid #6FC9A8; color: #0B0B10; cursor: pointer; }
  .lqg-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .lqg-rsvp-btn--ghost { background: transparent; color: #6FC9A8; }
  .lqg-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #6FC9A8; margin: 0; }
  ...
  .lqg-bank-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(111,201,168,0.18); }
  ...
  .lqg-bank-copy { flex-shrink: 0; font-family: var(--lqg-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #6FC9A8; background: transparent; color: #6FC9A8; cursor: pointer; }
  .lqg-bank-copy:hover { background: rgba(111,201,168,0.12); }
  ...
  .lqg-song-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; border-bottom: 1px solid rgba(111,201,168,0.3); padding-bottom: 12px; }
  ...
  .lqg-song-input { background: transparent; border: none; border-bottom: 1px solid rgba(111,201,168,0.3); color: #F4F1EA; font-family: var(--lqg-mono), monospace; font-size: 12px; padding: 6px 2px; min-width: 0; flex: 1; }
  .lqg-song-input::placeholder { color: #6E6A5D; }
  .lqg-song-input:focus { outline: none; border-bottom-color: #6FC9A8; }
  .lqg-song-sep { color: #8A8577; flex-shrink: 0; }
  .lqg-song-submit { flex-shrink: 0; background: none; border: none; color: #6FC9A8; font-family: var(--lqg-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .lqg-song-submit:hover { color: #F5F8F9; }
  .lqg-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .lqg-song-error { font-size: 10px; color: #6FC9A8; margin-top: 6px; }
  ...
  .lqg-quiz-opt { font-family: var(--lqg-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(111,201,168,0.4); background: transparent; color: #6FC9A8; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .lqg-quiz-opt:disabled { cursor: default; }
  .lqg-quiz-opt--picked { background: #6FC9A8; border-color: #6FC9A8; color: #0B0B10; }
  .lqg-quiz-opt--correct { background: #6FC9A8; border-color: #6FC9A8; color: #0B0B10; }
  .lqg-quiz-opt--wrong { border-color: #8A6A6A; color: #C99; opacity: 0.6; }
  .lqg-quiz-result { padding-top: 18px; border-top: 1px solid rgba(111,201,168,0.2); }
  ...
  .lqg-final-card { border: 1px solid #6FC9A8; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  ...
  .lqg-replay { cursor: pointer; color: #6FC9A8; }
  ...
  .lqg-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F5F8F9, #6FC9A8); transition: height 260ms linear; display: block; }
  .lqg-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #6FC9A8; transition: color 500ms ease; }
  ...
  .lqg-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #0E1611 0%, #0A110D 46%, #080D0A 100%); }
  .lqg-cover-half--bottom .lqg-cover-inner { top: auto; bottom: 0; }
  .lqg-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(111,201,168,0.4), rgba(232,242,240,0.3), rgba(111,201,168,0.5), rgba(111,201,168,0.4)); filter: blur(64px); opacity: .62; animation: lqgFoil 26s linear infinite; }
  ...
  .lqg-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#6FC9A8, transparent); display: block; }
  ...
  .lqg-cover-cta { border: 1px solid #6FC9A8; background: linear-gradient(100deg, rgba(200,164,92,0.08), rgba(232,214,168,0.2), rgba(200,164,92,0.08)); color: #F6EFDD; font-family: var(--lqg-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  ...
  .lqg-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #6FC9A8; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
