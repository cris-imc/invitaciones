  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="adp-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="adp-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #191820 0%, #0E0D11 52%, #101213 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="adp-section" style={{ background: "#101213" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="adp-section" style={{ background: "#101213" }}>
        ...
        <section data-tone="dark" data-screen-label="Tu lámina" className="adp-section adp-section--between" style={{ padding: "96px max(30px, calc((100% - 560px) / 2)) 48px max(24px, calc((100% - 560px) / 2))", background: "radial-gradient(120% 70% at 50% 100%, #191820 0%, #101213 55%, #101213 100%)" }}>
