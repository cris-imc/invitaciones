...
const ADP_CSS = `
  ...
  .adp-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #1F2123 0%, #101213 46%, #101213 100%); }
  .adp-cover-half--bottom .adp-cover-inner { top: auto; bottom: 0; }
  .adp-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(96,105,118,0.4), rgba(171,177,186,0.32), rgba(96,105,118,0.5), rgba(96,105,118,0.4)); filter: blur(64px); opacity: .62; animation: adpFoil 26s linear infinite; }
  ...
  .adp-cover-paper { position: absolute; width: 66%; height: 50%; left: 17%; top: 22%; background: rgba(171,177,186,.14); border-radius: 6px; box-shadow: 0 20px 40px rgba(0,0,0,.25); transform: rotate(-2deg); }
  ...
  .adp-cover-names { margin: 0; font-family: var(--adp-serif), serif; font-weight: 400; font-size: min(clamp(48px, 16vw, 96px), 12.5vh); line-height: 0.86; letter-spacing: -0.02em; color: #EBEDEF; }
  ...
  .adp-cover-cta { border: 1px solid #606976; background: linear-gradient(100deg, rgba(96,105,118,0.08), rgba(171,177,186,0.2), rgba(96,105,118,0.08)); color: #EBEDEF; font-family: var(--adp-mono), monospace; font-size: 12px; letter-spacing: 0.26em; padding: clamp(13px, 2.1vh, 19px) 0; text-align: center; width: 100%; }
  .adp-cover-cta--btn { cursor: pointer; border-radius: 0; }
  .adp-cover-cta--btn:hover { background: linear-gradient(100deg, rgba(171,177,186,0.34), rgba(235,237,239,0.5), rgba(171,177,186,0.34)); color: #0B0B0F; }
