...
/**
 * TintaViniloTemplateVioleta.tsx — Colección Paper · Papelería Viva · Familia 04 "Tinta & Vinilo"
 * Variante: Violeta tinta (generada, no editar a mano).
 *
...
interface TintaViniloTemplateVioletaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function TintaViniloTemplateVioleta({ invitation, guest, isPersonalized = false }: TintaViniloTemplateVioletaProps) {
  const tx = useTextos();
