  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="phl-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="phl-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #26272B 0%, #0C0B11 52%, #101113 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="phl-section" style={{ background: "#1B1D20" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="phl-section" style={{ background: "#1B1D20" }}>
