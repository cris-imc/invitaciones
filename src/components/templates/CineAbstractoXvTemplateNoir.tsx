  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="cxv-scroller">
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label="Frase" className="cxv-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #16161A 0%, #0E0E10 52%, #030304 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label="Música" className="cxv-section" style={{ background: "#0A0A0C" }}>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label="Regalos" className="cxv-section" style={{ background: "#0A0A0C" }}>
