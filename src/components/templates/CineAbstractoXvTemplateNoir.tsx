 ...
 *
 * Variante de color "Noir" de "Cine Abstracto XV" (Colección
...
export function CineAbstractoXvTemplateNoir({ invitation, guest, isPersonalized = false }: CineAbstractoXvTemplateProps) {
  const tx = useTextos();
  ...
  const handleConfirmed = useCallback((data: { attending: boolean; count: number }) => {
    ...
    window.setTimeout(() => {
      ...
      if (stubRef.current) {
        stubRef.current.style.borderColor = "#E6E9EE";
        stubRef.current.style.boxShadow = "0 0 0 1px rgba(230,233,238,.35), 0 18px 50px -30px #E6E9EE";
      }
      if (sealRef.current) {
    ...
    const frame = () => {
      ...
      if (sc) {
        ...
        pans.forEach((pan, pi) => {
          ...
          dots.forEach((dot, i) => {
            dot.style.background = i === active ? "#9FA8B0" : "rgba(20,20,27,0.18)";
          });
        });
        ...
        if (cur) {
          ...
          if (railRef.current) railRef.current.style.borderLeftColor = light ? "rgba(20,20,27,0.14)" : "rgba(150,155,163,0.14)";
          if (railLineRef.current) railLineRef.current.style.background = light ? "rgba(20,20,27,0.14)" : "rgba(150,155,163,0.16)";
          if (railTopRef.current) railTopRef.current.style.color = light ? "#7C7768" : "#8A8577";
          if (railLabelRef.current) railLabelRef.current.style.color = light ? "#9FA8B0" : "#E6E9EE";
        }
  ...
  if (estadoDelEvento === "POST_EVENT" || estadoDelEvento === "EXPIRED") {
    return (
      <PostEventoStorytelling
        ...
        fotos={livePhotos}
        paleta={{ fondo: "#030304", tinta: "#F4F1EA", acento: "#E6E9EE", clase: `${cxvArchivoBlack.variable} ${cxvMono.variable}`, fuente: "var(--cxv-mono), monospace" }}
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div ref={scrollerRef} data-scroller="1" className="cxv-scroller">
        ...
        <section data-tone="dark" data-screen-label="Save the Date" className="cxv-section" style={{ background: "radial-gradient(120% 80% at 50% 0%, #131316 0%, #0A0A0C 55%, #030304 100%)" }}>
            ...
            <div className="cxv-hero-photo-frame">
              {photoMobile && (
                <div className="acp-mobile-only">
                  <AnimatedCoverPhoto photoSrc={photoMobile} tint={false} effect="enfoque" scrimColorRgb="3,3,4" />
                </div>
              )}
              {photoDesktop && (
                <div className="acp-desktop-only">
                  <AnimatedCoverPhoto photoSrc={photoDesktop} tint={false} effect="enfoque" scrimColorRgb="3,3,4" />
                </div>
              )}
            </div>
        ...
        <section id="countdown" data-tone="dark" data-screen-label="Countdown" className="cxv-section cxv-section--between" style={{ background: "radial-gradient(100% 60% at 50% 100%, #17171B 0%, #0C0C0E 55%, #030304 100%)" }}>
        ...
        {hasFrase && (
        <section id="quote" data-tone="dark" data-screen-label={tx("invitacion.frase.etiqueta")} className="cxv-section" style={{ background: "radial-gradient(130% 90% at 86% 16%, #16161A 0%, #0E0E10 52%, #030304 100%)" }}>
        ...
        <div data-pan="1" data-scroll={scrollVertical ? "vertical" : "lateral"} data-screen-label={tx("invitacion.ubicacion.cuandoYDonde")} className="cxv-pan" style={!scrollVertical && ceremoniaHabilitada ? { height: "340vh" } : undefined}>
          <div className="cxv-pan-sticky">
            <div data-strip="1" className="cxv-strip">
              ...
              {hayComoLlegar && (
                <div data-tone="light" className="cxv-panel cxv-panel--end" style={{ background: "#E4DFD3", color: "#14141B" }}>
                  <svg viewBox="0 0 300 500" preserveAspectRatio="none" className="cxv-route-svg">
                    <path ref={routeRef} d="M18 468 C 130 400, 54 262, 152 220 S 254 140, 282 40" fill="none" stroke="#9FA8B0" strokeWidth={1.6} />
                    <circle cx={282} cy={40} r={5} fill="#9FA8B0" />
                  </svg>
              ...
              <div data-tone="dark" className="cxv-panel cxv-panel--center" style={{ background: "#0A0A0C", color: "#F4F1EA" }}>
        ...
        <section data-tone="dark" data-screen-label="Check-in" className="cxv-section" style={{ background: "radial-gradient(110% 70% at 50% 100%, #131316 0%, #0A0A0C 60%, #030304 100%)" }}>
        ...
        {sugerenciaMusicaHabilitada && (
          <section id="music" data-tone="dark" data-screen-label={tx("invitacion.musica.titulo")} className="cxv-section" style={{ background: "#0A0A0C" }}>
            ...
            <div data-xin="1" data-delay="160" data-dist="-80" className="cxv-eq">
              {[0, 0.18, 0.36, 0.54, 0.72].map((delay, i) => (
                <span key={i} className="cxv-eq-bar" style={{ animationDelay: `${delay}s`, background: i === 2 ? "#F5F1E8" : "#E6E9EE" }} />
              ))}
            </div>
        ...
        {showBankSection && (
          <section id="banco" data-tone="dark" data-screen-label={tx("invitacion.regalos.titulo")} className="cxv-section" style={{ background: "#0A0A0C" }}>
        ...
        {quizEnabled && (
          <section id="quiz" data-tone="dark" data-screen-label="Quiz" className="cxv-section" style={{ background: "#0A0A0C" }}>
      ...
      {mounted && isPersonalized && guest && isCoverOpen && (
        <BurbujaPase acento="#E6E9EE" guest={guest} />
      )}
...
const CXV_CSS = `
  ...
  a { color: #E6E9EE; text-decoration: none; }
  ...
  /* Foto principal (ver GuestPassVipTemplate.tsx). Mobile: la foto ocupa
     toda la sección, borde a borde. Desktop: se enmarca con un borde
     propio de la familia en vez de estirarse. */
  .cxv-hero-photo-section { min-height: calc(var(--vh, 1vh) * 100); position: relative; overflow: hidden; background: #030304; }
  ...
  @media (min-width: 768px) {
    .cxv-hero-photo-frame { inset: 64px max(24px, calc((100% - 900px) / 2)); border: 1px solid rgba(159,168,176,.3); }
  ...
  .cxv-date-month { font-family: var(--cxv-archivo), sans-serif; font-style: italic; font-size: clamp(50px, 18vw, 104px); line-height: 0.9; color: #E6E9EE; padding-left: 12%; }

  .cxv-divider { display: flex; align-items: center; gap: 16px; font-size: 10px; letter-spacing: 0.26em; color: #8A8577; }
  .cxv-divider-line { width: 52px; height: 1px; background: #E6E9EE; display: inline-block; }
  ...
  .cxv-cal-link:hover { color: #E6E9EE; }
  ...
  .cxv-medallion-ring { position: absolute; inset: 0; border-radius: 50%; background: conic-gradient(from 0deg, #9FA8B0, #2B2E33, #E6E9EE, #F5F1E8, #9FA8B0); filter: saturate(.75); }
  .cxv-medallion-core { position: absolute; inset: 3px; border-radius: 50%; background: #0B0B0D; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 3px; text-align: center; padding: 6px; }
  ...
  .cxv-medallion-sub { font-size: 6.5px; letter-spacing: 0.24em; color: #E6E9EE; }
  .cxv-medallion-arc { position: absolute; inset: -14%; }
  .cxv-medallion-arc-text { font-size: 7px; letter-spacing: 1.6px; fill: #E6E9EE; font-family: var(--cxv-mono), monospace; }

  .cxv-scan-grid { position: absolute; inset: 0; background: repeating-linear-gradient(0deg, rgba(150,155,163,0.06) 0 1px, transparent 1px 5px); pointer-events: none; }
  ...
  .cxv-cd-box { border: 1px solid #26262B; background: rgba(20,20,27,0.72); padding: 18px 15px; display: flex; flex-direction: column; gap: 6px; overflow: hidden; }
  .cxv-cd-num { font-family: var(--cxv-archivo), sans-serif; font-size: clamp(48px, 14vw, 80px); line-height: 0.82; color: #F2F4F7; display: inline-block; }
  .cxv-cd-label { font-size: 9px; letter-spacing: 0.3em; color: #E6E9EE; }
  .cxv-perf-strip { height: 12px; position: relative; background: radial-gradient(circle at 6px 50%, #030304 3.4px, transparent 3.8px) 0 0/12px 12px repeat-x; opacity: .85; }
  ...
  .cxv-glow-blob { position: absolute; right: -26%; top: 4%; width: 82vw; max-width: 540px; aspect-ratio: 1; border-radius: 50%; background: conic-gradient(from 200deg, rgba(159,168,176,0.3), rgba(230,233,238,0.2), rgba(230,233,238,0.32), rgba(159,168,176,0.3)); filter: blur(80px); opacity: .4; animation: gpFoil 30s linear infinite; }
  ...
  .cxv-accent-italic { font-style: italic; color: #9FA8B0; }
  .cxv-accent-serif { font-style: italic; color: #9FA8B0; font-family: var(--cxv-archivo), sans-serif; }
  .cxv-accent-serif-2 { color: #9FA8B0; }
  ...
  .cxv-seguir { position: relative; display: flex; align-items: center; gap: 10px; font-size: 9px; letter-spacing: 0.26em; color: #9FA8B0; margin-top: auto; }
  ...
  .cxv-link-cta { font-size: 10px; letter-spacing: 0.24em; color: #9FA8B0; }
  ...
  .cxv-crono-time { font-family: var(--cxv-mono), monospace; color: #9FA8B0; min-width: 42px; }
  ...
  .cxv-stub { position: relative; overflow: hidden; border: 1px solid #26262B; background: rgba(20,20,27,0.7); padding: 20px; display: flex; flex-direction: column; gap: 16px; transition: border-color 600ms ease, box-shadow 600ms ease; }
  ...
  .cxv-rsvp-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 12px 0; border-bottom: 1px solid rgba(150,155,163,0.18); font-size: 10.5px; letter-spacing: 0.18em; color: #8A8577; }
  ...
  .cxv-rsvp-stepper button { width: 26px; height: 26px; border-radius: 50%; border: 1px solid #E6E9EE; background: transparent; color: #E6E9EE; font-size: 14px; line-height: 1; cursor: pointer; }
  ...
  .cxv-rsvp-input { background: transparent; border: none; border-bottom: 1px solid rgba(150,155,163,0.3); color: #F4F1EA; font-family: var(--cxv-mono), monospace; font-size: 11px; letter-spacing: 0.02em; padding: 4px 2px; text-align: right; max-width: 55%; }
  .cxv-rsvp-input::placeholder { color: #6E6A5D; }
  .cxv-rsvp-input:focus { outline: none; border-bottom-color: #E6E9EE; }
  .cxv-rsvp-btn { width: 100%; padding: 16px; font-family: var(--cxv-mono), monospace; font-size: 11px; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; background: linear-gradient(180deg, #E6E9EE, #9FA8B0); border: 1px solid #E6E9EE; color: #0B0B10; cursor: pointer; }
  .cxv-rsvp-btn:disabled { opacity: 0.6; cursor: default; }
  .cxv-rsvp-btn--ghost { background: transparent; color: #E6E9EE; }
  .cxv-rsvp-error { font-size: 10px; letter-spacing: 0.06em; color: #9FA8B0; margin: 0; }
  ...
  .cxv-bank-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(150,155,163,0.18); }
  ...
  .cxv-bank-copy { flex-shrink: 0; font-family: var(--cxv-mono), monospace; font-size: 10px; letter-spacing: 0.1em; padding: 7px 12px; border: 1px solid #E6E9EE; background: transparent; color: #E6E9EE; cursor: pointer; }
  .cxv-bank-copy:hover { background: rgba(230,233,238,0.12); }
  ...
  .cxv-song-row { display: flex; align-items: center; justify-content: space-between; gap: 12px; border-bottom: 1px solid rgba(150,155,163,0.3); padding-bottom: 12px; }
  ...
  .cxv-song-input { background: transparent; border: none; border-bottom: 1px solid rgba(150,155,163,0.3); color: #F4F1EA; font-family: var(--cxv-mono), monospace; font-size: 12px; padding: 6px 2px; min-width: 0; flex: 1; }
  .cxv-song-input::placeholder { color: #6E6A5D; }
  .cxv-song-input:focus { outline: none; border-bottom-color: #E6E9EE; }
  .cxv-song-sep { color: #8A8577; flex-shrink: 0; }
  .cxv-song-submit { flex-shrink: 0; background: none; border: none; color: #E6E9EE; font-family: var(--cxv-mono), monospace; font-size: 10px; letter-spacing: 0.2em; cursor: pointer; }
  .cxv-song-submit:hover { color: #F5F1E8; }
  .cxv-song-submit:disabled { color: #6E6A5D; cursor: default; }
  .cxv-song-error { font-size: 10px; color: #9FA8B0; margin-top: 6px; }
  ...
  .cxv-quiz-opt { font-family: var(--cxv-mono), monospace; font-size: 11px; letter-spacing: 0.06em; padding: 10px 16px; border: 1px solid rgba(230,233,238,0.4); background: transparent; color: #E6E9EE; cursor: pointer; transition: background 160ms ease, color 160ms ease, border-color 160ms ease; }
  .cxv-quiz-opt:disabled { cursor: default; }
  .cxv-quiz-opt--picked { background: #E6E9EE; border-color: #E6E9EE; color: #0B0B10; }
  .cxv-quiz-opt--correct { background: #E6E9EE; border-color: #E6E9EE; color: #0B0B10; }
  .cxv-quiz-opt--wrong { border-color: #8A6A6A; color: #C99; opacity: 0.6; }
  .cxv-quiz-result { padding-top: 18px; border-top: 1px solid rgba(230,233,238,0.2); }
  ...
  .cxv-final-card { border: 1px solid #E6E9EE; padding: 30px 24px; display: flex; flex-direction: column; gap: 22px; align-items: center; text-align: center; position: relative; }
  ...
  .cxv-replay { cursor: pointer; color: #E6E9EE; }
  .cxv-footer-credit { display: flex; justify-content: center; padding-top: 8px; opacity: 0.7; }

  .cxv-rail { position: absolute; right: 0; top: 0; bottom: 0; width: 34px; z-index: 4; display: flex; flex-direction: column; align-items: center; justify-content: space-between; padding: 20px 0; opacity: 0; transition: opacity 700ms ease; pointer-events: none; border-left: 1px solid rgba(150,155,163,0.14); }
  .cxv-rail-top { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #8A8577; transition: color 500ms ease; }
  .cxv-rail-line { flex: 1; width: 1px; margin: 16px 0; background: rgba(150,155,163,0.16); position: relative; }
  .cxv-rail-bar { position: absolute; left: -1px; top: 0; width: 3px; height: 0%; background: linear-gradient(#F5F1E8, #E6E9EE); transition: height 260ms linear; display: block; }
  .cxv-rail-label { writing-mode: vertical-rl; font-size: 8px; letter-spacing: 0.34em; color: #E6E9EE; transition: color 500ms ease; }
  ...
  .cxv-cover-inner { position: absolute; left: 0; right: 0; top: 0; height: 200%; overflow: hidden; background: radial-gradient(120% 70% at 50% 8%, #0D0D10 0%, #0A0A0C 46%, #030304 100%); }
  .cxv-cover-half--bottom .cxv-cover-inner { top: auto; bottom: 0; }
  .cxv-cover-glow { position: absolute; left: 50%; top: 6%; width: 190%; aspect-ratio: 1; transform: translate(-50%, -14%); border-radius: 50%; background: conic-gradient(from 200deg, rgba(159,168,176,0.4), rgba(230,233,238,0.3), rgba(230,233,238,0.5), rgba(159,168,176,0.4)); filter: blur(64px); opacity: .62; animation: gpFoil 26s linear infinite; }
  ...
  .cxv-bulb { width: 5px; height: 5px; border-radius: 50%; background: #E6E9EE; animation: cxvBulbFlicker 1.4s ease-in-out infinite; display: inline-block; }
  ...
  .cxv-cover-rule { width: 1px; height: clamp(16px, 4vh, 44px); background: linear-gradient(#E6E9EE, transparent); display: block; }
  ...
  .cxv-lightbox-close { position: absolute; top: 20px; right: 20px; width: 36px; height: 36px; border-radius: 50%; border: 1px solid #E6E9EE; background: rgba(0,0,0,0.4); color: #F4F1EA; font-size: 18px; line-height: 1; cursor: pointer; display: flex; align-items: center; justify-content: center; }
