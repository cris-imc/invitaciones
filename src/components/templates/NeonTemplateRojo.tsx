    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', position: 'relative' }}>
            ...
            <div className="neon-seal opacity-0" style={{
              width: 44, height: 44, borderRadius: '50%', border: '1px solid #FF3C5C',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, color: '#FF3C5C',
            }}>
              {monogram}
            </div>
          ...
          {isTicketMaximized ? (
            <div className="flex items-center justify-between w-full animate-in fade-in duration-300">
              <div className="flex flex-col text-left">
                <span className=" text-[8px] font-semibold uppercase tracking-[0.2em] text-[#FF3C5C] leading-none mb-1" style={{ fontFamily: "var(--font-body-custom, var(--font-inter))" }}>Pase Especial</span>
      ...
      <div className="d-right tpl">
        ...
        <div className="w-full flex items-center justify-center gap-4 py-8 bg-[#0D0D10]" aria-hidden="true">
          <IconDiscoBall className="neon-scroll-doodle opacity-0" style={{ width: 30, height: 30, color: 'rgba(255,60,92,0.4)' }} />
        ...
        {songsEnabled && (
          <div className="w-full flex justify-center pt-16" style={{ background: '#0D0D10' }} aria-hidden="true">
            <IconMusic className="neon-scroll-doodle opacity-0" style={{ width: 28, height: 28, color: '#FF3C5C' }} />
          </div>
        )}
        {songsEnabled && (
          <SongSuggestion
