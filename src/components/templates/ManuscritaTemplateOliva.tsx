...
/**
 * ManuscritaTemplateOliva.tsx — Colección Paper · Papelería Viva · Familia 03 "Manuscrita"
 * Variante: Oliva (generada, no editar a mano).
 *
...
interface ManuscritaTemplateOlivaProps {
...
// ─── La plantilla ───────────────────────────────────────────────────────────
export function ManuscritaTemplateOliva({ invitation, guest, isPersonalized = false }: ManuscritaTemplateOlivaProps) {
  const tx = useTextos();
