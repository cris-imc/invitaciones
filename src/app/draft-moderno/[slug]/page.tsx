...
// ── Página principal (DRAFT aislado — no linkeado desde la app) ──
export default async function DraftModernoPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  return <ModernoTemplate invitation={invitation as Record<string, unknown>} />;
}
