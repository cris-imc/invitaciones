...
import {
  ...
  SHOJO_COMPONENTS,
  POP_COMPONENTS,
  OBSERVATORIO_COMPONENTS,
  NOIR_COMPONENTS,
  POSTAL_COMPONENTS,
  RETROWAVE_COMPONENTS,
  BAUHAUS_COMPONENTS,
  CARTELERA_COMPONENTS,
  COUTURE_COMPONENTS,
  MEMBRETE_COMPONENTS,
  TINTAVINILO_COMPONENTS,
  MANUSCRITA_COMPONENTS,
  ACUARELACORONA_COMPONENTS,
  SOBRESELLO_COMPONENTS,
  TRAZODEPAPEL_COMPONENTS,
  CIUDADDEPAPEL_COMPONENTS,
  CUENTODEPAPEL_COMPONENTS,
  CIELODEPAPEL_COMPONENTS,
  HERBARIO_COMPONENTS,
  TRAZO_COMPONENTS,
  NOCHE_COMPONENTS,
  LUMBRE_COMPONENTS,
  JARDINDEPAPEL_COMPONENTS,
  PreviewLoading,
  type TemplateTipo,
...
const COMPONENTS_BY_TIPO: Record<TemplateTipo, typeof ELEGANT_COMPONENTS> = {
  ...
  PRENSA: PRENSA_COMPONENTS,
  EDITORIALBLANCNOIR: EDITORIALBLANCNOIR_COMPONENTS,
  ARCADE: ARCADE_COMPONENTS,
  Y2K: Y2K_COMPONENTS,
  TROPICAL: TROPICAL_COMPONENTS,
  REINO: REINO_COMPONENTS,
  SHOJO: SHOJO_COMPONENTS,
  POP: POP_COMPONENTS,
  OBSERVATORIO: OBSERVATORIO_COMPONENTS,
  NOIR: NOIR_COMPONENTS,
  POSTAL: POSTAL_COMPONENTS,
  RETROWAVE: RETROWAVE_COMPONENTS,
  BAUHAUS: BAUHAUS_COMPONENTS,
  CARTELERA: CARTELERA_COMPONENTS,
  COUTURE: COUTURE_COMPONENTS,
  MEMBRETE: MEMBRETE_COMPONENTS,
  TINTAVINILO: TINTAVINILO_COMPONENTS,
  MANUSCRITA: MANUSCRITA_COMPONENTS,
  ACUARELACORONA: ACUARELACORONA_COMPONENTS,
  SOBRESELLO: SOBRESELLO_COMPONENTS,
  TRAZODEPAPEL: TRAZODEPAPEL_COMPONENTS,
  CIUDADDEPAPEL: CIUDADDEPAPEL_COMPONENTS,
  CUENTODEPAPEL: CUENTODEPAPEL_COMPONENTS,
  CIELODEPAPEL: CIELODEPAPEL_COMPONENTS,
  HERBARIO: HERBARIO_COMPONENTS,
  TRAZO: TRAZO_COMPONENTS,
  NOCHE: NOCHE_COMPONENTS,
  LUMBRE: LUMBRE_COMPONENTS,
  JARDINDEPAPEL: JARDINDEPAPEL_COMPONENTS,
};
