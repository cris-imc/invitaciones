...
const es = {
  ...
  strip: {
    ...
    personalizable: {
      ...
      detalle: "Adaptá colores, tipografías, fotos y estructura. Ya sea una boda, un 15 o un evento corporativo, el diseño se ajusta a tu estilo.",
    },
    gestion: {
      titulo: "Gestión de Invitados y Pagos",
      detalle: "Recibí confirmaciones (RSVP) al instante, administrá accesos y configurá tu mesa de regalos o cuenta bancaria sin comisiones.",
    },
    live: {
  ...
  caracteristicas: {
    ...
    mesas: {
      ...
      detalle: "Armá el salón, asigná cada familia a su mesa y repartí a las que no entran en una sola. Cada invitado ve la suya en su invitación.",
    },
    ingreso: {
    ...
    rsvp: {
      ...
      detalle: "RSVP en tiempo real: sabés quién confirmó sin tener que preguntar.",
    },
    social: {
    ...
    album: {
      ...
      detalle: "Compartí los momentos de la pareja antes de la fiesta y sumá los del evento.",
    },
    musica: {
  ...
  planes: {
    ...
    titulo: "Elegí el plan para tu evento",
    bajada: "Empezá completamente gratis o desbloqueá todas las funcionalidades con un único pago. Sin suscripciones, y hasta en {cuotas} cuotas sin interés.",
    bajadaSinCuotas: "Empezá completamente gratis o desbloqueá todas las funcionalidades con un único pago. Sin suscripciones.",
    ...
    diamond: {
      ...
      mesas: {
        titulo: "Organización de mesas:",
        detalle: "armá el salón y asigná a cada familia su mesa, y cada invitado la ve en su invitación",
      },
      ingreso: {
        titulo: "Control de ingreso:",
        detalle: "escaneás el QR en la puerta y ves quién llegó y a qué mesa va",
      },
      aperturas: {
        titulo: "Quién abrió la invitación:",
        detalle: "sabés a quién le llegó y a quién volver a escribirle",
      },
      sinMarca: {
  ...
  modelos: {
    ...
    tituloAntes: "Mirá cómo ven la invitación",
    tituloDestacado: "tus invitados",
    bajada: "Invitaciones reales, con nombre, salón, mapa y fecha de verdad — tocá cualquiera para abrirla completa, tal cual la va a ver cada invitado.",
    vacio: "Estamos preparando los modelos. Volvé pronto para ver ejemplos reales.",
